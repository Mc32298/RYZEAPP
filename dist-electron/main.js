...
function _d() {
  ...
  var e = yd,
    t = process.cwd,
    r = null,
    n = process.env.GRACEFUL_FS_PLATFORM || process.platform;
  ...
  function s(i) {
    (e.hasOwnProperty("O_SYMLINK") &&
      ...
      (i.fchmod = h(i.fchmod)),
      (i.lchmod = h(i.lchmod)),
      (i.chownSync = u(i.chownSync)),
      (i.fchownSync = u(i.fchownSync)),
      (i.lchownSync = u(i.lchownSync)),
      (i.chmodSync = d(i.chmodSync)),
      (i.fchmodSync = d(i.fchmodSync)),
      (i.lchmodSync = d(i.lchmodSync)),
      (i.stat = p(i.stat)),
      (i.fstat = p(i.fstat)),
      (i.lstat = p(i.lstat)),
      (i.statSync = E(i.statSync)),
      (i.fstatSync = E(i.fstatSync)),
      (i.lstatSync = E(i.lstatSync)),
      i.chmod &&
        !i.lchmod &&
        ((i.lchmod = function (m, T, A) {
          A && process.nextTick(A);
        }),
        (i.lchmodSync = function () {})),
      i.chown &&
        !i.lchown &&
        ((i.lchown = function (m, T, A, N) {
        ...
        (i.rename =
          typeof i.rename != "function"
            ...
            : (function (m) {
                ...
                return (
                  Object.setPrototypeOf && Object.setPrototypeOf(T, m),
                  T
                );
              })(i.rename)),
      (i.read =
        typeof i.read != "function"
          ? i.read
          : (function (m) {
              function T(A, N, D, S, b, I) {
                var v;
                if (I && typeof I == "function") {
                  var C = 0;
                  v = function (_, U, x) {
                    if (_ && _.code === "EAGAIN" && C < 10)
                      return (C++, m.call(i, A, N, D, S, b, v));
                    I.apply(this, arguments);
                  };
                }
                return m.call(i, A, N, D, S, b, v);
              }
      ...
      (i.readSync =
        typeof i.readSync != "function"
          ? i.readSync
          : /* @__PURE__ */ (function (m) {
              return function (T, A, N, D, S) {
                for (var b = 0; ; )
                  try {
                    return m.call(i, T, A, N, D, S);
                  } catch (I) {
                    if (I.code === "EAGAIN" && b < 10) {
                      b++;
                      continue;
                    }
                    throw I;
    ...
    function f(m) {
      ((m.lchmod = function (T, A, N) {
        m.open(T, e.O_WRONLY | e.O_SYMLINK, A, function (D, S) {
          if (D) {
            N && N(D);
            return;
          }
          m.fchmod(S, A, function (b) {
            m.close(S, function (I) {
              N && N(b || I);
            });
          });
        });
        ...
        (m.lchmodSync = function (T, A) {
          var N = m.openSync(T, e.O_WRONLY | e.O_SYMLINK, A),
            D = !0,
            S;
          try {
            ((S = m.fchmodSync(N, A)), (D = !1));
          } finally {
            if (D)
              try {
                m.closeSync(N);
    ...
    function o(m) {
      e.hasOwnProperty("O_SYMLINK") && m.futimes
        ? ((m.lutimes = function (T, A, N, D) {
            m.open(T, e.O_SYMLINK, function (S, b) {
              if (S) {
                D && D(S);
                return;
              }
              m.futimes(b, A, N, function (I) {
          ...
          (m.lutimesSync = function (T, A, N) {
            var D = m.openSync(T, e.O_SYMLINK),
              S,
              b = !0;
            try {
              ((S = m.futimesSync(D, A, N)), (b = !1));
            } finally {
              if (b)
                try {
                  m.closeSync(D);
    ...
    function h(m) {
      return (
        m &&
        function (T, A, N) {
          return m.call(i, T, A, function (D) {
    ...
    function l(m) {
      return (
        m &&
        function (T, A, N, D) {
          return m.call(i, T, A, N, function (S) {
            (y(S) && (S = null), D && D.apply(this, arguments));
          });
        }
      );
    }
    ...
    function p(m) {
      return (
        ...
        function (T, A, N) {
          ...
          return A ? m.call(i, T, A, D) : m.call(i, T, D);
        }
      );
    }
    function E(m) {
...
function Ad() {
  ...
  function t(r) {
    ...
    if (r instanceof Object) var n = { __proto__: e(r) };
...
function et() {
  ...
  typeof Symbol == "function" && typeof Symbol.for == "function"
    ? ((s = /* @__PURE__ */ Symbol.for("graceful-fs.queue")),
      (i = /* @__PURE__ */ Symbol.for("graceful-fs.previous")))
...
GFS4: `)),
  ...
  (ut[s] || o(ut, e[s]),
    ...
    process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH &&
      !e.__patched &&
      ((Wr = l(e)), (e.__patched = !0)));
  function l(m) {
    (t(m),
      (m.gracefulify = l),
      (m.createReadStream = pe),
      (m.createWriteStream = Z));
    var T = m.readFile;
    m.readFile = A;
    function A(Q, de, we) {
      return (
      ...
      function Re(Ne, Ce, Ae, w) {
        return T(Ne, Ce, function (g) {
          g && (g.code === "EMFILE" || g.code === "ENFILE")
            ? u([Re, [Ne, Ce, Ae], g, w || Date.now(), Date.now()])
            : typeof Ae == "function" && Ae.apply(this, arguments);
        });
      }
    }
    var N = m.writeFile;
    m.writeFile = D;
    function D(Q, de, we, Re) {
      return (
        typeof we == "function" && ((Re = we), (we = null)),
        Ne(Q, de, we, Re)
      );
      function Ne(Ce, Ae, w, g, q) {
        return N(Ce, Ae, w, function (P) {
          P && (P.code === "EMFILE" || P.code === "ENFILE")
            ? u([Ne, [Ce, Ae, w, g], P, q || Date.now(), Date.now()])
    ...
    function U(Q, de, we) {
      typeof de == "function" && ((we = de), (de = null));
      var Re = _.test(process.version)
        ? function (Ae, w, g, q) {
            return C(Ae, Ne(Ae, w, g, q));
          }
        : function (Ae, w, g, q) {
            return C(Ae, w, Ne(Ae, w, g, q));
          };
      return Re(Q, de, we);
      function Ne(Ce, Ae, w, g) {
        return function (q, P) {
          q && (q.code === "EMFILE" || q.code === "ENFILE")
            ? u([Re, [Ce, Ae, w], q, g || Date.now(), Date.now()])
            : (P && P.sort && P.sort(),
              typeof w == "function" && w.call(this, q, P));
        };
      }
    }
    ...
    var F = m.WriteStream;
    (F && ((Y.prototype = Object.create(F.prototype)), (Y.prototype.open = ee)),
      Object.defineProperty(m, "ReadStream", {
        get: function () {
          return k;
        },
        set: function (Q) {
    ...
    function k(Q, de) {
      return this instanceof k
        ...
        : k.apply(Object.create(k.prototype), arguments);
    }
    function G() {
      var Q = this;
      me(Q.path, Q.flags, Q.mode, function (de, we) {
        de
          ? (Q.autoClose && Q.destroy(), Q.emit("error", de))
          : ((Q.fd = we), Q.emit("open", we), Q.read());
      });
    }
    function Y(Q, de) {
    ...
    function ee() {
      ...
      me(Q.path, Q.flags, Q.mode, function (de, we) {
        de
          ? (Q.destroy(), Q.emit("error", de))
          : ((Q.fd = we), Q.emit("open", we));
      });
    }
    function pe(Q, de) {
  ...
  function y() {
    if ((clearTimeout(p), (p = void 0), e[s].length !== 0)) {
      var m = e[s].shift(),
        ...
        D = m[3],
        S = m[4];
      if (D === void 0) (h("RETRY", T.name, A), T.apply(null, A));
        ...
        var I = Date.now() - S,
          v = Math.max(S - D, 1),
          C = Math.min(v * 1.2, 100);
        I >= C
          ? (h("RETRY", T.name, A), T.apply(null, A.concat([D])))
          : e[s].push(m);
      }
...
function Rd() {
  ...
  const e = Le;
  return (
    (In.checkPath = function (r) {
      if (
        process.platform === "win32" &&
        /[<>:"|?*]/.test(r.replace(e.parse(r).root, ""))
      ) {
...
function Id() {
  ...
  ga = 1;
  const e = /* @__PURE__ */ er(),
    { checkPath: t } = /* @__PURE__ */ Rd(),
    r = (n) => {
      const a = { mode: 511 };
      return typeof n == "number" ? n : { ...a, ...n }.mode;
    };
  return (
    (Vr.makeDir = async (n, a) => (
      t(n),
      e.mkdir(n, {
        mode: r(a),
        recursive: !0,
...
function yt() {
  if (Ea) return Sn;
  Ea = 1;
  const e = nt().fromPromise,
    { makeDir: t, makeDirSync: r } = /* @__PURE__ */ Id(),
    n = e(t);
  return (
    (Sn = {
      mkdirs: n,
...
function tr() {
  ...
  function a(u, p, E) {
    ...
    const m = E.dereference
        ? (A) => e.statSync(A, { bigint: !0 })
        : (A) => e.lstatSync(A, { bigint: !0 }),
      T = m(u);
    try {
      y = m(p);
    } catch (A) {
  ...
  function s(u, p, E, y, m) {
    r.callbackify(n)(u, p, y, (T, A) => {
      ...
      if (D) {
        if (h(N, D)) {
          const S = t.basename(u),
            b = t.basename(p);
          return E === "move" && S !== b && S.toLowerCase() === b.toLowerCase()
            ? m(null, { srcStat: N, destStat: D, isChangingCase: !0 })
            : m(new Error("Source and destination must not be the same."));
        }
        if (N.isDirectory() && !D.isDirectory())
          return m(
            new Error(
              `Cannot overwrite non-directory '${p}' with directory '${u}'.`,
            ),
          );
        if (!N.isDirectory() && D.isDirectory())
          return m(
            new Error(
              `Cannot overwrite directory '${p}' with non-directory '${u}'.`,
            ),
          );
      }
      return N.isDirectory() && d(u, p)
        ? m(new Error(l(u, p, E)))
        : m(null, { srcStat: N, destStat: D });
    });
  }
  function i(u, p, E, y) {
    ...
    if (m.isDirectory() && d(u, p)) throw new Error(l(u, p, E));
    return { srcStat: m, destStat: T };
  }
  function f(u, p, E, y, m) {
    const T = t.resolve(t.dirname(u)),
      A = t.resolve(t.dirname(E));
    if (A === T || A === t.parse(A).root) return m();
    e.stat(A, { bigint: !0 }, (N, D) =>
      N
        ? N.code === "ENOENT"
          ? m()
          : m(N)
  ...
  function o(u, p, E, y) {
    const m = t.resolve(t.dirname(u)),
      T = t.resolve(t.dirname(E));
    ...
    if (h(p, A)) throw new Error(l(u, E, y));
    return o(u, p, T, y);
  }
  function h(u, p) {
...
function Sd() {
  ...
  function i(U, x, $, F) {
    (typeof $ == "function" && !F
      ? ((F = $), ($ = {}))
      : typeof $ == "function" && ($ = { filter: $ }),
      (F = F || function () {}),
      ($ = $ || {}),
      ($.clobber = "clobber" in $ ? !!$.clobber : !0),
      ($.overwrite = "overwrite" in $ ? !!$.overwrite : $.clobber),
      $.preserveTimestamps &&
        process.arch === "ia32" &&
        process.emitWarning(
	...
	see https://github.com/jprichardson/node-fs-extra/issues/269`,
      ...
      s.checkPaths(U, x, "copy", $, (L, j) => {
        ...
        s.checkParentPaths(U, k, x, "copy", (Y) =>
          Y ? F(Y) : $.filter ? o(f, G, U, x, $, F) : f(G, U, x, $, F),
        );
      }));
  }
  function f(U, x, $, F, L) {
  ...
  function o(U, x, $, F, L, j) {
    Promise.resolve(L.filter($, F)).then(
      (k) => (k ? U(x, $, F, L, j) : j()),
      (k) => j(k),
    );
  }
  ...
  function d(U, x, $, F, L) {
    (F.dereference ? e.stat : e.lstat)(x, (k, G) =>
      k
        ? L(k)
        : G.isDirectory()
          ? D(G, U, x, $, F, L)
          : G.isFile() || G.isCharacterDevice() || G.isBlockDevice()
            ? l(G, U, x, $, F, L)
            : G.isSymbolicLink()
              ? C(U, x, $, F, L)
              : G.isSocket()
                ? L(new Error(`Cannot copy a socket file: ${x}`))
                : G.isFIFO()
                  ? L(new Error(`Cannot copy a FIFO pipe: ${x}`))
                  : L(new Error(`Unknown file: ${x}`)),
    );
  }
  ...
  function u(U, x, $, F, L) {
    if (F.overwrite) e.unlink($, (j) => (j ? L(j) : p(U, x, $, F, L)));
    else return F.errorOnExist ? L(new Error(`'${$}' already exists`)) : L();
  }
  function p(U, x, $, F, L) {
    e.copyFile(x, $, (j) =>
      j ? L(j) : F.preserveTimestamps ? E(U.mode, x, $, L) : A($, U.mode, L),
    );
  }
  function E(U, x, $, F) {
  ...
  function D(U, x, $, F, L, j) {
    return x ? b($, F, L, j) : S(U.mode, $, F, L, j);
  }
  function S(U, x, $, F, L) {
    e.mkdir($, (j) => {
      if (j) return L(j);
  ...
  function b(U, x, $, F) {
    e.readdir(U, (L, j) => (L ? F(L) : I(j, U, x, $, F)));
  }
  function I(U, x, $, F, L) {
    const j = U.pop();
  ...
  function C(U, x, $, F, L) {
    e.readlink(x, (j, k) => {
      ...
      if ((F.dereference && (k = t.resolve(process.cwd(), k)), U))
        e.readlink($, (G, Y) =>
          G
            ? G.code === "EINVAL" || G.code === "UNKNOWN"
              ? e.symlink(k, $, L)
              : L(G)
            : (F.dereference && (Y = t.resolve(process.cwd(), Y)),
              s.isSrcSubdir(k, Y)
                ? L(
                    new Error(
                      `Cannot copy '${k}' to a subdirectory of itself, '${Y}'.`,
                    ),
                  )
                : U.isDirectory() && s.isSrcSubdir(Y, k)
                  ? L(new Error(`Cannot overwrite '${Y}' with '${k}'.`))
                  : _(k, $, L)),
        );
      else return e.symlink(k, $, L);
    });
  }
  function _(U, x, $) {
...
function bd() {
  ...
  function s(I, v, C) {
    ...
    const { srcStat: _, destStat: U } = a.checkPathsSync(I, v, "copy", C);
    return (a.checkParentPathsSync(I, _, v, "copy"), i(U, I, v, C));
  }
  function i(I, v, C, _) {
    if (_.filter && !_.filter(v, C)) return;
    const U = t.dirname(C);
    return (e.existsSync(U) || r(U), o(I, v, C, _));
  }
  function f(I, v, C, _) {
    if (!(_.filter && !_.filter(v, C))) return o(I, v, C, _);
  }
  function o(I, v, C, _) {
    const x = (_.dereference ? e.statSync : e.lstatSync)(v);
    if (x.isDirectory()) return T(x, I, v, C, _);
    if (x.isFile() || x.isCharacterDevice() || x.isBlockDevice())
      return h(x, I, v, C, _);
    if (x.isSymbolicLink()) return S(I, v, C, _);
    throw x.isSocket()
      ? new Error(`Cannot copy a socket file: ${v}`)
      : x.isFIFO()
        ? new Error(`Cannot copy a FIFO pipe: ${v}`)
        : new Error(`Unknown file: ${v}`);
  }
  function h(I, v, C, _, U) {
    return v ? d(I, C, _, U) : l(I, C, _, U);
  }
  function d(I, v, C, _) {
    if (_.overwrite) return (e.unlinkSync(C), l(I, v, C, _));
    if (_.errorOnExist) throw new Error(`'${C}' already exists`);
  }
  function l(I, v, C, _) {
    return (
      e.copyFileSync(v, C),
      _.preserveTimestamps && u(I.mode, v, C),
      y(C, I.mode)
    );
  }
  function u(I, v, C) {
    return (p(I) && E(C, I), m(v, C));
  }
  function p(I) {
    return (I & 128) === 0;
  }
  ...
  function y(I, v) {
    return e.chmodSync(I, v);
  }
  function m(I, v) {
    const C = e.statSync(I);
    return n(v, C.atime, C.mtime);
  }
  function T(I, v, C, _, U) {
    return v ? N(C, _, U) : A(I.mode, C, _, U);
  }
  function A(I, v, C, _) {
    return (e.mkdirSync(C), N(v, C, _), y(C, I));
  }
  function N(I, v, C) {
    e.readdirSync(I).forEach((_) => D(_, I, v, C));
  }
  function D(I, v, C, _) {
    const U = t.join(v, I),
      x = t.join(C, I),
      { destStat: $ } = a.checkPathsSync(U, x, "copy", _);
    return f($, U, x, _);
  }
  function S(I, v, C, _) {
    let U = e.readlinkSync(v);
    if ((_.dereference && (U = t.resolve(process.cwd(), U)), I)) {
      let x;
      try {
        x = e.readlinkSync(C);
      } catch ($) {
      ...
      if (
        (_.dereference && (x = t.resolve(process.cwd(), x)),
        a.isSrcSubdir(U, x))
      )
        throw new Error(
          `Cannot copy '${U}' to a subdirectory of itself, '${x}'.`,
        );
      if (e.statSync(C).isDirectory() && a.isSrcSubdir(x, U))
        throw new Error(`Cannot overwrite '${x}' with '${U}'.`);
      return b(U, C);
    } else return e.symlinkSync(U, C);
  }
  function b(I, v) {
    return (e.unlinkSync(v), e.symlinkSync(I, v));
  }
  return ((Dn = s), Dn);
}
var Pn, Aa;
...
function Cd() {
  ...
  function s(E, y, m) {
    ...
    (typeof y == "function" && ((m = y), (y = {})),
      ...
      r.strictEqual(typeof E, "string", "rimraf: path should be a string"),
      r.strictEqual(typeof m, "function", "rimraf: callback function required"),
      r(y, "rimraf: invalid options argument provided"),
      r.strictEqual(typeof y, "object", "rimraf: options should be object"),
      a(y),
      i(E, y, function A(N) {
        if (N) {
          if (
  ...
  function i(E, y, m) {
    (r(E),
      ...
      r(typeof m == "function"),
      y.lstat(E, (T, A) => {
        if (T && T.code === "ENOENT") return m(null);
        if (T && T.code === "EPERM" && n) return f(E, y, T, m);
        if (A && A.isDirectory()) return h(E, y, T, m);
        y.unlink(E, (N) => {
          if (N) {
            if (N.code === "ENOENT") return m(null);
            if (N.code === "EPERM") return n ? f(E, y, N, m) : h(E, y, N, m);
            if (N.code === "EISDIR") return h(E, y, N, m);
          }
          return m(N);
        });
      }));
  ...
  function f(E, y, m, T) {
    (r(E),
      ...
      y.chmod(E, 438, (A) => {
        A
          ? T(A.code === "ENOENT" ? null : m)
          : y.stat(E, (N, D) => {
              N
                ? T(N.code === "ENOENT" ? null : m)
                : D.isDirectory()
                  ? h(E, y, m, T)
                  : y.unlink(E, T);
            });
  ...
  function l(E, y) {
    ...
    try {
      ...
      if (T.code === "ENOENT") return;
      if (T.code === "EPERM") return n ? o(E, y, T) : u(E, y, T);
  ...
  function u(E, y, m) {
    ...
    try {
      ...
      if (T.code === "ENOTDIR") throw m;
      if (T.code === "ENOTEMPTY" || T.code === "EEXIST" || T.code === "EPERM")
        p(E, y);
      else if (T.code !== "ENOENT") throw T;
    }
  }
  function p(E, y) {
...
function Pd() {
  ...
  function n(s, i, f) {
    if (e.isAbsolute(s))
      return t.lstat(s, (o) =>
        o
          ? ((o.message = o.message.replace("lstat", "ensureSymlink")), f(o))
          : f(null, {
              toCwd: s,
              toDst: s,
            }),
...
function Fd() {
  ...
  function t(n, a, s) {
    if (
      ((s = typeof a == "function" ? a : s),
      (a = typeof a == "function" ? !1 : a),
      a)
    )
      return s(null, a);
    e.lstat(n, (i, f) => {
...
function Ld() {
  ...
  const e = nt().fromCallback,
    ...
    i = /* @__PURE__ */ Pd(),
    f = i.symlinkPaths,
    o = i.symlinkPathsSync,
    h = /* @__PURE__ */ Fd(),
    d = h.symlinkType,
    l = h.symlinkTypeSync,
    u = jt().pathExists,
    { areIdentical: p } = /* @__PURE__ */ tr();
  function E(T, A, N, D) {
    ((D = typeof N == "function" ? N : D),
      (N = typeof N == "function" ? !1 : N),
      r.lstat(A, (S, b) => {
        !S && b.isSymbolicLink()
          ? Promise.all([r.stat(T), r.stat(A)]).then(([I, v]) => {
              if (p(I, v)) return D(null);
              y(T, A, N, D);
            })
          : y(T, A, N, D);
      }));
  ...
  function m(T, A, N) {
    ...
    if (D && D.isSymbolicLink()) {
      const v = r.statSync(T),
        C = r.statSync(A);
      if (p(v, C)) return;
    }
    const S = o(T, A);
    ((T = S.toDst), (N = l(S.toCwd, N)));
    const b = t.dirname(A);
...
function xd() {
  if (Pa) return Bn;
  Pa = 1;
  const { createFile: e, createFileSync: t } = /* @__PURE__ */ Od(),
    { createLink: r, createLinkSync: n } = /* @__PURE__ */ Dd(),
    { createSymlink: a, createSymlinkSync: s } = /* @__PURE__ */ Ld();
  return (
    (Bn = {
      // file
      createFile: e,
...
`,
    ...
    const f = a ? n : "",
      o = JSON.stringify(r, s, i);
    if (o === void 0)
      throw new TypeError(
        `Converting ${typeof r} value to JSON is not supported`,
      );
    return o.replace(/\n/g, n) + f;
  }
  function t(r) {
...
function Ud() {
  ...
  const t = nt(),
    { stringify: r, stripBom: n } = Po();
  async function a(d, l = {}) {
    typeof l == "string" && (l = { encoding: l });
    const u = l.fs || e,
      p = "throws" in l ? l.throws : !0;
    ...
    try {
      ...
      if (p) throw ((m.message = `${d}: ${m.message}`), m);
      return null;
    }
    return y;
  }
  ...
  function i(d, l = {}) {
    ...
    try {
      ...
      if (p) throw ((E.message = `${d}: ${E.message}`), E);
      return null;
    }
  }
...
function Fo() {
  ...
  function i(f, ...o) {
    const h = r.dirname(f);
    if (t.existsSync(h)) return t.writeFileSync(f, ...o);
...
function $d() {
  if (ka) return Vn;
  ka = 1;
  const { stringify: e } = Po(),
    { outputFile: t } = /* @__PURE__ */ Fo();
...
function qd() {
  ...
  const e = nt().fromPromise,
    t = /* @__PURE__ */ kd();
  return (
    (t.outputJson = e(/* @__PURE__ */ $d())),
    (t.outputJsonSync = /* @__PURE__ */ Md()),
...
function Bd() {
  ...
  function f(u, p, E, y) {
    ...
    i.checkPaths(u, p, "move", E, (T, A) => {
      ...
      i.checkParentPaths(u, N, p, "move", (S) => {
        if (S) return y(S);
        if (o(p)) return h(u, p, m, D, y);
        a(t.dirname(p), (b) => (b ? y(b) : h(u, p, m, D, y)));
      });
    });
  }
  function o(u) {
  ...
  function h(u, p, E, y, m) {
    ...
    if (E) return n(p, (T) => (T ? m(T) : d(u, p, E, m)));
    s(p, (T, A) =>
      T ? m(T) : A ? m(new Error("dest already exists.")) : d(u, p, E, m),
    );
  }
  function d(u, p, E, y) {
    e.rename(u, p, (m) =>
      m ? (m.code !== "EXDEV" ? y(m) : l(u, p, E, y)) : y(),
    );
  }
  function l(u, p, E, y) {
    r(
...
function Hd() {
  ...
  function i(l, u, p) {
    p = p || {};
    const E = p.overwrite || p.clobber || !1,
      { srcStat: y, isChangingCase: m = !1 } = s.checkPathsSync(
        l,
        u,
        "move",
        p,
    ...
    return (
      s.checkParentPathsSync(l, y, u, "move"),
      f(u) || a(t.dirname(u)),
      o(l, u, E, m)
    );
  }
...
function Lo() {
  ...
  ((Ga = 1),
    ...
    (qt.CancellationError = qt.CancellationToken = void 0));
  const e = yc;
  let t = class extends e.EventEmitter {
    ...
    removeParentCancelHandler() {
      ...
      a != null &&
        this.parentCancelHandler != null &&
        (a.removeListener("cancel", this.parentCancelHandler),
        (this.parentCancelHandler = null));
    }
    dispose() {
      try {
...
function Gd() {
  ...
  ei = function (d, l) {
    l = l || {};
    var u = typeof d;
    if (u === "string" && d.length > 0) return i(d);
    if (u === "number" && isFinite(d)) return l.long ? o(d) : f(d);
    throw new Error(
  ...
  function e(t) {
    ...
    function n(l) {
      ...
      function m(...T) {
        ...
        let S = 0;
        ((T[0] = T[0].replace(/%([a-zA-Z%])/g, (I, v) => {
          if (I === "%%") return "%";
          S++;
          const C = n.formatters[v];
          if (typeof C == "function") {
            const _ = T[S];
            ((I = C.call(A, _)), T.splice(S, 1), S--);
          }
          return I;
        })),
          n.formatArgs.call(A, T),
          (A.log || n.log).apply(A, T));
      }
      return (
        (m.namespace = l),
        (m.useColors = n.useColors()),
        (m.color = n.selectColor(l)),
        (m.extend = a),
        (m.destroy = n.destroy),
        Object.defineProperty(m, "enabled", {
          ...
          get: () =>
            p !== null
              ? p
              : (E !== n.namespaces && ((E = n.namespaces), (y = n.enabled(l))),
                y),
          set: (T) => {
            p = T;
          },
    ...
    function i(l, u) {
      ...
      for (; p < l.length; )
        if (E < u.length && (u[E] === l[p] || u[E] === "*"))
          u[E] === "*" ? ((y = E), (m = p), E++) : (p++, E++);
        else if (y !== -1) ((E = y + 1), m++, (p = m));
        else return !1;
      for (; E < u.length && u[E] === "*"; ) E++;
      return E === u.length;
    }
    function f() {
      const l = [...n.names, ...n.skips.map((u) => "-" + u)].join(",");
      return (n.enable(""), l);
    }
    function o(l) {
      for (const u of n.skips) if (i(l, u)) return !1;
      for (const u of n.names) if (i(l, u)) return !0;
      return !1;
    }
    function h(l) {
        ...
        function r() {
          ...
          return (
            ...
            (typeof navigator < "u" &&
              ...
              parseInt(o[1], 10) >= 31) || // Double check webkit in userAgent just in case we are in a worker
            (typeof navigator < "u" &&
              navigator.userAgent &&
...
function Yd() {
  ...
  function i(o, h) {
    ...
    if (o && !h && a === void 0) return 0;
    const d = a || 0;
    if (n.TERM === "dumb") return d;
    if (process.platform === "win32") {
      const l = e.release().split(".");
      return Number(l[0]) >= 10 && Number(l[2]) >= 10586
        ? Number(l[2]) >= 14931
          ? 3
          : 2
        : 1;
    ...
    if ("CI" in n)
      return [
        ...
        "GITHUB_ACTIONS",
        "BUILDKITE",
      ].some((l) => l in n) || n.CI_NAME === "codeship"
        ? 1
        : d;
        ...
        t.inspectOpts = Object.keys(process.env)
          ...
          .reduce((u, p) => {
            const E = p
              .substring(6)
              .toLowerCase()
              .replace(/_([a-z])/g, (m, T) => T.toUpperCase());
            let y = process.env[p];
            return (
...
` + T,
              ...
              u.push(m + "m+" + e.exports.humanize(this.diff) + "\x1B[0m"));
          } else u[0] = i() + p + " " + u[0];
        }
        function i() {
        ...
        function f(...u) {
          return process.stderr.write(
            n.formatWithOptions(t.inspectOpts, ...u) +
              `
`,
          );
        }
...
function Rc() {
  ...
  ((Za = 1),
    ...
    (sr.ProgressCallbackTransform = void 0));
  const e = Dr;
      ...
      (i >= this.nextUpdate &&
        ...
        this.onProgress({
          ...
          bytesPerSecond: Math.round(
            this.transferred / ((i - this.start) / 1e3),
          ),
        }),
        (this.delta = 0)),
        s(null, n));
...
function Kd() {
  ...
  ((es = 1),
    ...
    (Ye.createHttpError = h),
    (Ye.parseJson = u),
    (Ye.configureRequestOptionsFromUrl = y),
    (Ye.configureRequestUrl = m),
    (Ye.safeGetHeader = N),
    (Ye.configureRequestOptions = S),
    (Ye.safeStringifyJson = b));
  const e = dt,
    t = Xd(),
    r = At,
    n = Dr,
    ...
    i = ln(),
    f = Rc(),
    o = (0, t.default)("electron-builder");
  function h(I, v = null) {
    return new l(
      I.statusCode || -1,
...
Headers: ` +
  ...
  Ye.HttpError = l;
  function u(I) {
    return I.then((v) => (v == null || v.length === 0 ? null : JSON.parse(v)));
  }
  class p {
    constructor() {
    ...
    request(v, C = new s.CancellationToken(), _) {
      S(v);
      const U = _ == null ? void 0 : JSON.stringify(_),
        x = U ? Buffer.from(U) : void 0;
      if (x != null) {
        o(U);
        const { headers: $, ...F } = v;
        v = {
    ...
    doApiRequest(v, C, _, U = 0) {
      return (
        ...
        C.createPromise((x, $, F) => {
          ...
          (this.addErrorAndTimeoutHandlers(L, $, v.timeout),
            this.addRedirectHandlers(L, v, $, U, (j) => {
    ...
    handleResponse(v, C, _, U, x, $, F) {
      ...
      if (
        (o.enabled &&
          o(
            `Response: ${v.statusCode} ${v.statusMessage}, request options: ${b(C)}`,
          ),
        v.statusCode === 404)
      ) {
        x(
          h(
            v,
            `method: ${C.method || "GET"} url: ${C.protocol || "https:"}//${C.hostname}${C.port ? `:${C.port}` : ""}${C.path}
...
`,
      ...
      const j = (L = v.statusCode) !== null && L !== void 0 ? L : 0,
        k = j >= 300 && j < 400,
        G = N(v, "location");
      if (k && G != null) {
        ...
        this.doApiRequest(p.prepareRedirectUrlOptions(G, C), _, F, $)
          .then(U)
          .catch(x);
        return;
      }
        ...
        v.on("end", () => {
          try {
            if (v.statusCode != null && v.statusCode >= 400) {
              const ee = N(v, "content-type"),
                pe =
                  ee != null &&
                  (Array.isArray(ee)
                    ? ee.find((Z) => Z.includes("json")) != null
                    : ee.includes("json"));
              x(
                h(
                  v,
    ...
    doDownload(v, C, _) {
      const U = this.createRequest(v, (x) => {
        if (x.statusCode >= 400) {
          C.callback(
            new Error(
              `Cannot download "${v.protocol || "https:"}//${v.hostname}${v.path}", status ${x.statusCode}: ${x.statusMessage}`,
            ),
          );
          return;
        }
        ...
        if ($ != null) {
          _ < this.maxRedirects
            ? this.doDownload(p.prepareRedirectUrlOptions($, v), C, _++)
            : C.callback(this.createMaxRedirectError());
          return;
        }
        C.responseHandler == null ? D(C, x) : C.responseHandler(x, C.callback);
      });
      (this.addErrorAndTimeoutHandlers(U, C.callback, v.timeout),
        this.addRedirectHandlers(U, v, C.callback, _, (x) => {
    ...
    static prepareRedirectUrlOptions(v, C) {
      const _ = y(v, { ...C }),
        U = _.headers;
      if (U?.authorization) {
        const x = p.reconstructOriginalUrl(C),
          $ = E(v, C);
        p.isCrossOriginRedirect(x, $) &&
          (o.enabled &&
            o(
              `Given the cross-origin redirect (from ${x.host} to ${$.host}), the Authorization header will be stripped out.`,
            ),
          delete U.authorization);
      }
      return _;
    }
    static reconstructOriginalUrl(v) {
      const C = v.protocol || "https:";
      if (!v.hostname) throw new Error("Missing hostname in request options");
      const _ = v.hostname,
        U = v.port ? `:${v.port}` : "",
        x = v.path || "/";
    ...
    static isCrossOriginRedirect(v, C) {
      if (v.hostname.toLowerCase() !== C.hostname.toLowerCase()) return !0;
      if (
        v.protocol === "http:" && // This can be replaced with `!originalUrl.port`, but for the sake of clarity.
        ["80", ""].includes(v.port) &&
        C.protocol === "https:" && // This can be replaced with `!redirectUrl.port`, but for the sake of clarity.
        ["443", ""].includes(C.port)
      )
        return !1;
      if (v.protocol !== C.protocol) return !0;
      const _ = v.port,
        U = C.port;
      return _ !== U;
    }
    static retryOnServerError(v, C = 3) {
      for (let _ = 0; ; _++)
        try {
          ...
          if (
            _ < C &&
            ((U instanceof l && U.isServerError()) || U.code === "EPIPE")
          )
            continue;
          throw U;
        }
  ...
  function m(I, v) {
    ((v.protocol = I.protocol),
      (v.hostname = I.hostname),
      I.port ? (v.port = I.port) : v.port && delete v.port,
      (v.path = I.pathname + I.search));
  }
  class T extends n.Transform {
    ...
    constructor(v, C = "sha512", _ = "base64") {
      (super(),
        ...
        (this.digester = (0, e.createHash)(C)));
    }
    // noinspection JSUnusedGlobalSymbols
    _transform(v, C, _) {
  ...
  function A(I, v, C) {
    return I != null && v != null && I !== v
      ? (C(
          new Error(
            `checksum mismatch: expected ${v} but got ${I} (X-Checksum-Sha2 header)`,
          ),
        ),
        !1)
      : !0;
  ...
  function D(I, v) {
    if (!A(N(v, "X-Checksum-Sha2"), I.options.sha2, I.callback)) return;
    const C = [];
    if (I.options.onProgress != null) {
      const $ = N(v, "content-length");
      $ != null &&
        C.push(
          new f.ProgressCallbackTransform(
            parseInt($, 10),
            I.options.cancellationToken,
            I.options.onProgress,
          ),
        );
    }
    const _ = I.options.sha512;
    _ != null
      ? C.push(
          new T(
            _,
      ...
      : I.options.sha2 != null &&
        C.push(new T(I.options.sha2, "sha256", "hex"));
    const U = (0, r.createWriteStream)(I.destination);
    C.push(U);
    let x = v;
    for (const $ of C)
      ($.on("error", (F) => {
        (U.close(), I.options.cancellationToken.cancelled || I.callback(F));
      }),
        (x = x.pipe($)));
    U.on("finish", () => {
      U.close(I.callback);
  ...
  function S(I, v, C) {
    (C != null && (I.method = C), (I.headers = { ...I.headers }));
    const _ = I.headers;
    return (
      v != null &&
        (_.authorization =
          v.startsWith("Basic") || v.startsWith("Bearer") ? v : `token ${v}`),
      _["User-Agent"] == null && (_["User-Agent"] = "electron-builder"),
      (C == null || C === "GET" || _["Cache-Control"] == null) &&
...
function Jd() {
  ...
  let e = class {
    ...
    get value() {
      ...
      if (this._value !== void 0 && t(this.selected, n)) return this._value;
      this.selected = n;
...
function Qd() {
  ...
  ((rs = 1),
    ...
    (zt.githubUrl = e),
    (zt.githubTagPrefix = t),
    (zt.getS3LikeProviderBaseUrl = r));
  function e(i, f = "github.com") {
    return `${i.protocol || "https"}://${i.host || f}`;
  }
  function t(i) {
    var f;
    return i.tagNamePrefix
      ? i.tagNamePrefix
      : !((f = i.vPrefixedTagName) !== null && f !== void 0) || f
        ? "v"
        : "";
  }
  function r(i) {
  ...
  function n(i) {
    ...
    else if (i.endpoint != null) f = `${i.endpoint}/${i.bucket}`;
    else if (i.bucket.includes(".")) {
      if (i.region == null)
        throw new Error(
          `Bucket name "${i.bucket}" includes a dot, but S3 region is missing`,
        );
      i.region === "us-east-1"
        ? (f = `https://s3.amazonaws.com/${i.bucket}`)
        : (f = `https://s3-${i.region}.amazonaws.com/${i.bucket}`);
    } else
      i.region === "cn-north-1"
        ? (f = `https://${i.bucket}.s3.${i.region}.amazonaws.com.cn`)
        : (f = `https://${i.bucket}.s3.amazonaws.com`);
    return a(f, i.path);
  }
  function a(i, f) {
    return (
      f != null && f.length > 0 && (f.startsWith("/") || (i += "/"), (i += f)),
      i
    );
  }
  function s(i) {
    if (i.name == null) throw new Error("name is missing");
    if (i.region == null) throw new Error("region is missing");
...
function Zd() {
  ...
  async function t(r, n) {
    ...
    const {
      ...
      attempt: o = 0,
      shouldRetry: h,
      cancellationToken: d = new e.CancellationToken(),
    } = n;
    try {
      return await r();
    } catch (l) {
      if (
        (await Promise.resolve(
          (a = h?.(l)) !== null && a !== void 0 ? a : !0,
        )) &&
        s > 0 &&
        !d.cancelled
      )
        return (
          await new Promise((u) => setTimeout(u, i + f * o)),
          await t(r, { ...n, retries: s - 1, attempt: o + 1 })
        );
      throw l;
    }
  }
...
function tf() {
  ...
  ((os = 1),
    ...
    (Bt.nil = Bt.UUID = void 0));
  const e = dt,
    t = ln(),
    r = "options.name must be either a string or a Buffer",
    n = (0, e.randomBytes)(16);
  n[0] = n[0] | 1;
  const a = {},
    s = [];
  for (let l = 0; l < 256; l++) {
  ...
  class i {
    constructor(u) {
      ...
      ((this.version = p.version),
        p.format === "ascii" ? (this.ascii = u) : (this.binary = u));
    }
    static v5(u, p) {
    ...
    as ||
      ...
      (function (e) {
        (function (t) {
          ...
          function n(w, g) {
            if (!(this instanceof n)) return new n(w, g);
            var q = this;
            (s(q),
              (q.q = q.c = ""),
              (q.bufferCheckPosition = t.MAX_BUFFER_LENGTH),
              (q.encoding = null),
              (q.opt = g || {}),
              (q.opt.lowercase = q.opt.lowercase || q.opt.lowercasetags),
              (q.looseCase = q.opt.lowercase ? "toLowerCase" : "toUpperCase"),
              (q.opt.maxEntityCount = q.opt.maxEntityCount || 512),
              (q.opt.maxEntityDepth = q.opt.maxEntityDepth || 4),
              (q.entityCount = q.entityDepth = 0),
              (q.tags = []),
              (q.closed = q.closedRoot = q.sawRoot = !1),
              (q.tag = q.error = null),
              (q.strict = !!w),
              (q.noscript = !!(w || q.opt.noscript)),
              (q.state = _.BEGIN),
              (q.strictEntities = q.opt.strictEntities),
              (q.ENTITIES = q.strictEntities
                ? Object.create(t.XML_ENTITIES)
                : Object.create(t.ENTITIES)),
              (q.attribList = []),
              q.opt.xmlns && (q.ns = Object.create(m)),
              q.opt.unquotedAttributeValues === void 0 &&
                (q.opt.unquotedAttributeValues = !w),
              (q.trackPosition = q.opt.position !== !1),
              q.trackPosition && (q.position = q.line = q.column = 0),
              x(q, "onready"));
          }
          (Object.create ||
            (Object.create = function (w) {
              function g() {}
              g.prototype = w;
              var q = new g();
              return q;
          ...
          function a(w) {
            for (
              var g = Math.max(t.MAX_BUFFER_LENGTH, 10),
                q = 0,
                P = 0,
                _e = r.length;
              P < _e;
            ...
            w.bufferCheckPosition = De + w.position;
          }
          function s(w) {
            for (var g = 0, q = r.length; g < q; g++) w[r[g]] = "";
          }
          function i(w) {
            (G(w),
              w.cdata !== "" && (k(w, "oncdata", w.cdata), (w.cdata = "")),
              w.script !== "" && (k(w, "onscript", w.script), (w.script = "")));
          }
          n.prototype = {
            end: function () {
              pe(this);
          ...
          function d(w, g) {
            if (w.length >= 2) {
              if (w[0] === 255 && w[1] === 254) return "utf-16le";
              if (w[0] === 254 && w[1] === 255) return "utf-16be";
            }
            return w.length >= 3 && w[0] === 239 && w[1] === 187 && w[2] === 191
              ? "utf8"
              : w.length >= 4
                ? w[0] === 60 && w[1] === 0 && w[2] === 63 && w[3] === 0
                  ? "utf-16le"
                  : w[0] === 0 && w[1] === 60 && w[2] === 0 && w[3] === 63
                    ? "utf-16be"
                    : "utf8"
                : g
                  ? "utf8"
          ...
          function l(w, g) {
            if (!(this instanceof l)) return new l(w, g);
            (f.apply(this),
              (this._parser = new n(w, g)),
              (this.writable = !0),
              (this.readable = !0));
            var q = this;
          ...
          ((l.prototype = Object.create(f.prototype, {
            ...
            (l.prototype._decodeBuffer = function (w, g) {
              if (
                (this._decoderBuffer &&
                  ((w = Buffer.concat([this._decoderBuffer, w])),
                  (this._decoderBuffer = null)),
                !this._decoder)
              ) {
                var q = d(w, g);
                if (!q) return ((this._decoderBuffer = w), "");
                ((this._parser.encoding = q),
                  (this._decoder = new TextDecoder(q)));
              }
...
` ||
          ...
          ((t.STATE = {
            ...
            Object.keys(t.ENTITIES).forEach(function (w) {
              var g = t.ENTITIES[w],
                q = typeof g == "number" ? String.fromCharCode(g) : g;
              t.ENTITIES[w] = q;
            }));
          for (var U in t.STATE) t.STATE[t.STATE[U]] = U;
          _ = t.STATE;
          function x(w, g, q) {
            w[g] && w[g](q);
          }
          ...
          function G(w) {
            ((w.textNode = Y(w.opt, w.textNode)),
              w.textNode && x(w, "ontext", w.textNode),
              (w.textNode = ""));
          }
          function Y(w, g) {
            return (
              w.trim && (g = g.trim()),
              w.normalize && (g = g.replace(/\s+/g, " ")),
              g
            );
          }
          function ee(w, g) {
...
Char: ` +
          ...
          function pe(w) {
            return (
              w.sawRoot && !w.closedRoot && Z(w, "Unclosed root tag"),
              w.state !== _.BEGIN &&
                w.state !== _.BEGIN_WHITESPACE &&
                w.state !== _.TEXT &&
                ee(w, "Unexpected end"),
              G(w),
              (w.c = ""),
          ...
          function ye(w) {
            ...
            var g = w.tags[w.tags.length - 1] || w,
              q = (w.tag = { name: w.tagName, attributes: {} });
            (w.opt.xmlns && (q.ns = g.ns),
              (w.attribList.length = 0),
              k(w, "onopentagstart", q));
          }
          function me(w, g) {
            var q = w.indexOf(":"),
              P = q < 0 ? ["", w] : w.split(":"),
              ...
              Te = P[1];
            return (
              g && w === "xmlns" && ((_e = "xmlns"), (Te = "")),
              { prefix: _e, local: Te }
            );
          }
          function Q(w) {
            if (
              (w.strict || (w.attribName = w.attribName[w.looseCase]()),
              w.attribList.indexOf(w.attribName) !== -1 ||
                w.tag.attributes.hasOwnProperty(w.attribName))
            ) {
              w.attribName = w.attribValue = "";
              return;
            }
            if (w.opt.xmlns) {
              var g = me(w.attribName, !0),
                q = g.prefix,
                P = g.local;
              if (q === "xmlns")
...
Actual: ` +
                  ...
                  var _e = w.tag,
                    Te = w.tags[w.tags.length - 1] || w;
                  (_e.ns === Te.ns && (_e.ns = Object.create(Te.ns)),
                    (_e.ns[P] = w.attribValue));
                }
              w.attribList.push([w.attribName, w.attribValue]);
            } else
              ((w.tag.attributes[w.attribName] = w.attribValue),
                k(w, "onattribute", {
                  name: w.attribName,
                  value: w.attribValue,
                }));
          ...
          function de(w, g) {
            if (w.opt.xmlns) {
              ...
              q.ns &&
                _e.ns !== q.ns &&
                Object.keys(q.ns).forEach(function (ne) {
                  k(w, "onopennamespace", {
                    prefix: ne,
                    uri: q.ns[ne],
                  });
                });
              for (var Te = 0, De = w.attribList.length; Te < De; Te++) {
                var $e = w.attribList[Te],
                  Me = $e[0],
                  We = $e[1],
                  c = me(Me, !0),
                  B = c.prefix,
                ...
                (B &&
                  B !== "xmlns" &&
                  !ie &&
                  (Z(w, "Unbound namespace prefix: " + JSON.stringify(B)),
                  (V.uri = B)),
                  (w.tag.attributes[Me] = V),
                  k(w, "onattribute", V));
              }
              w.attribList.length = 0;
            }
            ((w.tag.isSelfClosing = !!g),
              (w.sawRoot = !0),
              w.tags.push(w.tag),
              k(w, "onopentag", w.tag),
              g ||
                (!w.noscript && w.tagName.toLowerCase() === "script"
                  ? (w.state = _.SCRIPT)
                  : (w.state = _.TEXT),
                (w.tag = null),
                (w.tagName = "")),
          ...
          function we(w) {
            ...
            for (var P = q; g--; ) {
              var _e = w.tags[g];
              if (_e.name !== P) Z(w, "Unexpected close tag");
              else break;
            }
            if (g < 0) {
              (Z(w, "Unmatched closing tag: " + w.tagName),
                (w.textNode += "</" + w.tagName + ">"),
                (w.state = _.TEXT));
              return;
            }
            w.tagName = q;
            for (var Te = w.tags.length; Te-- > g; ) {
              var De = (w.tag = w.tags.pop());
              ((w.tagName = w.tag.name), k(w, "onclosetag", w.tagName));
              var $e = {};
              for (var Me in De.ns) $e[Me] = De.ns[Me];
              var We = w.tags[w.tags.length - 1] || w;
              w.opt.xmlns &&
                De.ns !== We.ns &&
                Object.keys(De.ns).forEach(function (c) {
                  var B = De.ns[c];
                  k(w, "onclosenamespace", { prefix: c, uri: B });
                });
            }
            (g === 0 && (w.closedRoot = !0),
              (w.tagName = w.attribValue = w.attribName = ""),
              (w.attribList.length = 0),
              (w.state = _.TEXT));
          }
          function Re(w) {
                  ...
                  g.charAt(0) === "#" &&
                    (g.charAt(1) === "x"
                      ...
                      : ((g = g.slice(1)),
                        ...
                        (_e = P.toString(10)))),
                  (g = g.replace(/^0+/, "")),
                  isNaN(P) || _e.toLowerCase() !== g || P < 0 || P > 1114111
                    ? (Z(w, "Invalid character entity"), "&" + w.entity + ";")
                    : String.fromCodePoint(P));
          }
          function Ne(w, g) {
            g === "<"
              ? ((w.state = _.OPEN_WAKA), (w.startTagPosition = w.position))
              : S(g) ||
                (Z(w, "Non-whitespace before first tag."),
                (w.textNode = g),
                (w.state = _.TEXT));
          }
          function Ce(w, g) {
...
`
                  ...
                  P === "<" && !(g.sawRoot && g.closedRoot && !g.strict)
                    ? ((g.state = _.OPEN_WAKA),
                      (g.startTagPosition = g.position))
                    : (!S(P) &&
                        (!g.sawRoot || g.closedRoot) &&
                        Z(g, "Text data outside of root node."),
                      P === "&"
                        ? (g.state = _.TEXT_ENTITY)
                        : (g.textNode += P));
                  continue;
                case _.SCRIPT:
                ...
                case _.SCRIPT_ENDING:
                  P === "/"
                    ? (g.state = _.CLOSE_TAG)
                    : ((g.script += "<" + P), (g.state = _.SCRIPT));
                  continue;
                case _.OPEN_WAKA:
                  if (P === "!") ((g.state = _.SGML_DECL), (g.sgmlDecl = ""));
                  else if (!S(P))
                    if (v(T, P)) ((g.state = _.OPEN_TAG), (g.tagName = P));
                    else if (P === "/")
                      ((g.state = _.CLOSE_TAG), (g.tagName = ""));
                    else if (P === "?")
                      ((g.state = _.PROC_INST),
                        (g.procInstName = g.procInstBody = ""));
                    else {
                      if (
                        (Z(g, "Unencoded <"),
                        g.startTagPosition + 1 < g.position)
                      ) {
                ...
                case _.SGML_DECL:
                  ...
                  g.doctype && g.doctype !== !0 && g.sgmlDecl
                    ? ((g.state = _.DOCTYPE_DTD),
                      (g.doctype += "<!" + g.sgmlDecl + P),
                      (g.sgmlDecl = ""))
                    : (g.sgmlDecl + P).toUpperCase() === u
                      ? (k(g, "onopencdata"),
                        (g.state = _.CDATA),
                        (g.sgmlDecl = ""),
                        (g.cdata = ""))
                      : (g.sgmlDecl + P).toUpperCase() === p
                        ? ((g.state = _.DOCTYPE),
                          (g.doctype || g.sawRoot) &&
                            Z(g, "Inappropriately located doctype declaration"),
                          (g.doctype = ""),
                          (g.sgmlDecl = ""))
                        : P === ">"
                          ? (k(g, "onsgmldeclaration", g.sgmlDecl),
                            (g.sgmlDecl = ""),
                            (g.state = _.TEXT))
                          : (b(P) && (g.state = _.SGML_DECL_QUOTED),
                            (g.sgmlDecl += P));
                  continue;
                case _.SGML_DECL_QUOTED:
                  (P === g.q && ((g.state = _.SGML_DECL), (g.q = "")),
                    (g.sgmlDecl += P));
                  continue;
                case _.DOCTYPE:
                  P === ">"
                    ? ((g.state = _.TEXT),
                      k(g, "ondoctype", g.doctype),
                      (g.doctype = !0))
                    : ((g.doctype += P),
                      P === "["
                        ? (g.state = _.DOCTYPE_DTD)
                        : b(P) && ((g.state = _.DOCTYPE_QUOTED), (g.q = P)));
                  continue;
                case _.DOCTYPE_QUOTED:
                  ((g.doctype += P),
                    P === g.q && ((g.q = ""), (g.state = _.DOCTYPE)));
                  continue;
                case _.DOCTYPE_DTD:
                  P === "]"
                    ? ((g.doctype += P), (g.state = _.DOCTYPE))
                    : P === "<"
                      ? ((g.state = _.OPEN_WAKA),
                        (g.startTagPosition = g.position))
                      : b(P)
                        ? ((g.doctype += P),
                          (g.state = _.DOCTYPE_DTD_QUOTED),
                          (g.q = P))
                        : (g.doctype += P);
                  continue;
                case _.DOCTYPE_DTD_QUOTED:
                  ((g.doctype += P),
                    P === g.q && ((g.state = _.DOCTYPE_DTD), (g.q = "")));
                  continue;
                case _.COMMENT:
                ...
                case _.COMMENT_ENDING:
                  P === "-"
                    ? ((g.state = _.COMMENT_ENDED),
                      (g.comment = Y(g.opt, g.comment)),
                      g.comment && k(g, "oncomment", g.comment),
                      (g.comment = ""))
                    : ((g.comment += "-" + P), (g.state = _.COMMENT));
                  continue;
                case _.COMMENT_ENDED:
                  P !== ">"
                    ? (Z(g, "Malformed comment"),
                      (g.comment += "--" + P),
                      (g.state = _.COMMENT))
                    : g.doctype && g.doctype !== !0
                      ? (g.state = _.DOCTYPE_DTD)
                      : (g.state = _.TEXT);
                  continue;
                case _.CDATA:
...
`
                          ? (g.line++, (g.column = 0))
                          : g.column++));
                  ((g.cdata += w.substring(Te, q - 1)),
                    P === "]" && (g.state = _.CDATA_ENDING));
                  continue;
                case _.CDATA_ENDING:
                  P === "]"
                    ? (g.state = _.CDATA_ENDING_2)
                    : ((g.cdata += "]" + P), (g.state = _.CDATA));
                  continue;
                case _.CDATA_ENDING_2:
                  P === ">"
                    ? (g.cdata && k(g, "oncdata", g.cdata),
                      k(g, "onclosecdata"),
                      (g.cdata = ""),
                      (g.state = _.TEXT))
                    : P === "]"
                ...
                case _.PROC_INST:
                  P === "?"
                    ? (g.state = _.PROC_INST_ENDING)
                    : S(P)
                      ? (g.state = _.PROC_INST_BODY)
                      : (g.procInstName += P);
                  continue;
                case _.PROC_INST_BODY:
                  if (!g.procInstBody && S(P)) continue;
                  P === "?"
                    ? (g.state = _.PROC_INST_ENDING)
                    : (g.procInstBody += P);
                  continue;
                case _.PROC_INST_ENDING:
                  if (P === ">") {
                    ...
                    (j(g, We),
                      k(g, "onprocessinginstruction", We),
                      (g.procInstName = g.procInstBody = ""),
                      (g.state = _.TEXT));
                  } else
                  ...
                  v(A, P)
                    ...
                    : (ye(g),
                      P === ">"
                        ? de(g)
                        : P === "/"
                          ? (g.state = _.OPEN_TAG_SLASH)
                          : (S(P) || Z(g, "Invalid character in tag name"),
                            (g.state = _.ATTRIB)));
                  continue;
                case _.OPEN_TAG_SLASH:
                  P === ">"
                    ? (de(g, !0), we(g))
                    : (Z(g, "Forward-slash in opening tag not followed by >"),
                      (g.state = _.ATTRIB));
                  continue;
                case _.ATTRIB:
                  if (S(P)) continue;
                  P === ">"
                    ...
                    : P === "/"
                      ...
                      : v(T, P)
                        ? ((g.attribName = P),
                          (g.attribValue = ""),
                          (g.state = _.ATTRIB_NAME))
                        : Z(g, "Invalid attribute name");
                  continue;
                case _.ATTRIB_NAME:
                  P === "="
                    ? (g.state = _.ATTRIB_VALUE)
                    : P === ">"
                      ? (Z(g, "Attribute without value"),
                        (g.attribValue = g.attribName),
                        Q(g),
                        de(g))
                      : S(P)
                        ? (g.state = _.ATTRIB_NAME_SAW_WHITE)
                        : v(A, P)
                          ? (g.attribName += P)
                          : Z(g, "Invalid attribute name");
                  continue;
                case _.ATTRIB_NAME_SAW_WHITE:
                  if (P === "=") g.state = _.ATTRIB_VALUE;
                  else {
                    if (S(P)) continue;
                    (Z(g, "Attribute without value"),
                      (g.tag.attributes[g.attribName] = ""),
                      (g.attribValue = ""),
                      k(g, "onattribute", {
                        name: g.attribName,
                        value: "",
                      ...
                      P === ">"
                        ? de(g)
                        : v(T, P)
                          ? ((g.attribName = P), (g.state = _.ATTRIB_NAME))
                          : (Z(g, "Invalid attribute name"),
                            (g.state = _.ATTRIB)));
                  }
                  continue;
                case _.ATTRIB_VALUE:
                  if (S(P)) continue;
                  b(P)
                    ? ((g.q = P), (g.state = _.ATTRIB_VALUE_QUOTED))
                    : (g.opt.unquotedAttributeValues ||
                        ee(g, "Unquoted attribute value"),
                      (g.state = _.ATTRIB_VALUE_UNQUOTED),
                      (g.attribValue = P));
                  continue;
                case _.ATTRIB_VALUE_QUOTED:
                  if (P !== g.q) {
                    P === "&"
                      ? (g.state = _.ATTRIB_VALUE_ENTITY_Q)
                      : (g.attribValue += P);
                    continue;
                  }
                  ...
                  S(P)
                    ...
                    : P === ">"
                      ...
                      : P === "/"
                        ? (g.state = _.OPEN_TAG_SLASH)
                        : v(T, P)
                          ? (Z(g, "No whitespace between attributes"),
                            (g.attribName = P),
                            (g.attribValue = ""),
                            (g.state = _.ATTRIB_NAME))
                          : Z(g, "Invalid attribute name");
                ...
                case _.ATTRIB_VALUE_UNQUOTED:
                  if (!I(P)) {
                    P === "&"
                      ? (g.state = _.ATTRIB_VALUE_ENTITY_U)
                      : (g.attribValue += P);
                    continue;
                  }
                  ...
                  if (g.tagName)
                    P === ">"
                      ...
                      : v(A, P)
                        ? (g.tagName += P)
                        : g.script
                          ? ((g.script += "</" + g.tagName + P),
                            (g.tagName = ""),
                            (g.state = _.SCRIPT))
                          : (S(P) || Z(g, "Invalid tagname in closing tag"),
                            (g.state = _.CLOSE_TAG_SAW_WHITE));
                  else {
                    if (S(P)) continue;
                    C(T, P)
                      ? g.script
                        ? ((g.script += "</" + P), (g.state = _.SCRIPT))
                        : Z(g, "Invalid tagname in closing tag.")
                      : (g.tagName = P);
                  }
                  continue;
                ...
                case _.ATTRIB_VALUE_ENTITY_U:
                  ...
                  if (P === ";") {
                    var Me = Re(g);
                    g.opt.unparsedEntities &&
                    !Object.values(t.XML_ENTITIES).includes(Me)
                      ? ((g.entityCount += 1) > g.opt.maxEntityCount &&
                          ee(g, "Parsed entity count exceeds max entity count"),
                        (g.entityDepth += 1) > g.opt.maxEntityDepth &&
                          ee(g, "Parsed entity depth exceeds max entity depth"),
                        (g.entity = ""),
                        (g.state = De),
                        g.write(Me),
                        (g.entityDepth -= 1))
                      : ((g[$e] += Me), (g.entity = ""), (g.state = De));
                  } else
                    v(g.entity.length ? D : N, P)
                      ? (g.entity += P)
                      : (Z(g, "Invalid character in entity name"),
                        (g[$e] += "&" + g.entity + P),
                        (g.entity = ""),
                        (g.state = De));
                  continue;
              ...
              var w = String.fromCharCode,
                ...
                q = function () {
                  ...
                  for (var We = ""; ++$e < Me; ) {
                    ...
                    if (
                      !isFinite(c) || // `NaN`, `+Infinity`, or `-Infinity`
                    ...
                    (c <= 65535
                      ...
                      : ((c -= 65536),
                        ...
                        _e.push(Te, De)),
                      ($e + 1 === Me || _e.length > P) &&
                        ((We += w.apply(null, _e)), (_e.length = 0)));
                  }
                  return We;
                };
...
function nf() {
  ...
  class r {
    ...
    elementOrNull(o, h = !1) {
      ...
      for (const d of this.elements) if (s(d, o, h)) return d;
      return null;
    }
    getElements(o, h = !1) {
      return this.elements === null
        ? []
        : this.elements.filter((d) => s(d, o, h));
    }
  ...
  function s(f, o, h) {
    ...
    return (
      d === o ||
      (h === !0 && d.length === o.length && d.toLowerCase() === o.toLowerCase())
    );
  }
  function i(f) {
    let o = null;
    ...
    return (
      (h.onopentag = (l) => {
        ...
        if (((u.attributes = l.attributes), o === null)) o = u;
        else {
...
function Lr() {
  ...
  function e(r, n) {
    var a = "",
      s = r.reason || "(unknown reason)";
    return r.mark
      ? (r.mark.name && (a += 'in "' + r.mark.name + '" '),
        (a += "(" + (r.mark.line + 1) + ":" + (r.mark.column + 1) + ")"),
        !n &&
          r.mark.snippet &&
          (a +=
            `
...
function of() {
  ...
  function t(a, s, i, f, o) {
    var h = "",
      ...
      l = Math.floor(o / 2) - 1;
    return (
      f - s > l && ((h = " ... "), (s = f - l + h.length)),
      i - f > l && ((d = " ..."), (i = f + l - d.length)),
      {
  ...
  function n(a, s) {
    ...
    (s.maxLength || (s.maxLength = 79),
      typeof s.indent != "number" && (s.indent = 1),
      typeof s.linesBefore != "number" && (s.linesBefore = 3),
      typeof s.linesAfter != "number" && (s.linesAfter = 2));
    for (
      var i = /\r?\n|\r|\0/g, f = [0], o = [], h, d = -1;
      (h = i.exec(a.buffer));
    )
      (o.push(h.index),
        f.push(h.index + h[0].length),
        a.position <= h.index && d < 0 && (d = f.length - 2));
    d < 0 && (d = f.length - 1);
    var l = "",
      u,
      p,
      E = Math.min(a.line + s.linesAfter, o.length).toString().length,
      y = s.maxLength - (s.indent + E + 3);
    for (u = 1; u <= s.linesBefore && !(d - u < 0); u++)
      ((p = t(a.buffer, f[d - u], o[d - u], a.position - (f[d] - f[d - u]), y)),
        (l =
          e.repeat(" ", s.indent) +
          r((a.line - u + 1).toString(), E) +
          " | " +
          p.str +
          `
` +
          l));
    for (
      p = t(a.buffer, f[d], o[d], a.position, y),
        l +=
          e.repeat(" ", s.indent) +
          r((a.line + 1).toString(), E) +
          " | " +
          p.str +
          `
`,
        l +=
          e.repeat("-", s.indent + E + 3 + p.pos) +
          `^
`,
        u = 1;
      u <= s.linesAfter && !(d + u >= o.length);
      u++
    )
      ((p = t(a.buffer, f[d + u], o[d + u], a.position - (f[d] - f[d + u]), y)),
        (l +=
...
function Je() {
  ...
  function a(s, i) {
    if (
      ...
      (this.styleAliases = n(i.styleAliases || null)),
      r.indexOf(this.kind) === -1)
    )
      throw new e(
        'Unknown kind "' +
          this.kind +
...
function Ic() {
  ...
  function n() {
    ...
    function o(h) {
      h.multi
        ? (s.multi[h.kind].push(h), s.multi.fallback.push(h))
        : (s[h.kind][h.tag] = s.fallback[h.tag] = h);
    }
    for (i = 0, f = arguments.length; i < f; i += 1) arguments[i].forEach(o);
    return s;
  }
  function a(s) {
  ...
  return (
    (a.prototype.extend = function (i) {
      ...
      return (
        (h.implicit = (this.implicit || []).concat(f)),
        (h.explicit = (this.explicit || []).concat(o)),
        (h.compiledImplicit = r(h, "implicit")),
        (h.compiledExplicit = r(h, "explicit")),
        (h.compiledTypeMap = n(h.compiledImplicit, h.compiledExplicit)),
        h
      );
    }),
    (li = a),
...
function Sc() {
  ...
  var e = Je();
  return (
    (ci = new e("tag:yaml.org,2002:str", {
      kind: "scalar",
...
function bc() {
  ...
  var e = Je();
  return (
    (ui = new e("tag:yaml.org,2002:seq", {
      kind: "sequence",
      construct: function (t) {
        return t !== null ? t : [];
      },
...
function Cc() {
  ...
  var e = Je();
  return (
    (di = new e("tag:yaml.org,2002:map", {
      kind: "mapping",
      construct: function (t) {
        return t !== null ? t : {};
      },
...
function Oc() {
  ...
  return (
    (hi = new e("tag:yaml.org,2002:null", {
      kind: "scalar",
      resolve: t,
      construct: r,
      predicate: n,
...
function Dc() {
  ...
  function t(a) {
    ...
    var s = a.length;
    return (
      (s === 4 && (a === "true" || a === "True" || a === "TRUE")) ||
      (s === 5 && (a === "false" || a === "False" || a === "FALSE"))
    );
  }
  function r(a) {
  ...
  return (
    (pi = new e("tag:yaml.org,2002:bool", {
      kind: "scalar",
      resolve: t,
      construct: r,
      predicate: n,
...
function Pc() {
  ...
  function r(o) {
    return (
      (48 <= o && o <= 57) || (65 <= o && o <= 70) || (97 <= o && o <= 102)
    );
  }
  function n(o) {
    return 48 <= o && o <= 55;
  ...
  function i(o) {
    var h = o,
      ...
      l;
    if (
      (h.indexOf("_") !== -1 && (h = h.replace(/_/g, "")),
      (l = h[0]),
      (l === "-" || l === "+") &&
        (l === "-" && (d = -1), (h = h.slice(1)), (l = h[0])),
      h === "0")
    )
      return 0;
    if (l === "0") {
  ...
  return (
    (mi = new t("tag:yaml.org,2002:int", {
      kind: "scalar",
      resolve: s,
      construct: i,
      predicate: f,
...
function Fc() {
  ...
  function n(o) {
    return !(
      o === null ||
      !r.test(o) || // Quick hack to not allow integers end with `_`
  ...
  function a(o) {
    var h, d;
    return (
      (h = o.replace(/_/g, "").toLowerCase()),
      (d = h[0] === "-" ? -1 : 1),
      "+-".indexOf(h[0]) >= 0 && (h = h.slice(1)),
      h === ".inf"
        ? d === 1
  ...
  function i(o, h) {
    ...
    else if (e.isNegativeZero(o)) return "-0.0";
    return ((d = o.toString(10)), s.test(d) ? d.replace("e", ".e") : d);
  }
  function f(o) {
    return (
      Object.prototype.toString.call(o) === "[object Number]" &&
      (o % 1 !== 0 || e.isNegativeZero(o))
    );
  }
  return (
    (gi = new t("tag:yaml.org,2002:float", {
      kind: "scalar",
      resolve: n,
      construct: a,
      predicate: f,
...
function Uc() {
  ...
  function a(i) {
    ...
    return (
      f[9] &&
        ...
        (y = (m * 60 + T) * 6e4),
        f[9] === "-" && (y = -y)),
      (A = new Date(Date.UTC(o, h, d, l, u, p, E))),
      y && A.setTime(A.getTime() - y),
      A
    );
  }
  function s(i) {
  ...
  return (
    (wi = new e("tag:yaml.org,2002:timestamp", {
      kind: "scalar",
      resolve: n,
      construct: a,
      instanceOf: Date,
...
function kc() {
  ...
  return (
    (vi = new e("tag:yaml.org,2002:merge", {
      kind: "scalar",
      resolve: t,
    })),
    vi
...
\r`;
  ...
  function n(i) {
    ...
    for (f = 0; f < d; f++)
      (f % 4 === 0 &&
        f &&
        (p.push((u >> 16) & 255), p.push((u >> 8) & 255), p.push(u & 255)),
        (u = (u << 6) | l.indexOf(h.charAt(f))));
    return (
      (o = (d % 4) * 6),
      o === 0
        ? (p.push((u >> 16) & 255), p.push((u >> 8) & 255), p.push(u & 255))
        : o === 18
          ? (p.push((u >> 10) & 255), p.push((u >> 2) & 255))
          : o === 12 && p.push((u >> 4) & 255),
      new Uint8Array(p)
    );
  }
  ...
  return (
    (_i = new e("tag:yaml.org,2002:binary", {
      kind: "scalar",
      resolve: r,
      construct: n,
      predicate: s,
...
function Mc() {
  ...
  return (
    (Ti = new e("tag:yaml.org,2002:omap", {
      kind: "sequence",
      resolve: n,
      construct: a,
    })),
...
function qc() {
  ...
  function r(a) {
    ...
    for (h = new Array(d.length), s = 0, i = d.length; s < i; s += 1) {
      if (
        ((f = d[s]),
        t.call(f) !== "[object Object]" ||
          ((o = Object.keys(f)), o.length !== 1))
      )
        return !1;
      h[s] = [o[0], f[o[0]]];
    }
  ...
  return (
    (Ai = new e("tag:yaml.org,2002:pairs", {
      kind: "sequence",
      resolve: r,
      construct: n,
    })),
...
function Bc() {
  ...
  function r(a) {
    ...
    var s,
      i = a;
    for (s in i) if (t.call(i, s) && i[s] !== null) return !1;
    return !0;
  }
  function n(a) {
    return a !== null ? a : {};
  ...
  return (
    (Ri = new e("tag:yaml.org,2002:set", {
      kind: "mapping",
      resolve: r,
      construct: n,
    })),
...
`
  ...
  var Y = {
    YAML: function (B, W, ie) {
      ...
      (B.version !== null && k(B, "duplication of %YAML directive"),
        ie.length !== 1 && k(B, "YAML directive accepts exactly one argument"),
        (V = /^([0-9]+)\.([0-9]+)$/.exec(ie[0])),
        V === null && k(B, "ill-formed argument of the YAML directive"),
        (ne = parseInt(V[1], 10)),
        (te = parseInt(V[2], 10)),
        ne !== 1 && k(B, "unacceptable YAML version of the document"),
        (B.version = ie[0]),
        (B.checkLineBreaks = te < 2),
        te !== 1 &&
          te !== 2 &&
          G(B, "unsupported YAML version of the document"));
    },
    TAG: function (B, W, ie) {
      var V, ne;
      (ie.length !== 2 && k(B, "TAG directive accepts exactly two arguments"),
        (V = ie[0]),
        (ne = ie[1]),
        y.test(V) ||
        ...
        a.call(B.tagMap, V) &&
          k(
            B,
            'there is a previously declared suffix for "' + V + '" tag handle',
          ),
        m.test(ne) ||
      ...
      if (((ae = c.input.slice(B, W)), ie))
        for (V = 0, ne = ae.length; V < ne; V += 1)
          ((te = ae.charCodeAt(V)),
            te === 9 ||
              (32 <= te && te <= 1114111) ||
              k(c, "expected valid JSON character"));
  ...
  function Z(c, B, W, ie, V, ne, te, ae, ue) {
    ...
    if (Array.isArray(V))
      for (
        V = Array.prototype.slice.call(V), Ie = 0, Se = V.length;
        Ie < Se;
        Ie += 1
      )
        (Array.isArray(V[Ie]) &&
          k(c, "nested arrays are not supported inside keys"),
          typeof V == "object" &&
            T(V[Ie]) === "[object Object]" &&
            (V[Ie] = "[object Object]"));
    if (
      (typeof V == "object" &&
        T(V) === "[object Object]" &&
      ...
      (V = String(V)),
      B === null && (B = {}),
      ie === "tag:yaml.org,2002:merge")
    )
      if (Array.isArray(ne))
        for (Ie = 0, Se = ne.length; Ie < Se; Ie += 1) pe(c, B, ne[Ie], W);
      else pe(c, B, ne, W);
    else
      (!c.json &&
        !a.call(W, V) &&
        a.call(B, V) &&
        ((c.line = te || c.line),
        (c.lineStart = ae || c.lineStart),
        (c.position = ue || c.position),
        k(c, "duplicated mapping key")),
        U(B, V, ne),
        delete W[V]);
    return B;
  }
  function ye(c) {
    var B;
    ((B = c.input.charCodeAt(c.position)),
      B === 10
        ? c.position++
        : B === 13
          ? (c.position++,
            c.input.charCodeAt(c.position) === 10 && c.position++)
          : k(c, "a line break is expected"),
      (c.line += 1),
      (c.lineStart = c.position),
      (c.firstTabInLine = -1));
  }
  function me(c, B, W) {
    for (var ie = 0, V = c.input.charCodeAt(c.position); V !== 0; ) {
      for (; N(V); )
        (V === 9 && c.firstTabInLine === -1 && (c.firstTabInLine = c.position),
          (V = c.input.charCodeAt(++c.position)));
      if (B && V === 35)
        do V = c.input.charCodeAt(++c.position);
        while (V !== 10 && V !== 13 && V !== 0);
      if (A(V))
        for (
          ye(c), V = c.input.charCodeAt(c.position), ie++, c.lineIndent = 0;
          V === 32;
        )
    ...
    return (
      W !== -1 && ie !== 0 && c.lineIndent < W && G(c, "deficient indentation"),
      ie
    );
  }
  function Q(c) {
    var B = c.position,
      W;
    return (
      (W = c.input.charCodeAt(B)),
      !!(
        (W === 45 || W === 46) &&
        W === c.input.charCodeAt(B + 1) &&
        W === c.input.charCodeAt(B + 2) &&
        ((B += 3), (W = c.input.charCodeAt(B)), W === 0 || D(W))
      )
    );
  }
  function de(c, B) {
...
`,
  ...
  function we(c, B, W) {
    var ie,
      ...
      H;
    if (
      ((H = c.input.charCodeAt(c.position)),
      D(H) ||
        S(H) ||
        H === 35 ||
        H === 38 ||
        ...
        H === 96 ||
        ((H === 63 || H === 45) &&
          ((V = c.input.charCodeAt(c.position + 1)), D(V) || (W && S(V)))))
    )
      return !1;
    for (
      c.kind = "scalar", c.result = "", ne = te = c.position, ae = !1;
      H !== 0;
    ) {
      if (H === 58) {
        if (((V = c.input.charCodeAt(c.position + 1)), D(V) || (W && S(V))))
          break;
      } else if (H === 35) {
        if (((ie = c.input.charCodeAt(c.position - 1)), D(ie))) break;
      } else {
        if ((c.position === c.lineStart && Q(c)) || (W && S(H))) break;
        if (A(H))
          if (
            ((ue = c.line),
            (Ie = c.lineStart),
    ...
    return (
      ee(c, ne, te, !1),
      c.result ? !0 : ((c.kind = he), (c.result = R), !1)
    );
  }
  function Re(c, B) {
    var W, ie, V;
    if (((W = c.input.charCodeAt(c.position)), W !== 39)) return !1;
    for (
      c.kind = "scalar", c.result = "", c.position++, ie = V = c.position;
      (W = c.input.charCodeAt(c.position)) !== 0;
    )
      if (W === 39)
        if (
          (ee(c, ie, c.position, !0),
        ...
        A(W)
          ? (ee(c, ie, V, !0), de(c, me(c, !1, B)), (ie = V = c.position))
          : c.position === c.lineStart && Q(c)
            ? k(
                c,
                "unexpected end of the document within a single quoted scalar",
              )
            : (c.position++, (V = c.position));
    k(c, "unexpected end of the stream within a single quoted scalar");
  }
  function Ne(c, B) {
    var W, ie, V, ne, te, ae;
    if (((ae = c.input.charCodeAt(c.position)), ae !== 34)) return !1;
    for (
      c.kind = "scalar", c.result = "", c.position++, W = ie = c.position;
      (ae = c.input.charCodeAt(c.position)) !== 0;
    ) {
      if (ae === 34) return (ee(c, W, c.position, !0), c.position++, !0);
      if (ae === 92) {
        if (
          (ee(c, W, c.position, !0),
          (ae = c.input.charCodeAt(++c.position)),
          A(ae))
        )
          me(c, !1, B);
        else if (ae < 256 && x[ae]) ((c.result += $[ae]), c.position++);
        else if ((te = I(ae)) > 0) {
          for (V = te, ne = 0; V > 0; V--)
            ((ae = c.input.charCodeAt(++c.position)),
              (te = b(ae)) >= 0
                ? (ne = (ne << 4) + te)
                : k(c, "expected hexadecimal character"));
          ((c.result += _(ne)), c.position++);
        } else k(c, "unknown escape sequence");
        W = ie = c.position;
      } else
        A(ae)
          ? (ee(c, W, ie, !0), de(c, me(c, !1, B)), (W = ie = c.position))
          : c.position === c.lineStart && Q(c)
            ? k(
                c,
                "unexpected end of the document within a double quoted scalar",
              )
            : (c.position++, (ie = c.position));
    }
  ...
  function Ce(c, B) {
    ...
    if (((re = c.input.charCodeAt(c.position)), re === 91))
      ((Se = 93), (H = !1), (ae = []));
    else if (re === 123) ((Se = 125), (H = !0), (ae = {}));
    else return !1;
    for (
      c.anchor !== null && (c.anchorMap[c.anchor] = ae),
        re = c.input.charCodeAt(++c.position);
      re !== 0;
    ) {
      if ((me(c, !0, B), (re = c.input.charCodeAt(c.position)), re === Se))
        return (
          c.position++,
          (c.tag = te),
          (c.anchor = ue),
          (c.kind = H ? "mapping" : "sequence"),
          (c.result = ae),
          !0
        );
      (W
        ? re === 44 && k(c, "expected the node content, but found ','")
        : k(c, "missed comma between flow collection entries"),
        (K = X = oe = null),
        (he = R = !1),
        re === 63 &&
          ((Ie = c.input.charCodeAt(c.position + 1)),
          D(Ie) && ((he = R = !0), c.position++, me(c, !0, B))),
        (ie = c.line),
        (V = c.lineStart),
        (ne = c.position),
        Te(c, B, s, !1, !0),
        ...
        (R || c.line === ie) &&
          ...
          (oe = c.result)),
        H
          ? Z(c, ae, z, K, X, oe, ie, V, ne)
          : he
            ? ae.push(Z(c, null, z, K, X, oe, ie, V, ne))
            : ae.push(X),
        me(c, !0, B),
        (re = c.input.charCodeAt(c.position)),
        re === 44
          ? ((W = !0), (re = c.input.charCodeAt(++c.position)))
          : (W = !1));
    }
  ...
  function Ae(c, B) {
    var W,
      ...
      Se,
      he;
    if (((he = c.input.charCodeAt(c.position)), he === 124)) ie = !1;
    else if (he === 62) ie = !0;
    else return !1;
    for (c.kind = "scalar", c.result = ""; he !== 0; )
      if (((he = c.input.charCodeAt(++c.position)), he === 43 || he === 45))
        h === V
          ? (V = he === 43 ? l : d)
          : k(c, "repeat of a chomping mode identifier");
      else if ((Se = v(he)) >= 0)
        Se === 0
          ? k(
              c,
          ...
          : te
            ? k(c, "repeat of an indentation width identifier")
            : ((ae = B + Se - 1), (te = !0));
      else break;
    if (N(he)) {
      do he = c.input.charCodeAt(++c.position);
      while (N(he));
      if (he === 35)
        do he = c.input.charCodeAt(++c.position);
        while (!A(he) && he !== 0);
    ...
    for (; he !== 0; ) {
      for (
        ye(c), c.lineIndent = 0, he = c.input.charCodeAt(c.position);
        (!te || c.lineIndent < ae) && he === 32;
      )
...
`,
  ...
  function w(c, B) {
    ...
    for (
      c.anchor !== null && (c.anchorMap[c.anchor] = ne),
        ue = c.input.charCodeAt(c.position);
      ue !== 0 &&
      (c.firstTabInLine !== -1 &&
        ((c.position = c.firstTabInLine),
        k(c, "tab characters must not be used in indentation")),
      !(ue !== 45 || ((te = c.input.charCodeAt(c.position + 1)), !D(te))));
    ) {
      ...
      if (
        ...
        me(c, !0, -1),
        (ue = c.input.charCodeAt(c.position)),
        (c.line === W || c.lineIndent > B) && ue !== 0)
      )
        k(c, "bad indentation of a sequence entry");
      else if (c.lineIndent < B) break;
    }
    return ae
      ? ((c.tag = ie),
        (c.anchor = V),
  ...
  function g(c, B, W) {
    ...
    if (c.firstTabInLine !== -1) return !1;
    for (
      c.anchor !== null && (c.anchorMap[c.anchor] = he),
        re = c.input.charCodeAt(c.position);
      re !== 0;
    ) {
      if (
        ...
        (re === 63
          ? (K && (Z(c, he, R, H, z, null, te, ae, ue), (H = z = X = null)),
            (oe = !0),
            (K = !0),
            (V = !0))
          : K
        ...
        if (c.line === ne) {
          ...
          else return ((c.tag = Ie), (c.anchor = Se), !0);
        } else if (oe)
          k(
            c,
      ...
      if (
        ((c.line === ne || c.lineIndent > B) &&
          (K && ((te = c.line), (ae = c.lineStart), (ue = c.position)),
          Te(c, B, o, !0, V) && (K ? (z = c.result) : (X = c.result)),
          K || (Z(c, he, R, H, z, X, te, ae, ue), (H = z = X = null)),
          me(c, !0, -1),
          (re = c.input.charCodeAt(c.position))),
        (c.line === ne || c.lineIndent > B) && re !== 0)
      )
        k(c, "bad indentation of a mapping entry");
      else if (c.lineIndent < B) break;
    }
    return (
      K && Z(c, he, R, H, z, null, te, ae, ue),
      oe &&
        ((c.tag = Ie), (c.anchor = Se), (c.kind = "mapping"), (c.result = he)),
      oe
    );
  }
  function q(c) {
    ...
    if (
      (c.tag !== null && k(c, "duplication of a tag property"),
      (te = c.input.charCodeAt(++c.position)),
      te === 60
        ? ((W = !0), (te = c.input.charCodeAt(++c.position)))
        : te === 33
          ? ((ie = !0), (V = "!!"), (te = c.input.charCodeAt(++c.position)))
          : (V = "!"),
      (B = c.position),
      W)
    ) {
      do te = c.input.charCodeAt(++c.position);
      while (te !== 0 && te !== 62);
      c.position < c.length
        ? ((ne = c.input.slice(B, c.position)),
          (te = c.input.charCodeAt(++c.position)))
        : k(c, "unexpected end of the stream within a verbatim tag");
    } else {
      for (; te !== 0 && !D(te); )
        (te === 33 &&
          (ie
            ? k(c, "tag suffix cannot contain exclamation marks")
            : ((V = c.input.slice(B - 1, c.position + 1)),
              y.test(V) ||
                k(c, "named tag handle cannot contain such characters"),
              (ie = !0),
              (B = c.position + 1))),
          (te = c.input.charCodeAt(++c.position)));
      ((ne = c.input.slice(B, c.position)),
        E.test(ne) &&
          k(c, "tag suffix cannot contain flow indicator characters"));
    }
      ...
      W
        ...
        : a.call(c.tagMap, V)
          ...
          : V === "!"
            ? (c.tag = "!" + ne)
            : V === "!!"
              ? (c.tag = "tag:yaml.org,2002:" + ne)
              : k(c, 'undeclared tag handle "' + V + '"'),
      !0
    );
  }
  function P(c) {
    ...
    for (
      c.anchor !== null && k(c, "duplication of an anchor property"),
        W = c.input.charCodeAt(++c.position),
        B = c.position;
      W !== 0 && !D(W) && !S(W);
    )
    ...
    return (
      c.position === B &&
        k(c, "name of an anchor node must contain at least one character"),
      (c.anchor = c.input.slice(B, c.position)),
      !0
    );
  }
  function _e(c) {
    ...
    for (
      ie = c.input.charCodeAt(++c.position), B = c.position;
      ie !== 0 && !D(ie) && !S(ie);
    )
      ie = c.input.charCodeAt(++c.position);
    return (
      c.position === B &&
        k(c, "name of an alias node must contain at least one character"),
      (W = c.input.slice(B, c.position)),
      a.call(c.anchorMap, W) || k(c, 'unidentified alias "' + W + '"'),
      (c.result = c.anchorMap[W]),
      me(c, !0, -1),
      !0
    );
  }
  function Te(c, B, W, ie, V) {
    var ne,
      ...
      K;
    if (
      (c.listener !== null && c.listener("open", c),
      (c.tag = null),
      (c.anchor = null),
      (c.kind = null),
      (c.result = null),
    ...
    if (
      ...
      (ue === 1 || o === W) &&
        (s === W || i === W ? (X = B) : (X = B + 1),
        (K = c.position - c.lineStart),
        ue === 1
          ? (ae && (w(c, K) || g(c, K, X))) || Ce(c, X)
            ? (Se = !0)
            : ((te && Ae(c, X)) || Re(c, X) || Ne(c, X)
                ? (Se = !0)
                : _e(c)
                  ? ((Se = !0),
                    (c.tag !== null || c.anchor !== null) &&
                      k(c, "alias node should not have any properties"))
                  : we(c, X, s === W) &&
                    ((Se = !0), c.tag === null && (c.tag = "?")),
      ...
      for (
        c.result !== null &&
          ...
          he = 0,
          R = c.implicitTypes.length;
        he < R;
        he += 1
      )
        if (((z = c.implicitTypes[he]), z.resolve(c.result))) {
          ((c.result = z.construct(c.result)),
            (c.tag = z.tag),
            c.anchor !== null && (c.anchorMap[c.anchor] = c.result));
          break;
        }
      ...
      if (a.call(c.typeMap[c.kind || "fallback"], c.tag))
        ...
        for (
          z = null,
            H = c.typeMap.multi[c.kind || "fallback"],
            he = 0,
            R = H.length;
          he < R;
          he += 1
      ...
      (z || k(c, "unknown tag !<" + c.tag + ">"),
        ...
        z.resolve(c.result, c.tag)
          ? ((c.result = z.construct(c.result, c.tag)),
            c.anchor !== null && (c.anchorMap[c.anchor] = c.result))
          : k(c, "cannot resolve a node with !<" + c.tag + "> explicit tag"));
    }
    return (
      c.listener !== null && c.listener("close", c),
      c.tag !== null || c.anchor !== null || Se
    );
  }
  function De(c) {
    var B = c.position,
    ...
    for (
      c.version = null,
        c.checkLineBreaks = c.legacy,
        c.tagMap = /* @__PURE__ */ Object.create(null),
        c.anchorMap = /* @__PURE__ */ Object.create(null);
      (te = c.input.charCodeAt(c.position)) !== 0 &&
      (me(c, !0, -1),
      (te = c.input.charCodeAt(c.position)),
      !(c.lineIndent > 0 || te !== 37));
    ) {
      for (
        ne = !0, te = c.input.charCodeAt(++c.position), W = c.position;
        te !== 0 && !D(te);
      )
        te = c.input.charCodeAt(++c.position);
      for (
        ie = c.input.slice(W, c.position),
          V = [],
          ie.length < 1 &&
            k(
              c,
        ...
        for (; N(te); ) te = c.input.charCodeAt(++c.position);
        if (te === 35) {
          do te = c.input.charCodeAt(++c.position);
          while (te !== 0 && !A(te));
          break;
      ...
      (te !== 0 && ye(c),
        a.call(Y, ie)
          ? Y[ie](c, ie, V)
          : G(c, 'unknown document directive "' + ie + '"'));
    }
    if (
      (me(c, !0, -1),
      c.lineIndent === 0 &&
      c.input.charCodeAt(c.position) === 45 &&
      c.input.charCodeAt(c.position + 1) === 45 &&
      c.input.charCodeAt(c.position + 2) === 45
        ? ((c.position += 3), me(c, !0, -1))
        : ne && k(c, "directives end mark is expected"),
      Te(c, c.lineIndent - 1, o, !1, !0),
      me(c, !0, -1),
      c.checkLineBreaks &&
        p.test(c.input.slice(B, c.position)) &&
        G(c, "non-ASCII line breaks are interpreted as content"),
      c.documents.push(c.result),
      c.position === c.lineStart && Q(c))
    ) {
      c.input.charCodeAt(c.position) === 46 &&
        ((c.position += 3), me(c, !0, -1));
      return;
    }
  ...
  function $e(c, B) {
    ((c = String(c)),
      (B = B || {}),
      c.length !== 0 &&
        (c.charCodeAt(c.length - 1) !== 10 &&
          c.charCodeAt(c.length - 1) !== 13 &&
          (c += `
`),
    ...
    for (
      ie !== -1 &&
        ((W.position = ie), k(W, "null byte is not allowed in input")),
        W.input += "\0";
      W.input.charCodeAt(W.position) === 32;
    )
      ((W.lineIndent += 1), (W.position += 1));
    for (; W.position < W.length - 1; ) De(W);
    return W.documents;
  }
  function Me(c, B, W) {
    B !== null &&
      ...
      ((W = B), (B = null));
    var ie = $e(c, W);
    if (typeof B != "function") return ie;
    for (var V = 0, ne = ie.length; V < ne; V += 1) B(ie[V]);
  }
  function We(c, B) {
    var W = $e(c, B);
    if (W.length !== 0) {
...
function sf() {
  ...
  function k(R, H) {
    ...
    for (z = {}, X = Object.keys(H), K = 0, oe = X.length; K < oe; K += 1)
      ((re = X[K]),
        ...
        (fe = R.compiledTypeMap.fallback[re]),
        fe && a.call(fe.styleAliases, se) && (se = fe.styleAliases[se]),
        (z[re] = se));
    return z;
  }
  function G(R) {
    var H, z, X;
    if (((H = R.toString(16).toUpperCase()), R <= 255)) ((z = "x"), (X = 2));
    else if (R <= 65535) ((z = "u"), (X = 4));
    else if (R <= 4294967295) ((z = "U"), (X = 8));
    else
      throw new t(
  ...
  var Y = 1,
    ee = 2;
  function pe(R) {
    ((this.schema = R.schema || r),
      (this.indent = Math.max(1, R.indent || 2)),
      (this.noArrayIndent = R.noArrayIndent || !1),
      (this.skipInvalid = R.skipInvalid || !1),
      (this.flowLevel = e.isNothing(R.flowLevel) ? -1 : R.flowLevel),
      (this.styleMap = k(this.schema, R.styles || null)),
      ...
      (this.quotingType = R.quotingType === '"' ? ee : Y),
  ...
  function Z(R, H) {
    for (
      var z = e.repeat(" ", H), X = 0, K = -1, oe = "", re, se = R.length;
      X < se;
    )
      ((K = R.indexOf(
        `
...
` + e.repeat(" ", R.indent * H)
  ...
  function me(R, H) {
    ...
    for (z = 0, X = R.implicitTypes.length; z < X; z += 1)
      if (((K = R.implicitTypes[z]), K.resolve(H))) return !0;
    return !1;
  }
  function Q(R) {
    return R === h || R === i;
  ...
  function Ae(R, H) {
    var z = R.charCodeAt(H),
      X;
    return z >= 55296 &&
      z <= 56319 &&
      H + 1 < R.length &&
      ((X = R.charCodeAt(H + 1)), X >= 56320 && X <= 57343)
      ? (z - 55296) * 1024 + X - 56320 + 65536
      : z;
  }
  function w(R) {
    var H = /^\n* /;
  ...
  function De(R, H, z, X, K, oe, re, se) {
    var fe,
      ...
      Vt = X !== -1,
      st = -1,
      Ft = Ne(Ae(R, 0)) && Ce(Ae(R, R.length - 1));
    if (H || re)
      for (fe = 0; fe < R.length; ge >= 65536 ? (fe += 2) : fe++) {
        if (((ge = Ae(R, fe)), !de(ge))) return Te;
      ...
      for (fe = 0; fe < R.length; ge >= 65536 ? (fe += 2) : fe++) {
        if (((ge = Ae(R, fe)), ge === f))
          ((Ue = !0),
            Vt &&
              ((be =
                be || // Foldable line = too long, and not more-indented.
                (fe - st - 1 > X && R[st + 1] !== " ")),
              (st = fe)));
        else if (!de(ge)) return Te;
        ((Ft = Ft && Re(ge, Oe, se)), (Oe = ge));
      }
  ...
  function $e(R, H, z, X, K) {
    R.dump = (function () {
      if (H.length === 0) return R.quotingType === ee ? '""' : "''";
      if (!R.noCompatMode && (L.indexOf(H) !== -1 || j.test(H)))
        return R.quotingType === ee ? '"' + H + '"' : "'" + H + "'";
      var oe = R.indent * Math.max(1, z),
        re =
          R.lineWidth === -1
            ? -1
            : Math.max(Math.min(R.lineWidth, 40), R.lineWidth - oe),
        se = X || (R.flowLevel > -1 && z >= R.flowLevel);
      function fe(ge) {
        return me(R, ge);
      }
      switch (
        De(H, se, R.indent, re, fe, R.quotingType, R.forceQuotes && !X, K)
      ) {
        case g:
          return H;
        case q:
...
` +
  ...
  function ie(R, H, z) {
    ...
    for (oe = 0, re = z.length; oe < re; oe += 1)
      ((se = z[oe]),
        R.replacer && (se = R.replacer.call(z, String(oe), se)),
        (ue(R, H, se, !1, !1) || (typeof se > "u" && ue(R, H, null, !1, !1))) &&
          (X !== "" && (X += "," + (R.condenseFlow ? "" : " ")),
          (X += R.dump)));
    ((R.tag = K), (R.dump = "[" + X + "]"));
  }
  function V(R, H, z, X) {
    ...
    for (re = 0, se = z.length; re < se; re += 1)
      ((fe = z[re]),
        R.replacer && (fe = R.replacer.call(z, String(re), fe)),
        (ue(R, H + 1, fe, !0, !0, !1, !0) ||
          (typeof fe > "u" && ue(R, H + 1, null, !0, !0, !1, !0))) &&
          ((!X || K !== "") && (K += ye(R, H)),
          R.dump && f === R.dump.charCodeAt(0) ? (K += "-") : (K += "- "),
          (K += R.dump)));
    ((R.tag = oe), (R.dump = K || "[]"));
  }
  function ne(R, H, z) {
    ...
    for (re = 0, se = oe.length; re < se; re += 1)
      ((Oe = ""),
        ...
        (fe = oe[re]),
        (ge = z[fe]),
        R.replacer && (ge = R.replacer.call(z, fe, ge)),
        ue(R, H, fe, !1, !1) &&
          (R.dump.length > 1024 && (Oe += "? "),
          (Oe +=
            R.dump +
            (R.condenseFlow ? '"' : "") +
            ":" +
            (R.condenseFlow ? "" : " ")),
          ue(R, H, ge, !1, !1) && ((Oe += R.dump), (X += Oe))));
    ((R.tag = K), (R.dump = "{" + X + "}"));
  }
  function te(R, H, z, X) {
    var K = "",
      ...
      Ue,
      be;
    if (R.sortKeys === !0) re.sort();
    else if (typeof R.sortKeys == "function") re.sort(R.sortKeys);
    else if (R.sortKeys)
    ...
    for (se = 0, fe = re.length; se < fe; se += 1)
      ((be = ""),
        ...
        (ge = re[se]),
        (Oe = z[ge]),
        R.replacer && (Oe = R.replacer.call(z, ge, Oe)),
        ue(R, H + 1, ge, !0, !0, !0) &&
          ((Ue =
            (R.tag !== null && R.tag !== "?") ||
            (R.dump && R.dump.length > 1024)),
          Ue &&
            (R.dump && f === R.dump.charCodeAt(0) ? (be += "?") : (be += "? ")),
          (be += R.dump),
          Ue && (be += ye(R, H)),
          ue(R, H + 1, Oe, !0, Ue) &&
            (R.dump && f === R.dump.charCodeAt(0) ? (be += ":") : (be += ": "),
  ...
  function ae(R, H, z) {
    var X, K, oe, re, se, fe;
    for (
      K = z ? R.explicitTypes : R.implicitTypes, oe = 0, re = K.length;
      oe < re;
      oe += 1
    )
      if (
        ((se = K[oe]),
        (se.instanceOf || se.predicate) &&
          (!se.instanceOf ||
            (typeof H == "object" && H instanceof se.instanceOf)) &&
          (!se.predicate || se.predicate(H)))
      ) {
        if (
          (z
            ? se.multi && se.representName
              ? (R.tag = se.representName(H))
              : (R.tag = se.tag)
            : (R.tag = "?"),
          se.represent)
        ) {
          if (
            ((fe = R.styleMap[se.tag] || se.defaultStyle),
            n.call(se.represent) === "[object Function]")
          )
            X = se.represent(H, fe);
          else if (a.call(se.represent, fe)) X = se.represent[fe](H, fe);
          else
            throw new t(
              "!<" + se.tag + '> tag resolver accepts not "' + fe + '" style',
            );
          R.dump = X;
        }
        return !0;
  ...
  function ue(R, H, z, X, K, oe, re) {
    ...
    var se = n.call(R.dump),
      fe = X,
      ge;
    X && (X = R.flowLevel < 0 || R.flowLevel > H);
    var Oe = se === "[object Object]" || se === "[object Array]",
      Ue,
      be;
    if (
      (Oe && ((Ue = R.duplicates.indexOf(z)), (be = Ue !== -1)),
      ((R.tag !== null && R.tag !== "?") || be || (R.indent !== 2 && H > 0)) &&
        (K = !1),
      be && R.usedDuplicates[Ue])
    )
      R.dump = "*ref_" + Ue;
    else {
      if (
        (Oe && be && !R.usedDuplicates[Ue] && (R.usedDuplicates[Ue] = !0),
        se === "[object Object]")
      )
        X && Object.keys(R.dump).length !== 0
          ? (te(R, H, R.dump, K), be && (R.dump = "&ref_" + Ue + R.dump))
          : (ne(R, H, R.dump), be && (R.dump = "&ref_" + Ue + " " + R.dump));
      else if (se === "[object Array]")
        X && R.dump.length !== 0
          ? (R.noArrayIndent && !re && H > 0
              ? V(R, H - 1, R.dump, K)
              : V(R, H, R.dump, K),
            be && (R.dump = "&ref_" + Ue + R.dump))
          : (ie(R, H, R.dump), be && (R.dump = "&ref_" + Ue + " " + R.dump));
      else if (se === "[object String]")
        R.tag !== "?" && $e(R, R.dump, H, oe, fe);
      else {
        if (se === "[object Undefined]") return !1;
        if (R.skipInvalid) return !1;
        throw new t("unacceptable kind of an object to dump " + se);
      }
      R.tag !== null &&
        R.tag !== "?" &&
        ((ge = encodeURI(R.tag[0] === "!" ? R.tag.slice(1) : R.tag).replace(
          /!/g,
          "%21",
        )),
        R.tag[0] === "!"
          ? (ge = "!" + ge)
          : ge.slice(0, 18) === "tag:yaml.org,2002:"
            ? (ge = "!!" + ge.slice(18))
            : (ge = "!<" + ge + ">"),
        (R.dump = ge + " " + R.dump));
    }
  ...
  function Ie(R, H) {
    var z = [],
      ...
      K,
      oe;
    for (Se(R, z, X), K = 0, oe = X.length; K < oe; K += 1)
  ...
  function Se(R, H, z) {
    ...
    if (R !== null && typeof R == "object")
      if (((K = H.indexOf(R)), K !== -1)) z.indexOf(K) === -1 && z.push(K);
      else if ((H.push(R), Array.isArray(R)))
        for (K = 0, oe = R.length; K < oe; K += 1) Se(R[K], H, z);
      else
  ...
  function he(R, H) {
    ...
    var X = R;
    return (
      z.replacer && (X = z.replacer.call({ "": X }, "", X)),
      ue(z, 0, X, !0, !0)
        ? z.dump +
          `
`
...
function Uo() {
  ...
  return (
    (ze.Type = Je()),
    (ze.Schema = Ic()),
    (ze.FAILSAFE_SCHEMA = Nc()),
    (ze.JSON_SCHEMA = Lc()),
    (ze.CORE_SCHEMA = xc()),
    (ze.DEFAULT_SCHEMA = xo()),
    (ze.load = e.load),
    (ze.loadAll = e.loadAll),
    (ze.dump = t.dump),
    (ze.YAMLException = Lr()),
    (ze.types = {
      binary: $c(),
    ...
    (ze.safeLoad = r("safeLoad", "load")),
    (ze.safeLoadAll = r("safeLoadAll", "loadAll")),
    (ze.safeDump = r("safeDump", "dump")),
    ze
  );
}
var cr = {},
...
function cn() {
  ...
  const e = "2.0.0",
    t = 256,
    r = Number.MAX_SAFE_INTEGER /* istanbul ignore next */ || 9007199254740991,
    n = 16,
    a = t - 6;
  return (
    (bi = {
    ...
    ks ||
      ...
      (function (e, t) {
        ...
        const u = "[a-zA-Z0-9-]",
          ...
          y = (m, T, A) => {
            ...
            (s(m, D, T),
              ...
              (o[D] = T),
              (h[D] = N),
              (i[D] = new RegExp(T, A ? "g" : void 0)),
              (f[D] = new RegExp(N, A ? "g" : void 0)));
          };
        (y("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
          ...
          y(
            "MAINVERSION",
            `(${o[d.NUMERICIDENTIFIER]})\\.(${o[d.NUMERICIDENTIFIER]})\\.(${o[d.NUMERICIDENTIFIER]})`,
          ),
          y(
            "MAINVERSIONLOOSE",
            `(${o[d.NUMERICIDENTIFIERLOOSE]})\\.(${o[d.NUMERICIDENTIFIERLOOSE]})\\.(${o[d.NUMERICIDENTIFIERLOOSE]})`,
          ),
          y(
            "PRERELEASEIDENTIFIER",
            `(?:${o[d.NONNUMERICIDENTIFIER]}|${o[d.NUMERICIDENTIFIER]})`,
          ),
          y(
            "PRERELEASEIDENTIFIERLOOSE",
            `(?:${o[d.NONNUMERICIDENTIFIER]}|${o[d.NUMERICIDENTIFIERLOOSE]})`,
          ),
          y(
            "PRERELEASE",
            `(?:-(${o[d.PRERELEASEIDENTIFIER]}(?:\\.${o[d.PRERELEASEIDENTIFIER]})*))`,
          ),
          y(
            "PRERELEASELOOSE",
            `(?:-?(${o[d.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${o[d.PRERELEASEIDENTIFIERLOOSE]})*))`,
          ),
          y("BUILDIDENTIFIER", `${u}+`),
          y(
            "BUILD",
            `(?:\\+(${o[d.BUILDIDENTIFIER]}(?:\\.${o[d.BUILDIDENTIFIER]})*))`,
          ),
          y(
            "FULLPLAIN",
            `v?${o[d.MAINVERSION]}${o[d.PRERELEASE]}?${o[d.BUILD]}?`,
          ),
          y("FULL", `^${o[d.FULLPLAIN]}$`),
          y(
            "LOOSEPLAIN",
            `[v=\\s]*${o[d.MAINVERSIONLOOSE]}${o[d.PRERELEASELOOSE]}?${o[d.BUILD]}?`,
          ),
          y("LOOSE", `^${o[d.LOOSEPLAIN]}$`),
          y("GTLT", "((?:<|>)?=?)"),
          y("XRANGEIDENTIFIERLOOSE", `${o[d.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),
          y("XRANGEIDENTIFIER", `${o[d.NUMERICIDENTIFIER]}|x|X|\\*`),
          y(
            "XRANGEPLAIN",
            `[v=\\s]*(${o[d.XRANGEIDENTIFIER]})(?:\\.(${o[d.XRANGEIDENTIFIER]})(?:\\.(${o[d.XRANGEIDENTIFIER]})(?:${o[d.PRERELEASE]})?${o[d.BUILD]}?)?)?`,
          ),
          y(
            "XRANGEPLAINLOOSE",
            `[v=\\s]*(${o[d.XRANGEIDENTIFIERLOOSE]})(?:\\.(${o[d.XRANGEIDENTIFIERLOOSE]})(?:\\.(${o[d.XRANGEIDENTIFIERLOOSE]})(?:${o[d.PRERELEASELOOSE]})?${o[d.BUILD]}?)?)?`,
          ),
          y("XRANGE", `^${o[d.GTLT]}\\s*${o[d.XRANGEPLAIN]}$`),
          y("XRANGELOOSE", `^${o[d.GTLT]}\\s*${o[d.XRANGEPLAINLOOSE]}$`),
          y(
            "COERCEPLAIN",
            `(^|[^\\d])(\\d{1,${r}})(?:\\.(\\d{1,${r}}))?(?:\\.(\\d{1,${r}}))?`,
          ),
          y("COERCE", `${o[d.COERCEPLAIN]}(?:$|[^\\d])`),
          y(
            "COERCEFULL",
            o[d.COERCEPLAIN] +
              `(?:${o[d.PRERELEASE]})?(?:${o[d.BUILD]})?(?:$|[^\\d])`,
          ),
          y("COERCERTL", o[d.COERCE], !0),
          y("COERCERTLFULL", o[d.COERCEFULL], !0),
          y("LONETILDE", "(?:~>?)"),
          y("TILDETRIM", `(\\s*)${o[d.LONETILDE]}\\s+`, !0),
          (t.tildeTrimReplace = "$1~"),
          y("TILDE", `^${o[d.LONETILDE]}${o[d.XRANGEPLAIN]}$`),
          y("TILDELOOSE", `^${o[d.LONETILDE]}${o[d.XRANGEPLAINLOOSE]}$`),
          y("LONECARET", "(?:\\^)"),
          y("CARETTRIM", `(\\s*)${o[d.LONECARET]}\\s+`, !0),
          (t.caretTrimReplace = "$1^"),
          y("CARET", `^${o[d.LONECARET]}${o[d.XRANGEPLAIN]}$`),
          y("CARETLOOSE", `^${o[d.LONECARET]}${o[d.XRANGEPLAINLOOSE]}$`),
          y("COMPARATORLOOSE", `^${o[d.GTLT]}\\s*(${o[d.LOOSEPLAIN]})$|^$`),
          y("COMPARATOR", `^${o[d.GTLT]}\\s*(${o[d.FULLPLAIN]})$|^$`),
          y(
            "COMPARATORTRIM",
            `(\\s*)${o[d.GTLT]}\\s*(${o[d.LOOSEPLAIN]}|${o[d.XRANGEPLAIN]})`,
            !0,
          ),
          (t.comparatorTrimReplace = "$1$2$3"),
          y(
            "HYPHENRANGE",
            `^\\s*(${o[d.XRANGEPLAIN]})\\s+-\\s+(${o[d.XRANGEPLAIN]})\\s*$`,
          ),
          y(
            "HYPHENRANGELOOSE",
            `^\\s*(${o[d.XRANGEPLAINLOOSE]})\\s+-\\s+(${o[d.XRANGEPLAINLOOSE]})\\s*$`,
          ),
          y("STAR", "(<|>)?=?\\s*\\*"),
          y("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$"),
...
function Qe() {
  ...
  qs = 1;
  const e = un(),
    { MAX_LENGTH: t, MAX_SAFE_INTEGER: r } = cn(),
    { safeRe: n, t: a } = xr(),
    s = ko(),
    { compareIdentifiers: i } = Hc();
  class f {
    constructor(h, d) {
      if (((d = s(d)), h instanceof f)) {
        if (
          h.loose === !!d.loose &&
          h.includePrerelease === !!d.includePrerelease
        )
          return h;
        h = h.version;
      ...
      if (!l) throw new TypeError(`Invalid Version: ${h}`);
      if (
        ((this.raw = h),
        (this.major = +l[1]),
        (this.minor = +l[2]),
    ...
    compare(h) {
      if (
        (e("SemVer.compare", this.version, this.options, h), !(h instanceof f))
      ) {
    ...
    inc(h, d, l) {
      if (h.startsWith("pre")) {
        ...
        if (d) {
          const u = `-${d}`.match(
            this.options.loose ? n[a.PRERELEASELOOSE] : n[a.PRERELEASE],
          );
          if (!u || u[1] !== d) throw new Error(`invalid identifier: ${d}`);
        }
      }
      switch (h) {
        case "premajor":
        ...
        // prepatch.
        case "prerelease":
          (this.prerelease.length === 0 && this.inc("patch", d, l),
            this.inc("pre", d, l));
          break;
        case "release":
        ...
        case "pre": {
          ...
          if (d) {
            let p = [d, u];
            (l === !1 && (p = [d]),
              i(this.prerelease[0], d) === 0
                ? isNaN(this.prerelease[1]) && (this.prerelease = p)
                : (this.prerelease = p));
          }
          break;
        }
...
function df() {
  ...
  return (
    (xi = (r, n, a, s, i) => {
      ...
      try {
        return new e(r instanceof e ? r.version : r, a).inc(n, s, i).version;
      } catch {
        return null;
      }
    }),
    ...
    (eo = (s, i) => {
      ...
      if (!i.rtl)
        ...
        for (; (E = p.exec(s)) && (!f || f.index + f[0].length !== s.length); )
          ((!f || E.index + E[0].length !== f.index + f[0].length) && (f = E),
            (p.lastIndex = E.index + E[1].length + E[2].length));
        p.lastIndex = -1;
      }
      ...
      const o = f[2],
        h = f[3] || "0",
        d = f[4] || "0",
        l = i.includePrerelease && f[5] ? `-${f[5]}` : "",
        u = i.includePrerelease && f[6] ? `+${f[6]}` : "";
...
function Tf() {
  ...
  class e {
    ...
    get(r) {
      ...
      if (n !== void 0) return (this.map.delete(r), this.map.set(r, n), n);
    }
    delete(r) {
...
function ht() {
  ...
  class t {
    constructor(L, j) {
      if (((j = a(j)), L instanceof t))
        return L.loose === !!j.loose &&
          L.includePrerelease === !!j.includePrerelease
          ? L
          : new t(L.raw, j);
      if (L instanceof s)
        return (
      ...
      if (this.set.length > 1) {
        const k = this.set[0];
        if (
          ((this.set = this.set.filter((G) => !y(G[0]))), this.set.length === 0)
        )
          this.set = [k];
      ...
      if (this.formatted === void 0) {
        ...
        for (let L = 0; L < this.set.length; L++) {
          ...
          for (let k = 0; k < j.length; k++)
            (k > 0 && (this.formatted += " "),
              (this.formatted += j[k].toString().trim()));
        }
      }
    ...
    parseRange(L) {
      const k =
          ((this.options.includePrerelease && p) | (this.options.loose && E)) +
          ":" +
          L,
        G = n.get(k);
      if (G) return G;
      const Y = this.options.loose,
        ee = Y ? o[h.HYPHENRANGELOOSE] : o[h.HYPHENRANGE];
      ((L = L.replace(ee, x(this.options.includePrerelease))),
        i("hyphen replace", L),
        (L = L.replace(o[h.COMPARATORTRIM], d)),
        i("comparator trim", L),
        (L = L.replace(o[h.TILDETRIM], l)),
        i("tilde trim", L),
        (L = L.replace(o[h.CARETTRIM], u)),
        i("caret trim", L));
      let pe = L.split(" ")
        .map((Q) => A(Q, this.options))
        .join(" ")
        .split(/\s+/)
        .map((Q) => U(Q, this.options));
      (Y &&
        (pe = pe.filter(
          (Q) => (
            i("loose invalid filter", Q, this.options),
            !!Q.match(o[h.COMPARATORLOOSE])
          ),
        )),
        i("range list", pe));
      const Z = /* @__PURE__ */ new Map(),
        ye = pe.map((Q) => new s(Q, this.options));
      for (const Q of ye) {
        if (y(Q)) return [Q];
        Z.set(Q.value, Q);
      }
    ...
    intersects(L, j) {
      ...
      return this.set.some(
        (k) =>
          ...
          L.set.some(
            (G) =>
              T(G, j) && k.every((Y) => G.every((ee) => Y.intersects(ee, j))),
          ),
      );
    }
    ...
    test(L) {
      ...
      for (let j = 0; j < this.set.length; j++)
        if ($(this.set[j], L, this.options)) return !0;
      return !1;
    }
  }
  ro = t;
  const r = Tf(),
    ...
    { FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: E } = cn(),
    y = (F) => F.value === "<0.0.0-0",
    m = (F) => F.value === "",
    T = (F, L) => {
      let j = !0;
          ...
          N(G)
            ...
            : N(Y)
              ...
              : N(ee)
                ? (Z = `>=${G}.${Y}.0 <${G}.${+Y + 1}.0-0`)
                : pe
                  ? (i("replaceTilde pr", pe),
                    (Z = `>=${G}.${Y}.${ee}-${pe} <${G}.${+Y + 1}.0-0`))
                  : (Z = `>=${G}.${Y}.${ee} <${G}.${+Y + 1}.0-0`),
          i("tilde return", Z),
          Z
        );
    ...
    I = (F, L) => {
      i("caret", F, L);
      const j = L.loose ? o[h.CARETLOOSE] : o[h.CARET],
        k = L.includePrerelease ? "-0" : "";
      return F.replace(j, (G, Y, ee, pe, Z) => {
        ...
        return (
          N(Y)
            ? (ye = "")
            : N(ee)
              ? (ye = `>=${Y}.0.0${k} <${+Y + 1}.0.0-0`)
              : N(pe)
                ? Y === "0"
                  ? (ye = `>=${Y}.${ee}.0${k} <${Y}.${+ee + 1}.0-0`)
                  : (ye = `>=${Y}.${ee}.0${k} <${+Y + 1}.0.0-0`)
                : Z
                  ? (i("replaceCaret pr", Z),
                    Y === "0"
                      ? ee === "0"
                        ? (ye = `>=${Y}.${ee}.${pe}-${Z} <${Y}.${ee}.${+pe + 1}-0`)
                        : (ye = `>=${Y}.${ee}.${pe}-${Z} <${Y}.${+ee + 1}.0-0`)
                      : (ye = `>=${Y}.${ee}.${pe}-${Z} <${+Y + 1}.0.0-0`))
                  : (i("no pr"),
                    Y === "0"
                      ? ee === "0"
                        ? (ye = `>=${Y}.${ee}.${pe}${k} <${Y}.${ee}.${+pe + 1}-0`)
                        : (ye = `>=${Y}.${ee}.${pe}${k} <${Y}.${+ee + 1}.0-0`)
                      : (ye = `>=${Y}.${ee}.${pe} <${+Y + 1}.0.0-0`)),
          i("caret return", ye),
          ye
        );
      });
        ...
        return (
          ...
          ye
            ...
            : G && de
              ...
              : me
                ? (k = `>=${Y}.0.0${Z} <${+Y + 1}.0.0-0`)
                : Q && (k = `>=${Y}.${ee}.0${Z} <${Y}.${+ee + 1}.0-0`),
          i("xRange return", k),
          k
        );
      });
    },
    _ = (F, L) => (i("replaceStars", F, L), F.trim().replace(o[h.STAR], "")),
    U = (F, L) => (
      i("replaceGTE0", F, L),
      F.trim().replace(o[L.includePrerelease ? h.GTE0PRE : h.GTE0], "")
    ),
    x = (F) => (L, j, k, G, Y, ee, pe, Z, ye, me, Q, de) => (
      N(k)
        ? (j = "")
        : N(G)
          ? (j = `>=${k}.0.0${F ? "-0" : ""}`)
    ...
    $ = (F, L, j) => {
      for (let k = 0; k < F.length; k++) if (!F[k].test(L)) return !1;
      if (L.prerelease.length && !j.includePrerelease) {
        for (let k = 0; k < F.length; k++)
          if (
            (i(F[k].semver),
            F[k].semver !== s.ANY && F[k].semver.prerelease.length > 0)
          ) {
            const G = F[k].semver;
            if (
              G.major === L.major &&
...
function fn() {
  ...
  class t {
    ...
    parse(d) {
      const l = this.options.loose ? n[a.COMPARATORLOOSE] : n[a.COMPARATOR],
        u = d.match(l);
      if (!u) throw new TypeError(`Invalid comparator: ${d}`);
    ...
    test(d) {
      if (
        (i("Comparator.test", d, this.options.loose),
        this.semver === e || d === e)
      )
        return !0;
      if (typeof d == "string")
    ...
    intersects(d, l) {
      ...
      return this.operator === ""
        ? this.value === ""
          ? !0
          : new o(d.value, l).test(this.value)
        : d.operator === ""
          ? d.value === ""
            ? !0
            : new o(this.value, l).test(d.semver)
          : ((l = r(l)),
            (l.includePrerelease &&
...
function Sf() {
  ...
  return (
    (lo = (a, s) => {
      a = new t(a, s);
      let i = new e("0.0.0");
      if (a.test(i) || ((i = new e("0.0.0-0")), a.test(i))) return i;
      i = null;
  ...
  return (
    (uo = (d, l, u, p) => {
      ...
      for (let N = 0; N < l.set.length; ++N) {
        ...
        if (
          (D.forEach((I) => {
            (I.semver === r && (I = new t(">=0.0.0")),
              (S = S || I),
              (b = b || I),
              E(I.semver, S.semver, p)
                ? (S = I)
                : m(I.semver, b.semver, p) && (b = I));
          }),
          S.operator === T ||
            S.operator === A ||
            ((!b.operator || b.operator === T) && y(d, b.semver)))
        )
          return !1;
        if (b.operator === A && m(d, b.semver)) return !1;
      }
      return !0;
    }),
    uo
        ...
        u === p
          ...
          : !p && u === o[0]
            ...
            : p
              ...
              : h.push(`>=${u}`);
      const d = h.join(" || "),
        l = typeof n.raw == "string" ? n.raw : String(n);
  ...
  const e = ht(),
    ...
    o = (l, u, p) => {
      ...
      if (l.length === 1 && l[0].semver === r) {
        if (u.length === 1 && u[0].semver === r) return !0;
      ...
      let T;
      if (y && m) {
        if (((T = a(y.semver, m.semver, p)), T > 0)) return null;
      ...
      for (const v of E) {
        if ((y && !n(v, String(y), p)) || (m && !n(v, String(m), p)))
          return null;
        for (const C of u) if (!n(v, String(C), p)) return !1;
        return !0;
      }
      let A,
        N,
        ...
        if (
          ...
          if (
            (I &&
              ...
              v.semver.major === I.major &&
              v.semver.minor === I.minor &&
              v.semver.patch === I.patch &&
              (I = !1),
            v.operator === ">" || v.operator === ">=")
          ) {
            if (((A = h(y, v, p)), A === v && A !== y)) return !1;
        ...
        if (m) {
          if (
            (b &&
              v.semver.prerelease &&
              v.semver.prerelease.length &&
              v.semver.major === b.major &&
              v.semver.minor === b.minor &&
              v.semver.patch === b.patch &&
              (b = !1),
            v.operator === "<" || v.operator === "<=")
          ) {
            if (((N = d(m, v, p)), N === v && N !== m)) return !1;
          } else if (m.operator === "<=" && !n(m.semver, String(v), p))
            return !1;
        }
        if (!v.operator && (m || y) && T !== 0) return !1;
      }
      return !(
        (y && D && !m && T !== 0) ||
        (m && S && !y && T !== 0) ||
    ...
    Sl ||
      ...
      (function (e, t) {
        var r = 200,
          ...
          me = /^(?:0|[1-9]\d*)$/,
          Q = {};
        ((Q[$] = Q[F] = Q[L] = Q[j] = Q[k] = Q[G] = Q[Y] = Q[ee] = Q[pe] = !0),
          (Q[f] =
            Q[o] =
            Q[U] =
            Q[d] =
            ...
            Q[_] =
              !1));
        var de = typeof ut == "object" && ut && ut.Object === Object && ut,
          we =
            typeof self == "object" && self && self.Object === Object && self,
          Re = de || we || Function("return this")(),
          Ne = t && !t.nodeType && t,
          Ce = Ne && !0 && e && !e.nodeType && e,
          Ae = Ce && Ce.exports === Ne,
          w = Ae && de.process,
          g = (function () {
            try {
        ...
        function P(O, M) {
          for (
            var J = -1, ce = O == null ? 0 : O.length, Pe = 0, ve = [];
            ++J < ce;
          ) {
            var ke = O[J];
            M(ke, J, O) && (ve[Pe++] = ke);
        ...
        function Te(O, M) {
          for (var J = -1, ce = O == null ? 0 : O.length; ++J < ce; )
            if (M(O[J], J, O)) return !0;
          return !1;
        }
        function De(O, M) {
          for (var J = -1, ce = Array(O); ++J < O; ) ce[J] = M(J);
          return ce;
        }
        function $e(O) {
          return function (M) {
        ...
        var ie = Array.prototype,
          ...
          ne = Object.prototype,
          te = Re["__core-js_shared__"],
          ae = V.toString,
          ue = ne.hasOwnProperty,
          Ie = (function () {
          ...
          R = Ae ? Re.Buffer : void 0,
          H = Re.Symbol,
          z = Re.Uint8Array,
          X = ne.propertyIsEnumerable,
          K = ie.splice,
          oe = H ? H.toStringTag : void 0,
          re = Object.getOwnPropertySymbols,
          se = R ? R.isBuffer : void 0,
          fe = B(Object.keys, Object),
          ge = Yt(Re, "DataView"),
          Oe = Yt(Re, "Map"),
          Ue = Yt(Re, "Promise"),
          be = Yt(Re, "Set"),
          ...
          bu = Ut(be),
          Cu = Ut(Vt),
          Qo = H ? H.prototype : void 0,
          wn = Qo ? Qo.valueOf : void 0;
        function Lt(O) {
          var M = -1,
            J = O == null ? 0 : O.length;
          for (this.clear(); ++M < J; ) {
        ...
        ((Lt.prototype.clear = Nu),
          (Lt.prototype.delete = Ou),
          (Lt.prototype.get = Du),
          (Lt.prototype.has = Pu),
          (Lt.prototype.set = Fu));
        function wt(O) {
        ...
        function $u(O, M) {
          var J = this.__data__,
            ce = Mr(J, O);
          return (
            ce < 0 ? (++this.size, J.push([O, M])) : (J[ce][1] = M),
            this
          );
        }
        ((wt.prototype.clear = Lu),
          (wt.prototype.delete = xu),
          (wt.prototype.get = Uu),
          (wt.prototype.has = ku),
          (wt.prototype.set = $u));
        function xt(O) {
        ...
        function $r(O) {
          var M = -1,
            J = O == null ? 0 : O.length;
          for (this.__data__ = new xt(); ++M < J; ) this.add(O[M]);
        }
        function Gu(O) {
              ...
              !(
                ...
                (xe == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
                  ...
                  (ve &&
                    (xe == "buffer" ||
                      xe == "byteLength" ||
                      xe == "byteOffset")) || // Skip index properties.
                  sd(xe, je))
              ) &&
              Be.push(xe);
          return Be;
        ...
        function Mr(O, M) {
          for (var J = O.length; J--; ) if (na(O[J][0], M)) return J;
          return -1;
        }
        function Qu(O, M, J) {
          var ce = M(O);
        ...
        function ea(O, M, J, ce, Pe) {
          return O === M
            ? !0
            : O == null || M == null || (!or(O) && !or(M))
              ? O !== O && M !== M
              : Zu(O, M, J, ce, ea, Pe);
        }
        function Zu(O, M, J, ce, Pe, ve) {
          var ke = Br(O),
            Be = Br(M),
            je = ke ? o : It(O),
            xe = Be ? o : It(M);
          ...
          if (Ve && !tt)
            return (
              ...
              ke || sa(O)
                ? ta(O, M, J, ce, Pe, ve)
                : nd(O, M, je, J, ce, Pe, ve)
            );
          if (!(J & a)) {
            var ot = tt && ue.call(O, "__wrapped__"),
              at = lt && ue.call(M, "__wrapped__");
            if (ot || at) {
              var St = ot ? O.value() : O,
                vt = at ? M.value() : M;
              return (ve || (ve = new Rt()), Pe(St, vt, J, ce, ve));
            }
          }
          return Ve ? (ve || (ve = new Rt()), id(O, M, J, ce, Pe, ve)) : !1;
        }
        function ed(O) {
          if (!aa(O) || cd(O)) return !1;
          var M = ia(O) ? he : ye;
          return M.test(Ut(O));
        }
        function td(O) {
        ...
        function ta(O, M, J, ce, Pe, ve) {
          var ke = J & a,
            Be = O.length,
            je = M.length;
          if (Be != je && !(ke && je > Be)) return !1;
          var xe = ve.get(O);
          if (xe && ve.get(M)) return xe == M;
          var tt = -1,
            lt = !0,
            Ve = J & s ? new $r() : void 0;
          for (ve.set(O, M), ve.set(M, O); ++tt < Be; ) {
            var ot = O[tt],
              at = M[tt];
            if (ce)
              var St = ke ? ce(at, ot, tt, M, O, ve) : ce(ot, at, tt, O, M, ve);
            if (St !== void 0) {
              if (St) continue;
              lt = !1;
              break;
          ...
          return (ve.delete(O), ve.delete(M), lt);
        }
        function nd(O, M, J, ce, Pe, ve, ke) {
          switch (J) {
            case x:
            ...
            case U:
              return !(O.byteLength != M.byteLength || !ve(new z(O), new z(M)));
            case d:
            case l:
            case m:
              return na(+O, +M);
            ...
            case b:
              var je = ce & a;
              if ((Be || (Be = W), O.size != M.size && !je)) return !1;
              var xe = ke.get(O);
              if (xe) return xe == M;
              ((ce |= s), ke.set(O, M));
              var tt = ta(Be(O), Be(M), ce, Pe, ve, ke);
              return (ke.delete(O), tt);
            case v:
              if (wn) return wn.call(O) == wn.call(M);
          }
          return !1;
        }
        function id(O, M, J, ce, Pe, ve) {
          var ke = J & a,
            Be = ra(O),
            je = Be.length,
            xe = ra(M),
            tt = xe.length;
          if (je != tt && !ke) return !1;
          for (var lt = je; lt--; ) {
            var Ve = Be[lt];
            if (!(ke ? Ve in M : ue.call(M, Ve))) return !1;
          }
          var ot = ve.get(O);
          if (ot && ve.get(M)) return ot == M;
          var at = !0;
          (ve.set(O, M), ve.set(M, O));
          for (var St = ke; ++lt < je; ) {
            Ve = Be[lt];
            var vt = O[Ve],
              kt = M[Ve];
            if (ce)
              var la = ke ? ce(kt, vt, Ve, M, O, ve) : ce(vt, kt, Ve, O, M, ve);
          ...
          return (ve.delete(O), ve.delete(M), at);
        }
        function ra(O) {
          return Qu(O, md, ad);
        }
        ...
        var ad = re
            ...
            : gd,
          It = ir;
        ((ge && It(new ge(new ArrayBuffer(1))) != x) ||
          (Oe && It(new Oe()) != y) ||
          (Ue && It(Ue.resolve()) != N) ||
          (be && It(new be()) != b) ||
          (Vt && It(new Vt()) != _)) &&
        ...
        function ud(O) {
          var M = O && O.constructor,
            J = (typeof M == "function" && M.prototype) || ne;
          return O === J;
        }
        function dd(O) {
          return Se.call(O);
...
function Lf() {
  ...
  ((bl = 1),
    ...
    (Kt.DownloadedUpdateHelper = void 0),
    (Kt.createTempUpdateFile = f));
  const e = dt,
    t = At,
    r = Ff(),
    n = /* @__PURE__ */ Ot(),
  ...
  let s = class {
    ...
    async validateDownloadedPath(h, d, l, u) {
      if (this.versionInfo != null && this.file === h && this.fileInfo != null)
        return r(this.versionInfo, d) &&
          r(this.fileInfo.info, l.info) &&
          (await (0, n.pathExists)(h))
          ? h
          : null;
      const p = await this.getValidCachedUpdateFile(l, u);
      return p === null
        ? null
        : (u.info(`Update has already been downloaded to ${h}).`),
          (this._file = p),
          p);
    }
    ...
    async getValidCachedUpdateFile(h, d) {
      ...
      if (!(await (0, n.pathExists)(l))) return null;
      let p;
      try {
      ...
      if (h.info.sha512 !== p.sha512)
        return (
          d.info(
            `Cached update sha512 checksum doesn't match the latest available update. New update must be downloaded. Cached: ${p.sha512}, expected: ${h.info.sha512}. Directory for cached update will be cleaned`,
          ),
          await this.cleanCacheDirForPendingUpdate(),
          null
        );
      ...
      const m = await i(y);
      return h.info.sha512 !== m
        ? (d.warn(
            `Sha512 checksum doesn't match the latest available update. New update must be downloaded. Cached: ${m}, expected: ${h.info.sha512}`,
          ),
          await this.cleanCacheDirForPendingUpdate(),
          null)
        : ((this._downloadedFileInfo = p), y);
    }
    getUpdateInfoFile() {
  ...
  function i(o, h = "sha512", d = "base64", l) {
    return new Promise((u, p) => {
      ...
      (E.on("error", p).setEncoding(d),
        (0, t.createReadStream)(o, {
          ...l,
  ...
  async function f(o, h, d) {
    ...
    for (let p = 0; p < 3; p++)
      try {
        ...
        (d.warn(`Error on remove temp update file: ${E}`),
          (u = a.join(h, `${l++}-${o}`)));
      }
    return u;
  }
...
function xf() {
  ...
  function r() {
    ...
    return (
      process.platform === "win32"
        ? (a = process.env.LOCALAPPDATA || e.join(n, "AppData", "Local"))
        : process.platform === "darwin"
          ? (a = e.join(n, "Library", "Caches"))
          : (a = process.env.XDG_CACHE_HOME || e.join(n, ".cache")),
      a
    );
  }
  return tn;
  ...
  let r = class {
    ...
    get appUpdateConfigPath() {
      return this.isPackaged
        ? e.join(process.resourcesPath, "app-update.yml")
        : e.join(this.app.getAppPath(), "dev-app-update.yml");
    }
    get userDataPath() {
        ...
        class n extends t.HttpExecutor {
          ...
          async download(s, i, f) {
            return await f.cancellationToken.createPromise((o, h, d) => {
              ...
              ((0, t.configureRequestUrl)(s, l),
                (0, t.configureRequestOptions)(l),
                this.doDownload(
                  l,
                  {
                    destination: i,
          ...
          createRequest(s, i) {
            (s.headers &&
              s.headers.Host &&
              ((s.host = s.headers.Host), delete s.headers.Host),
            ...
            return (
              ...
              this.proxyLoginCallback != null &&
                f.on("login", this.proxyLoginCallback),
              f
            );
          }
            ...
            s.on("redirect", (d, l, u) => {
              (s.abort(),
                o > this.maxRedirects
                  ...
                  : h(t.HttpExecutor.prepareRedirectUrlOptions(u, i)));
            });
          }
        }
...
function Gt() {
  ...
  function r(a, s, i = !1) {
    const f = new e.URL(a, s),
      o = s.search;
    return (
      o != null && o.length !== 0
        ? (f.search = o)
        : i && (f.search = `noCache=${Date.now().toString(32)}`),
      f
    );
  }
  function n(a) {
...
function Yc() {
  ...
  var e = "[object Symbol]",
    t = /[\\^$.*+?()[\]{}|]/g,
    r = RegExp(t.source),
    n = typeof ut == "object" && ut && ut.Object === Object && ut,
...
function it() {
  ...
  let s = class {
    constructor(l) {
      ((this.runtimeOptions = l),
        (this.requestHeaders = null),
        (this.executor = l.executor));
    }
    ...
    getBlockMapFiles(l, u, p, E = null) {
      ...
      return [
        (0, n.newUrlFromBase)(
          `${l.pathname.replace(new RegExp(a(p), "g"), u)}.blockmap`,
          E ? new r.URL(E) : l,
        ),
        y,
      ];
  ...
  function i(d, l, u) {
    ...
    const E = d.filter((m) =>
        m.url.pathname.toLowerCase().endsWith(`.${l.toLowerCase()}`),
      ),
      y =
        (p = E.find((m) =>
          [m.url.pathname, m.info.url].some((T) => T.includes(process.arch)),
        )) !== null && p !== void 0
          ? p
          : E.shift();
    return (
      ...
      (u == null
        ...
        : d.find(
            (m) =>
              !u.some((T) =>
                m.url.pathname.toLowerCase().endsWith(`.${T.toLowerCase()}`),
              ),
          ))
    );
  }
  function f(d, l, u) {
    if (d == null)
      throw (0, e.newError)(
        `Cannot parse update info from ${l} in the latest release artifacts (${u}): rawData: null`,
    ...
    try {
      ...
      throw (0, e.newError)(
        `Cannot parse update info from ${l} in the latest release artifacts (${u}): ${E.stack || E.message}, rawData: ${d}`,
        "ERR_UPDATER_INVALID_UPDATE_INFO",
      );
    }
    return p;
  ...
  function o(d) {
    ...
    throw (0, e.newError)(
      `No files provided: ${(0, e.safeStringifyJson)(d)}`,
      "ERR_UPDATER_NO_FILES_PROVIDED",
    );
  }
  function h(d, l, u = (p) => p) {
    const E = o(d).map((T) => {
        if (T.sha2 == null && T.sha512 == null)
          throw (0, e.newError)(
            `Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, e.safeStringifyJson)(T)}`,
      ...
      y = d.packages,
      m = y == null ? null : y[process.arch] || y.ia32;
    return (
      m != null &&
        (E[0].packageInfo = {
          ...m,
  ...
  let n = class extends r.Provider {
    constructor(s, i, f) {
      (super(f),
        ...
        (this.updater = i),
        (this.baseUrl = (0, t.newBaseUrl)(this.configuration.url)));
    }
    get channel() {
    ...
    async getLatestVersion() {
      const s = (0, t.getChannelFilename)(this.channel),
        i = (0, t.newUrlFromBase)(
          s,
          this.baseUrl,
      ...
      for (let f = 0; ; f++)
        try {
          ...
          if (o instanceof e.HttpError && o.statusCode === 404)
            throw (0, e.newError)(
              `Cannot find channel "${s}" update info: ${o.stack || o.message}`,
...
function $f() {
  ...
  let n = class extends r.Provider {
    constructor(s, i, f) {
      ...
      this.baseUrl = (0, t.newBaseUrl)(
        `https://api.bitbucket.org/2.0/repositories/${o}/${h}/downloads`,
      );
    }
    get channel() {
    ...
    async getLatestVersion() {
      const s = new e.CancellationToken(),
        i = (0, t.getChannelFilename)(this.getCustomChannelName(this.channel)),
        f = (0, t.newUrlFromBase)(
          i,
          this.baseUrl,
          this.updater.isAddNoCacheQuery,
        );
      try {
        ...
        throw (0, e.newError)(
          `Unable to find latest version on ${this.toString()}, please ensure release exists: ${o.stack || o.message}`,
...
function Xc() {
  ...
  class i extends a.Provider {
    constructor(l, u, p) {
      (super({
        ...
        (this.options = l),
        (this.baseUrl = (0, n.newBaseUrl)((0, e.githubUrl)(l, u))));
  ...
  let f = class extends i {
    ...
    get channel() {
      ...
      return l == null
        ? this.getDefaultChannelName()
        : this.getCustomChannelName(l);
    }
    async getLatestVersion() {
      var l, u, p, E, y;
      const m = new e.CancellationToken(),
        T = await this.httpRequest(
          (0, n.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl),
          {
        ...
        A = (0, e.parseXml)(T);
      let N = A.element("entry", !1, "No published versions on GitHub"),
        D = null;
      try {
        if (this.updater.allowPrerelease) {
          const _ =
            ((l = this.updater) === null || l === void 0
              ? void 0
              : l.channel) ||
            ((u = t.prerelease(this.updater.currentVersion)) === null ||
            u === void 0
              ? void 0
              : u[0]) ||
            null;
          if (_ === null) D = s.exec(N.element("link").attribute("href"))[1];
          else
            for (const U of A.getElements("entry")) {
              ...
              const $ = x[1],
                F =
                  ((p = t.prerelease($)) === null || p === void 0
                    ? void 0
                    : p[0]) || null,
                L = !_ || ["alpha", "beta"].includes(_),
                j = F !== null && !["alpha", "beta"].includes(String(F));
          ...
          for (const _ of A.getElements("entry"))
            if (s.exec(_.element("link").attribute("href"))[1] === D) {
              N = _;
              break;
            }
        }
        ...
        throw (0, e.newError)(
          `Cannot parse releases feed: ${_.stack || _.message},
XML:
${T}`,
      ...
      let S,
        ...
        I = "";
      const v = async (_) => {
        ((b = (0, n.getChannelFilename)(_)),
          (I = (0, n.newUrlFromBase)(
            this.getBaseDownloadPath(String(D), b),
            this.baseUrl,
          )));
        const U = this.createRequestOptions(I);
        try {
          return await this.executor.request(U, m);
        } catch (x) {
          throw x instanceof e.HttpError && x.statusCode === 404
            ? (0, e.newError)(
                `Cannot find ${b} in the latest release artifacts (${I}): ${x.stack || x.message}`,
                "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
              )
            : x;
        }
      ...
      try {
        ...
        (this.updater.allowPrerelease &&
          !((E = t.prerelease(D)) === null || E === void 0) &&
          E[0] &&
          (_ = this.getCustomChannelName(
            String(
              (y = t.prerelease(D)) === null || y === void 0 ? void 0 : y[0],
            ),
          )),
          (S = await v(_)));
      } catch (_) {
        if (this.updater.allowPrerelease)
          S = await v(this.getDefaultChannelName());
        else throw _;
      }
      const C = (0, a.parseUpdateInfo)(S, b, I);
      return (
        C.releaseName == null &&
          (C.releaseName = N.elementValueOrEmpty("title")),
        C.releaseNotes == null &&
          (C.releaseNotes = h(
      ...
      const u = this.options,
        p =
          u.host == null || u.host === "github.com"
            ? (0, n.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl)
            : new r.URL(
                `${this.computeGithubBasePath(`/repos/${u.owner}/${u.repo}/releases`)}/latest`,
                this.baseApiUrl,
              );
      try {
        ...
        throw (0, e.newError)(
          `Unable to find latest version on GitHub (${p}), please ensure a production release exists: ${E.stack || E.message}`,
          "ERR_UPDATER_LATEST_VERSION_NOT_FOUND",
        );
      }
    }
    ...
    resolveFiles(l) {
      return (0, a.resolveFiles)(l, this.baseUrl, (u) =>
        this.getBaseDownloadPath(l.tag, u.replace(/ /g, "-")),
      );
    }
...
function Mf() {
  ...
  let s = class extends a.Provider {
    ...
    get channel() {
      ...
      return f == null
        ? this.getDefaultChannelName()
        : this.getCustomChannelName(f);
    }
    async getLatestVersion() {
      const f = new e.CancellationToken(),
        o = (0, n.newUrlFromBase)(
          `projects/${this.options.projectId}/releases/permalink/latest`,
          this.baseApiUrl,
        );
      let h;
      try {
        const A = {
          ...
          N = await this.httpRequest(o, A, f);
        if (!N)
          throw (0, e.newError)(
        ...
        throw (0, e.newError)(
          `Unable to find latest release on GitLab (${o}): ${A.stack || A.message}`,
          "ERR_UPDATER_LATEST_VERSION_NOT_FOUND",
        );
      }
      const d = h.tag_name;
      ...
      const E = async (A) => {
        ...
        const N = h.assets.links.find((S) => S.name === u);
        if (!N)
          throw (0, e.newError)(
            `Cannot find ${u} in the latest release assets`,
            "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
          );
        p = new t.URL(N.direct_asset_url);
        const D = this.options.token
          ? { "PRIVATE-TOKEN": this.options.token }
          : void 0;
        try {
          const S = await this.httpRequest(p, D, f);
          if (!S)
            throw (0, e.newError)(
              `Empty response from ${p}`,
              "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
            );
          return S;
        } catch (S) {
          throw S instanceof e.HttpError && S.statusCode === 404
            ? (0, e.newError)(
                `Cannot find ${u} in the latest release artifacts (${p}): ${S.stack || S.message}`,
                "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
              )
            : S;
        }
      ...
      if (!l)
        throw (0, e.newError)(
          `Unable to parse channel data from ${u}`,
          "ERR_UPDATER_INVALID_UPDATE_INFO",
        );
      const y = (0, a.parseUpdateInfo)(l, u, p);
      (y.releaseName == null && (y.releaseName = h.name),
        y.releaseNotes == null && (y.releaseNotes = h.description || null));
    ...
    async fetchReleaseInfoByVersion(f) {
      const o = new e.CancellationToken(),
        h = [`v${f}`, f];
      for (const d of h) {
        const l = (0, n.newUrlFromBase)(
          `projects/${this.options.projectId}/releases/${encodeURIComponent(d)}`,
          this.baseApiUrl,
        );
        try {
          const u = {
            ...
            p = await this.httpRequest(l, u, o);
          if (p) return JSON.parse(p);
        } catch (u) {
          if (u instanceof e.HttpError && u.statusCode === 404) continue;
          throw (0, e.newError)(
            `Unable to find release ${d} on GitLab (${l}): ${u.stack || u.message}`,
            "ERR_UPDATER_RELEASE_NOT_FOUND",
          );
        }
      }
      throw (0, e.newError)(
        `Unable to find release with version ${f} (tried: ${h.join(", ")}) on GitLab`,
        "ERR_UPDATER_RELEASE_NOT_FOUND",
      );
    }
    ...
    async getBlockMapFiles(f, o, h, d = null) {
      if (this.options.uploadTarget === "project_upload") {
        const l = f.pathname.split("/").pop() || "",
          [u, p] = await this.findBlockMapUrlsFromAssets(o, h, l);
        if (!p)
          throw (0, e.newError)(
            `Cannot find blockmap file for ${h} in GitLab assets`,
            "ERR_UPDATER_BLOCKMAP_FILE_NOT_FOUND",
          );
        if (!u)
          throw (0, e.newError)(
            `Cannot find blockmap file for ${o} in GitLab assets`,
            "ERR_UPDATER_BLOCKMAP_FILE_NOT_FOUND",
          );
        return [u, p];
      } else return super.getBlockMapFiles(f, o, h, d);
    }
    resolveFiles(f) {
      return (0, a.getFileList)(f).map((o) => {
        const d = [
          ...
          ].find((u) => f.assets.has(u)),
          l = d ? f.assets.get(d) : void 0;
        if (!l)
          throw (0, e.newError)(
            `Cannot find asset "${o.url}" in GitLab release assets. Available assets: ${Array.from(f.assets.keys()).join(", ")}`,
...
function qf() {
  ...
  let n = class extends r.Provider {
    constructor(s, i, f) {
      ...
      this.baseUrl = (0, t.newBaseUrl)(
        `https://${o}/v1/accounts/${this.configuration.account}/artifacts?product=${this.configuration.product}`,
      );
    }
    get channel() {
    ...
    async getLatestVersion() {
      ...
      try {
        const o = await this.httpRequest(
          f,
          {
...
function Bf() {
  ...
  ((Ml = 1),
    ...
    (gr.PrivateGitHubProvider = void 0));
  const e = He(),
    t = Uo(),
    r = Le,
    n = Nt,
  ...
  let f = class extends s.BaseGitHubProvider {
    ...
    async getLatestVersion() {
      const h = new e.CancellationToken(),
        d = (0, a.getChannelFilename)(this.getDefaultChannelName()),
        l = await this.getLatestVersionInfo(h),
        u = l.assets.find((y) => y.name === d);
      if (u == null)
        throw (0, e.newError)(
          `Cannot find ${d} in the release ${l.html_url || l.name}`,
          "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
        );
      ...
      try {
        ...
        throw y instanceof e.HttpError && y.statusCode === 404
          ? (0, e.newError)(
              `Cannot find ${d} in the latest release artifacts (${p}): ${y.stack || y.message}`,
              "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND",
            )
          : y;
      }
    ...
    async getLatestVersionInfo(h) {
      ...
      try {
        ...
        throw (0, e.newError)(
          `Unable to find latest version on GitHub (${u}), please ensure a production release exists: ${p.stack || p.message}`,
          "ERR_UPDATER_LATEST_VERSION_NOT_FOUND",
        );
      }
    }
    ...
    resolveFiles(h) {
      return (0, i.getFileList)(h).map((d) => {
        const l = r.posix.basename(d.url).replace(/ /g, "-"),
          u = h.assets.find((p) => p != null && p.name === l);
        if (u == null)
          throw (0, e.newError)(
            `Cannot find asset "${l}" in: ${JSON.stringify(h.assets, null, 2)}`,
            "ERR_UPDATER_ASSET_NOT_FOUND",
          );
        return {
          url: new n.URL(u.url),
...
function Hf() {
  ...
  ((ql = 1),
    ...
    (fr.isUrlProbablySupportMultiRangeRequests = f),
    (fr.createClient = o));
  const e = He(),
    t = $f(),
    r = zc(),
        ...
        const p = h,
          E =
            (p.private
              ...
              : null) || p.token;
        return E == null
          ? new n.GitHubProvider(p, d, l)
          : new i.PrivateGitHubProvider(p, d, E, l);
      }
      case "bitbucket":
      ...
      case "generic": {
        ...
        return new r.GenericProvider(p, d, {
          ...
          isUseMultipleRangeRequest:
            p.useMultipleRangeRequest !== !1 && f(p.url),
        });
      }
      case "custom": {
        const p = h,
...
function jo() {
  ...
  function t(i, f, o) {
    ...
    const m = d.get(E);
    let T = 0;
    const { checksumToOffset: A, checksumToOldSize: N } = a(
      h.get(E),
      y.offset,
      o,
    );
    let D = u.offset;
    for (let S = 0; S < m.checksums.length; D += m.sizes[S], S++) {
      const b = m.sizes[S],
        I = m.checksums[S];
      let v = A.get(I);
      (v != null &&
        N.get(I) !== b &&
        (o.warn(
          `Checksum ("${I}") matches, but size differs (old: ${N.get(I)}, new: ${b})`,
        ),
        (v = void 0)),
        v === void 0
          ? (T++,
            l != null && l.kind === e.DOWNLOAD && l.end === D
              ? (l.end += b)
              : ((l = {
                  kind: e.DOWNLOAD,
                  start: D,
    ...
    return (
      T > 0 &&
        o.info(
          `File${u.name === "file" ? "" : " " + u.name} has ${T} changed blocks`,
        ),
      p
    );
  }
  ...
  function n(i, f, o, h) {
    if (r && f.length !== 0) {
      ...
      if (d.kind === i.kind && i.start < d.end && i.start > d.start) {
        const l = [d.start, d.end, i.start, i.end].reduce((u, p) =>
          u < p ? u : p,
        );
...
rel: ${d.start - l} until ${d.end - l} and ${i.start - l} until ${i.end - l}`);
  ...
  function a(i, f, o) {
    ...
    for (let u = 0; u < i.checksums.length; u++) {
      const p = i.checksums[u],
        E = i.sizes[u],
        y = d.get(p);
      if (y === void 0) (h.set(p, l), d.set(p, E));
      else if (o.debug != null) {
        const m = y === E ? "(same size)" : `(size: ${y}, this size: ${E})`;
        o.debug(
          `${p} duplicated in blockmap ${m}, it doesn't lead to broken differential downloader, just corresponding block will be skipped)`,
        );
      }
      l += E;
    }
  ...
  function s(i) {
    ...
    for (const o of i) f.set(o.name, o);
    return f;
  }
  return Zt;
}
  ...
  let f = class extends r.Writable {
    constructor(h, d, l, u, p, E, y, m) {
      (super(),
        (this.out = h),
        (this.options = d),
        (this.partIndexToTaskIndex = l),
        (this.partIndexToLength = p),
        (this.finishHandler = E),
        (this.grandTotalBytes = y),
        (this.onProgress = m),
        (this.start = Date.now()),
        (this.nextUpdate = this.start + 1e3),
        (this.transferred = 0),
      ...
      this.handleData(h)
        .then(() => {
          if (this.onProgress) {
            const u = Date.now();
            (u >= this.nextUpdate ||
              this.transferred === this.grandTotalBytes) &&
              this.grandTotalBytes &&
              (u - this.start) / 1e3 &&
              ((this.nextUpdate = u + 1e3),
              this.onProgress({
                ...
                bytesPerSecond: Math.round(
                  this.transferred / ((u - this.start) / 1e3),
                ),
              }),
              (this.delta = 0));
          }
    ...
    async handleData(h) {
      ...
      if (this.ignoreByteCount > 0) {
        ...
        ((this.remainingPartDataCount -= l),
          await this.processPartData(h, 0, l),
          (d = l));
      }
      if (d !== h.length) {
        ...
        for (;;) {
          ...
          const l = this.partIndexToLength[this.partIndex],
            u = d + l,
            p = Math.min(u, h.length);
          if (
            (await this.processPartStarted(h, d, p),
            (this.remainingPartDataCount = l - (p - d)),
            this.remainingPartDataCount > 0)
          )
            return;
    ...
    onPartEnd() {
      ...
      if (this.actualPartLength !== h)
        throw (0, e.newError)(
          `Expected length: ${h} differs from actual: ${this.actualPartLength}`,
    ...
    processPartStarted(h, d, l) {
      return (
        ...
        this.processPartData(h, d, l)
      );
    }
    processPartData(h, d, l) {
      ((this.actualPartLength += l - d),
        (this.transferred += l - d),
        (this.delta += l - d));
      const u = this.out;
      return u.write(d === 0 && h.length === l ? h : h.slice(d, l))
        ? Promise.resolve()
        : new Promise((p, E) => {
            (u.on("error", E),
              u.once("drain", () => {
...
function jf() {
  ...
  ((jl = 1),
    ...
    (wr.executeTasksUsingMultipleRangeRequests = n),
    (wr.checkIsRangesSupported = s));
  const e = He(),
    t = Kc(),
    r = jo();
  function n(i, f, o, h, d) {
    const l = (u) => {
      if (u >= f.length) {
        (i.fileMetadataBuffer != null && o.write(i.fileMetadataBuffer),
          o.end());
        return;
      }
      const p = u + 1e3;
  ...
  function a(i, f, o, h, d) {
    ...
    for (let A = f.start; A < f.end; A++) {
      const N = f.tasks[A];
      N.kind === r.OperationKind.DOWNLOAD &&
        ((l += `${N.start}-${N.end - 1}, `),
        E.set(u, A),
        u++,
        y.push(N.end - N.start),
        (p += N.end - N.start));
    }
    if (u <= 1) {
      const A = (N) => {
        ...
        if (D.kind === r.OperationKind.COPY)
          ...
          const S = i.createRequestOptions();
          S.headers.Range = `bytes=${D.start}-${D.end - 1}`;
          const b = i.httpExecutor.createRequest(S, (I) => {
            (I.on("error", d),
              s(I, d) &&
                (I.pipe(o, {
                  end: !1,
    ...
    const T = i.httpExecutor.createRequest(m, (A) => {
      if (!s(A, d)) return;
      const N = (0, e.safeGetHeader)(A, "content-type"),
        D = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(
          N,
        );
      if (D == null) {
        d(
          new Error(
            `Content-Type "multipart/byteranges" is expected, but got "${N}"`,
          ),
        );
        return;
      }
      const S = new t.DataSplitter(
        o,
        f,
        E,
        D[1] || D[2],
      ...
      (S.on("error", d),
        ...
        A.on("end", () => {
          setTimeout(() => {
            (T.abort(),
              d(new Error("Response ends without calling any handlers")));
          }, 1e4);
        }));
    });
  ...
  function s(i, f) {
    if (i.statusCode >= 400) return (f((0, e.createHttpError)(i)), !1);
    if (i.statusCode !== 206) {
      ...
      if (o == null || o === "none")
        return (
          f(
            new Error(
              `Server doesn't support Accept-Ranges (response code ${i.statusCode})`,
            ),
          ),
          !1
        );
...
function Gf() {
  ...
  ((Gl = 1),
    ...
    (vr.ProgressDifferentialDownloadCallbackTransform = void 0));
  const e = Dr;
  var t;
  (function (n) {
  ...
  let r = class extends e.Transform {
    constructor(a, s, i) {
      (super(),
        (this.progressDifferentialDownloadInfo = a),
        (this.cancellationToken = s),
        (this.onProgress = i),
        (this.start = Date.now()),
        (this.transferred = 0),
        (this.delta = 0),
      ...
      (f >= this.nextUpdate &&
        ...
        this.onProgress({
          ...
          percent:
            ...
            100,
          bytesPerSecond: Math.round(
            this.transferred / ((f - this.start) / 1e3),
          ),
        }),
        (this.delta = 0)),
        i(null, a));
...
function Jc() {
  ...
  let o = class {
    ...
    createRequestOptions() {
      ...
      return (
        (0, e.configureRequestUrl)(this.options.newUrl, u),
        (0, e.configureRequestOptions)(u),
        u
      );
    }
    doDownload(u, p) {
      if (u.version !== p.version)
        throw new Error(
          `version is different (${u.version} - ${p.version}), full download is required`,
        );
      const E = this.logger,
        y = (0, s.computeOperations)(u, p, E);
      E.debug != null && E.debug(JSON.stringify(y, null, 2));
      let m = 0,
        T = 0;
      for (const N of y) {
        const D = N.end - N.start;
        N.kind === s.OperationKind.DOWNLOAD ? (m += D) : (T += D);
      }
      ...
      if (
        ...
        throw new Error(
          `Internal error, size mismatch: downloadSize: ${m}, copySize: ${T}, newSize: ${A}`,
        );
      return (
        E.info(
          `Full: ${h(A)}, To download: ${h(m)} (${Math.round(m / (A / 100))}%)`,
        ),
        this.downloadFile(y)
      );
    }
    downloadFile(u) {
      const p = [],
        E = () =>
          Promise.all(
            p.map((y) =>
              (0, t.close)(y.descriptor).catch((m) => {
                this.logger.error(`cannot close file "${y.path}": ${m}`);
              }),
            ),
          );
      return this.doDownloadFile(u, p)
        .then(E)
        .catch((y) =>
          E()
            .catch((m) => {
    ...
    async doDownloadFile(u, p) {
      ...
      await new Promise((T, A) => {
        ...
        if (
          ...
          let $ = 0;
          for (const L of u)
            L.kind === s.OperationKind.DOWNLOAD &&
              (x.push(L.end - L.start), ($ += L.end - L.start));
          const F = {
            expectedByteCounts: x,
            grandTotal: $,
          };
          ((D = new f.ProgressDifferentialDownloadCallbackTransform(
            F,
        ...
        if (this.options.isUseMultipleRangeRequest) {
          ((v = (0, i.executeTasksUsingMultipleRangeRequests)(
            this,
            u,
            I,
            E,
        ...
        ((U.redirect = "manual"),
          (v = (x) => {
            ...
            if (x >= u.length) {
              (this.fileMetadataBuffer != null &&
                I.write(this.fileMetadataBuffer),
                I.end());
              return;
            }
            const L = u[x++];
            if (L.kind === s.OperationKind.COPY) {
              (D && D.beginFileCopy(), (0, n.copyData)(L, I, E, A, () => v(x)));
              return;
            }
            const j = `bytes=${L.start}-${L.end - 1}`;
            ((U.headers.range = j),
              (F =
                ($ = this.logger) === null || $ === void 0
                  ? void 0
                  : $.debug) === null ||
                F === void 0 ||
                F.call($, `download range: ${j}`),
            ...
            const k = this.httpExecutor.createRequest(U, (G) => {
              (G.on("error", A),
                ...
                G.statusCode >= 400 && A((0, e.createHttpError)(G)),
                G.pipe(I, {
                  end: !1,
                }),
                G.once("end", () => {
                  (D && D.endRangeDownload(),
                    ++C === 100
                      ? ((C = 0), setTimeout(() => v(x), 1e3))
                      : v(x));
                }));
            });
            (k.on("redirect", (G, Y, ee) => {
              (this.logger.info(`Redirect to ${d(ee)}`),
                (_ = ee),
                (0, e.configureRequestUrl)(new a.URL(_), U),
                k.followRedirect());
            }),
              this.httpExecutor.addErrorAndTimeoutHandlers(k, A),
              k.end());
          }),
          v(0));
      });
    ...
    async readRemoteBytes(u, p) {
      const E = Buffer.allocUnsafe(p + 1 - u),
        y = this.createRequestOptions();
      y.headers.range = `bytes=${u}-${p}`;
      let m = 0;
      if (
        (await this.request(y, (T) => {
          (T.copy(E, m), (m += T.length));
        }),
        m !== E.length)
      )
        throw new Error(
          `Received data length ${m} is not equal to expected ${E.length}`,
        );
      return E;
    }
    request(u, p) {
      return new Promise((E, y) => {
        const m = this.httpExecutor.createRequest(u, (T) => {
          (0, i.checkIsRangesSupported)(T, y) &&
            (T.on("error", y),
            T.on("aborted", () => {
...
function Wf() {
  ...
  ((Vl = 1),
    ...
    (Er.GenericDifferentialDownloader = void 0));
  const e = Jc();
  ...
  let T = class Qc extends n.EventEmitter {
    ...
    set channel(S) {
      if (this._channel != null) {
        if (typeof S != "string")
          throw (0, e.newError)(
            `Channel must be a string, but got: ${S}`,
    ...
    set updateConfigPath(S) {
      ((this.clientPromise = null),
        (this._appUpdateConfigPath = S),
        (this.configOnDisk = new i.Lazy(() => this.loadUpdateConfig())));
    }
    /**
    ...
    set isUpdateSupported(S) {
      S && (this._isUpdateSupported = S);
    }
    /**
    ...
    set isUserWithinRollout(S) {
      S && (this._isUserWithinRollout = S);
    }
    constructor(S, b) {
      (super(),
        (this.autoDownload = !0),
        ...
        (this.signals = new m.UpdaterSignal(this)),
        (this._appUpdateConfigPath = null),
        (this._isUpdateSupported = (C) => this.checkIfUpdateSupported(C)),
        (this._isUserWithinRollout = (C) => this.isStagingMatch(C)),
        (this.clientPromise = null),
        (this.stagingUserIdPromise = new i.Lazy(() =>
        ...
        b == null
          ? ((this.app = new d.ElectronAppAdapter()),
            (this.httpExecutor = new l.ElectronHttpExecutor((C, _) =>
              this.emit("login", C, _),
            )))
          : ((this.app = b), (this.httpExecutor = null)));
      const I = this.app.version,
        v = (0, o.parse)(I);
      if (v == null)
        throw (0, e.newError)(
          `App version is not a valid semver version: "${I}"`,
          "ERR_UPDATER_INVALID_VERSION",
        );
      ((this.currentVersion = v),
        (this.allowPrerelease = A(v)),
        S != null &&
          (this.setFeedURL(S),
          typeof S != "string" &&
            S.requestHeaders &&
    ...
    setFeedURL(S) {
      ...
      let I;
      (typeof S == "string"
        ? (I = new u.GenericProvider({ provider: "generic", url: S }, this, {
            ...b,
            isUseMultipleRangeRequest: (0,
            p.isUrlProbablySupportMultiRangeRequests)(S),
          }))
        : (I = (0, p.createClient)(S, this, b)),
        (this.clientPromise = Promise.resolve(I)));
    }
    /**
          ...
          .catch((I) => {
            throw (
              ...
              this.emit(
                "error",
                I,
                `Cannot check for updates: ${(I.stack || I).toString()}`,
              ),
              I
            );
          })),
        (this.checkForUpdatesPromise = S),
        S
      );
    }
    isUpdaterActive() {
    ...
    checkForUpdatesAndNotify(S) {
      return this.checkForUpdates().then((b) =>
        b?.downloadPromise
          ? (b.downloadPromise.then(() => {
              const I = Qc.formatDownloadNotification(
                b.updateInfo.version,
                this.app.name,
                S,
              );
              new Ht.Notification(I).show();
            }),
            b)
    ...
    static formatDownloadNotification(S, b, I) {
      return (
        I == null &&
          (I = {
        ...
        (I = {
          title: I.title.replace("{appName}", b).replace("{version}", S),
          body: I.body.replace("{appName}", b).replace("{version}", S),
        }),
        I
      );
    }
    async isStagingMatch(S) {
      const b = S.stagingPercentage;
      let I = b;
      if (I == null) return !0;
      if (((I = parseInt(I, 10)), isNaN(I)))
        return (this._logger.warn(`Staging percentage is NaN: ${b}`), !0);
      I = I / 100;
      const v = await this.stagingUserIdPromise.value,
        _ = e.UUID.parse(v).readUInt32BE(12) / 4294967295;
      return (
        this._logger.info(
          `Staging percentage: ${I}, percentage: ${_}, user id: ${v}`,
        ),
        _ < I
      );
    }
    computeFinalHeaders(S) {
      return (
        this.requestHeaders != null && Object.assign(S, this.requestHeaders),
        S
      );
    }
    async isUpdateAvailable(S) {
      const b = (0, o.parse)(S.version);
      if (b == null)
        throw (0, e.newError)(
          `This file could not be downloaded, or the latest version (from update server) does not have a valid semver version: "${S.version}"`,
          "ERR_UPDATER_INVALID_VERSION",
        );
      const I = this.currentVersion;
      if (
        (0, o.eq)(b, I) ||
        !(await Promise.resolve(this.isUpdateSupported(S))) ||
        !(await Promise.resolve(this.isUserWithinRollout(S)))
      )
        return !1;
      const C = (0, o.gt)(b, I),
        _ = (0, o.lt)(b, I);
    ...
    checkIfUpdateSupported(S) {
      const b = S?.minimumSystemVersion,
        I = (0, r.release)();
      if (b)
        try {
          if ((0, o.lt)(I, b))
            return (
              this._logger.info(
                `Current OS version ${I} is less than the minimum OS version required ${b} for version ${I}`,
              ),
              !1
            );
        } catch (v) {
          this._logger.warn(
            `Failed to compare current OS version(${I}) with minimum OS version(${b}): ${(v.message || v).toString()}`,
          );
        }
      return !0;
    }
    async getUpdateInfoAndProvider() {
      (await this.app.whenReady(),
        this.clientPromise == null &&
          (this.clientPromise = this.configOnDisk.value.then((I) =>
            (0, p.createClient)(I, this, this.createProviderRuntimeOptions()),
          )));
      const S = await this.clientPromise,
        b = await this.stagingUserIdPromise.value;
      return (
        S.setRequestHeaders(
          this.computeFinalHeaders({ "x-user-staging-id": b }),
        ),
        {
    ...
    async doCheckForUpdates() {
      ...
      const S = await this.getUpdateInfoAndProvider(),
        b = S.info;
      if (!(await this.isUpdateAvailable(b)))
        return (
          this._logger.info(
            `Update for version ${this.currentVersion.format()} is not available (latest version: ${b.version}, downgrade is ${this.allowDowngrade ? "allowed" : "disallowed"}).`,
          ),
          this.emit("update-not-available", b),
          {
            isUpdateAvailable: !1,
            versionInfo: b,
            updateInfo: b,
      ...
      ((this.updateInfoAndProvider = S), this.onUpdateAvailable(b));
    ...
    onUpdateAvailable(S) {
      (this._logger.info(
        `Found version ${S.version} (url: ${(0, e.asArray)(S.files)
          .map((b) => b.url)
          .join(", ")})`,
      ),
    ...
    downloadUpdate(S = new e.CancellationToken()) {
      ...
      this._logger.info(
        `Downloading update from ${(0, e.asArray)(b.info.files)
          .map((v) => v.url)
          .join(", ")}`,
      );
      const I = (v) => {
    ...
    dispatchUpdateDownloaded(S) {
      this.emit(m.UPDATE_DOWNLOADED, S);
    }
    async loadUpdateConfig() {
      return (
        this._appUpdateConfigPath == null &&
          (this._appUpdateConfigPath = this.app.appUpdateConfigPath),
        (0, s.load)(await (0, a.readFile)(this._appUpdateConfigPath, "utf-8"))
      );
    }
    computeRequestHeaders(S) {
      const b = S.fileExtraDownloadHeaders;
      if (b != null) {
    ...
    async getOrCreateStagingUserId() {
      const S = f.join(this.app.userDataPath, ".updaterId");
      try {
        const I = await (0, a.readFile)(S, "utf-8");
        if (e.UUID.check(I)) return I;
        this._logger.warn(
          `Staging user id file exists, but content was invalid: ${I}`,
        );
      } catch (I) {
        I.code !== "ENOENT" &&
          this._logger.warn(
            `Couldn't read staging user ID, creating a blank one: ${I}`,
          );
      }
      const b = e.UUID.v5((0, t.randomBytes)(4096), e.UUID.OID);
      this._logger.info(`Generated new staging user ID: ${b}`);
      try {
        await (0, a.outputFile)(S, b);
      } catch (I) {
    ...
    get isAddNoCacheQuery() {
      ...
      for (const b of Object.keys(S)) {
        ...
        if (I === "authorization" || I === "private-token") return !1;
      }
      return !0;
    }
    async getOrCreateDownloadHelper() {
      ...
      if (S == null) {
        const b = (await this.configOnDisk.value).updaterCacheDirName,
          I = this._logger;
        b == null &&
          I.error(
        ...
        (I.debug != null && I.debug(`updater cache dir: ${v}`),
          (S = new h.DownloadedUpdateHelper(v)),
          (this.downloadedUpdateHelper = S));
      }
      return S;
    }
    async executeDownload(S) {
      ...
      this.listenerCount(m.DOWNLOAD_PROGRESS) > 0 &&
        (I.onProgress = (Z) => this.emit(m.DOWNLOAD_PROGRESS, Z));
      const v = S.downloadUpdateOptions.updateInfoAndProvider.info,
        C = v.version,
        _ = b.packageInfo;
      function U() {
        const Z = decodeURIComponent(S.fileInfo.url.pathname);
        return Z.toLowerCase().endsWith(`.${S.fileExtension.toLowerCase()}`)
          ? f.basename(Z)
          : S.fileInfo.info.url;
      }
      const x = await this.getOrCreateDownloadHelper(),
        $ = x.cacheDirForPendingUpdate;
      ...
      const j =
          _ == null
            ? null
            : f.join($, `package-${C}${f.extname(_.path) || ".7z"}`),
        k = async (Z) => {
          (await x.setDownloadedFile(L, j, v, b, F, Z),
            await S.done({
              ...v,
              downloadedFile: L,
            }));
          ...
          return (
            (await (0, a.pathExists)(ye)) &&
              (await (0, a.copyFile)(
                ye,
                f.join(x.cacheDir, "current.blockmap"),
              )),
            j == null ? [L] : [L, j]
          );
        },
        G = this._logger,
        Y = await x.validateDownloadedPath(L, v, b, G);
      if (Y != null) return ((L = Y), await k(!1));
      const ee = async () => (
          await x.clear().catch(() => {}),
      ...
      try {
        (await S.task(pe, I, j, ee),
          await (0, e.retry)(() => (0, a.rename)(pe, L), {
            retries: 60,
            interval: 500,
            shouldRetry: (Z) =>
              Z instanceof Error && /^EBUSY:/.test(Z.message)
                ? !0
                : (G.warn(
                    `Cannot rename temp file to final file: ${Z.message || Z.stack}`,
                  ),
                  !1),
          }));
      } catch (Z) {
        throw (
          await ee(),
          Z instanceof e.CancellationError &&
            (G.info("cancelled"), this.emit("update-cancelled", v)),
          Z
        );
      }
      return (
        G.info(`New version ${C} has been downloaded to ${L}`),
        await k(!0)
      );
    }
    async differentialDownloadInstaller(S, b, I, v, C) {
      try {
        if (
          this._testOnlyOptions != null &&
          ...
          return !0;
        const _ = b.updateInfoAndProvider.provider,
          U = await _.getBlockMapFiles(
            S.url,
            this.app.version,
            b.updateInfoAndProvider.info.version,
        ...
        const x = async (G) => {
            ...
            try {
              ...
              throw new Error(
                `Cannot parse blockmap "${G.href}", error: ${ee}`,
              );
            }
          },
          $ = {
        ...
        this.listenerCount(m.DOWNLOAD_PROGRESS) > 0 &&
          ($.onProgress = (G) => this.emit(m.DOWNLOAD_PROGRESS, G));
        const F = async (G, Y) => {
          ...
          L = async (G) => {
            ...
            try {
              if (await (0, a.pathExists)(Y))
                return JSON.parse(
                  (0, E.gunzipSync)(await (0, a.readFile)(Y)).toString(),
                );
            } catch (ee) {
        ...
        return (
          k == null && (k = await x(U[0])),
          await new y.GenericDifferentialDownloader(
            S.info,
            this.httpExecutor,
            $,
          ).download(k, j),
        ...
        if (
          (this._logger.error(
            `Cannot download differentially, fallback to full download: ${_.stack || _}`,
          ),
          this._testOnlyOptions != null)
        )
          throw _;
  ...
  let r = class extends t.AppUpdater {
    ...
    quitAndInstall(a = !1, s = !1) {
      (this._logger.info("Install on explicit quitAndInstall"),
        this.install(a, a ? s : this.autoRunAppAfterInstall)
          ? setImmediate(() => {
    ...
    executeDownload(a) {
      return super.executeDownload({
        ...a,
          ...
          this.dispatchUpdateDownloaded(s),
          this.addQuitHandler(),
          Promise.resolve()
        ),
      });
    ...
    install(a = !1, s = !1) {
      ...
      const i = this.downloadedUpdateHelper,
        f = this.installerPath,
        o = i == null ? null : i.downloadedFileInfo;
      if (f == null || o == null)
        return (
          this.dispatchError(
      ...
      try {
        return (
          this._logger.info(`Install: isSilent: ${a}, isForceRunAfter: ${s}`),
          this.doInstall({
            isSilent: a,
            isForceRunAfter: s,
    ...
    addQuitHandler() {
      this.quitHandlerAdded ||
        ...
        this.app.onQuit((a) => {
          ...
          if (a !== 0) {
            this._logger.info(
              `Update will be not installed on quit because application is quitting with exit code ${a}`,
            );
            return;
          }
    ...
    spawnSyncLog(a, s = [], i = {}) {
      ...
      if (h != null && h !== 0)
        throw (
          ...
          new Error(`Command ${a} exited with code ${h}`)
        );
      return d.trim();
    }
    /**
    ...
    async spawnLog(a, s = [], i = void 0, f = "ignore") {
      return (
        ...
        new Promise((o, h) => {
          try {
            const d = { stdio: f, env: i, detached: !0 },
              l = (0, e.spawn)(a, s, d);
            (l.on("error", (u) => {
              h(u);
            }),
...
function Zc() {
  ...
  let n = class extends t.DifferentialDownloader {
    async download() {
      const f = this.blockAwareFileInfo,
        o = f.size,
        h = o - (f.blockMapSize + 4);
...
function Ql() {
  ...
  let h = class extends s.BaseUpdater {
    ...
    /*** @private */
    doDownloadUpdate(l) {
      const u = l.updateInfoAndProvider.provider,
        p = (0, f.findFile)(
          u.resolveFiles(l.updateInfoAndProvider.info),
          "AppImage",
          ["rpm", "deb", "pacman"],
        );
      return this.executeDownload({
        ...
        task: async (E, y) => {
          ...
          ((l.disableDifferentialDownload ||
            (await this.downloadDifferential(p, m, E, u, l))) &&
            (await this.httpExecutor.download(p.url, E, y)),
            await (0, r.chmod)(E, 493));
        },
      });
    }
      ...
      try {
        ...
        return (
          this.listenerCount(o.DOWNLOAD_PROGRESS) > 0 &&
            (m.onProgress = (T) => this.emit(o.DOWNLOAD_PROGRESS, T)),
          await new i.FileWithEmbeddedBlockMapDifferentialDownloader(
            l.info,
            this.httpExecutor,
            m,
          ).download(),
        ...
        return (
          this._logger.error(
            `Cannot download differentially, fallback to full download: ${m.stack || m}`,
          ),
    ...
    doInstall(l) {
      ...
      (a.basename(y) === E || !/\d+\.\d+\.\d+/.test(E)
        ? (p = u)
        : (p = a.join(a.dirname(u), a.basename(y))),
        (0, t.execFileSync)("mv", ["-f", y, p]),
        p !== u && this.emit("appimage-filename-updated", p));
      const m = {
        ...process.env,
...
function Wo() {
  ...
  let t = class extends e.BaseUpdater {
    ...
    isRunningAsRoot() {
      var n;
      return (
        ((n = process.getuid) === null || n === void 0
          ? void 0
          : n.call(process)) === 0
      );
    }
    ...
    get installerPath() {
      var n, a;
      return (a =
        (n = super.installerPath) === null || n === void 0
          ? void 0
          : n.replace(/\\/g, "\\\\").replace(/ /g, "\\ ")) !== null &&
        a !== void 0
        ? a
        : null;
    }
    runCommandWithSudoIfNeeded(n) {
      if (this.isRunningAsRoot())
        return (
          ...
          this.spawnSyncLog(n[0], n.slice(1))
        );
      const { name: a } = this.app,
        s = `"${a} would like to update"`,
        i = this.sudoWithArgs(s);
      this._logger.info(
        `Running as non-root user, using sudo to install: ${i}`,
      );
      let f = '"';
      return (
        (/pkexec/i.test(i[0]) || i[0] === "sudo") && (f = ""),
        this.spawnSyncLog(i[0], [
          ...(i.length > 1 ? i.slice(1) : []),
          `${f}/bin/bash`,
          "-c",
          `'${n.join(" ")}'${f}`,
        ])
    ...
    sudoWithArgs(n) {
      const a = this.determineSudoCommand(),
        s = [a];
      return (
        /kdesudo/i.test(a)
          ? (s.push("--comment", n), s.push("-c"))
          : /gksudo/i.test(a)
            ? s.push("--message", n)
            : /pkexec/i.test(a) && s.push("--disable-internal-agent"),
        s
      );
    }
    hasCommand(n) {
    ...
    determineSudoCommand() {
      ...
      for (const a of n) if (this.hasCommand(a)) return a;
      return "sudo";
    }
    /**
    ...
    detectPackageManager(n) {
      var a;
      const s =
        (a = process.env.ELECTRON_BUILDER_LINUX_PACKAGE_MANAGER) === null ||
        a === void 0
          ? void 0
          : a.trim();
      if (s) return s;
      for (const i of n) if (this.hasCommand(i)) return i;
      return (
        this._logger.warn(
          `No package manager found in the list: ${n.join(", ")}. Defaulting to the first one: ${n[0]}`,
        ),
        n[0]
      );
    }
...
function tc() {
  ...
  let n = class eu extends r.LinuxUpdater {
    ...
    /*** @private */
    doDownloadUpdate(s) {
      const i = s.updateInfoAndProvider.provider,
        f = (0, e.findFile)(
          i.resolveFiles(s.updateInfoAndProvider.info),
          "deb",
          ["AppImage", "rpm", "pacman"],
        );
      return this.executeDownload({
        ...
        task: async (o, h) => {
          (this.listenerCount(t.DOWNLOAD_PROGRESS) > 0 &&
            (h.onProgress = (d) => this.emit(t.DOWNLOAD_PROGRESS, d)),
            await this.httpExecutor.download(f.url, o, h));
        },
      });
    }
    doInstall(s) {
      ...
      const f = ["dpkg", "apt"],
        o = this.detectPackageManager(f);
      try {
        eu.installWithCommandRunner(
          o,
          i,
          this.runCommandWithSudoIfNeeded.bind(this),
          this._logger,
        );
      } catch (h) {
        return (this.dispatchError(h), !1);
    ...
    static installWithCommandRunner(s, i, f, o) {
      ...
      if (s === "dpkg")
        try {
          ...
          (o.warn((h = d.message) !== null && h !== void 0 ? h : d),
            o.warn(
              "dpkg installation failed, trying to fix broken dependencies with apt-get",
            ),
            f(["apt-get", "install", "-f", "-y"]));
        }
      else if (s === "apt")
        (o.warn(
          "Using apt to install a local .deb. This may fail for unsigned packages unless properly configured.",
        ),
          f([
            "apt",
            "install",
      ...
      else throw new Error(`Package manager ${s} not supported`);
    }
  };
  ...
  let n = class tu extends r.LinuxUpdater {
      ...
      return this.executeDownload({
        ...
        task: async (o, h) => {
          (this.listenerCount(e.DOWNLOAD_PROGRESS) > 0 &&
            (h.onProgress = (d) => this.emit(e.DOWNLOAD_PROGRESS, d)),
            await this.httpExecutor.download(f.url, o, h));
        },
      });
    }
    ...
    static installWithCommandRunner(s, i, f) {
      ...
      try {
        ...
        (f.warn((o = h.message) !== null && o !== void 0 ? o : h),
          f.warn(
            "pacman installation failed, attempting to update package database and retry",
          ));
        try {
          (i(["pacman", "-Sy", "--noconfirm"]),
            i(["pacman", "-U", "--noconfirm", s]));
        } catch (d) {
...
function oc() {
  ...
  let n = class ru extends r.LinuxUpdater {
    ...
    doInstall(s) {
      ...
      const f = ["zypper", "dnf", "yum", "rpm"],
        o = this.detectPackageManager(f);
      try {
        ru.installWithCommandRunner(
          o,
          i,
          this.runCommandWithSudoIfNeeded.bind(this),
          this._logger,
    ...
    static installWithCommandRunner(s, i, f, o) {
      ...
      if (s === "dnf") return f(["dnf", "install", "--nogpgcheck", "-y", i]);
      if (s === "yum") return f(["yum", "install", "--nogpgcheck", "-y", i]);
      if (s === "rpm")
        return (
          o.warn("Installing with rpm only (no dependency resolution)."),
          f(["rpm", "-Uvh", "--replacepkgs", "--replacefiles", "--nodeps", i])
        );
...
function sc() {
  ...
  let h = class extends s.AppUpdater {
    constructor(l, u) {
      (super(l, u),
        (this.nativeUpdater = Ht.autoUpdater),
        (this.squirrelDownloadedUpdate = !1),
        this.nativeUpdater.on("error", (p) => {
    ...
    async doDownloadUpdate(l) {
      let u = l.updateInfoAndProvider.provider.resolveFiles(
        l.updateInfoAndProvider.info,
      );
      const p = this._logger,
        E = "sysctl.proc_translated";
      let y = !1;
      try {
        (this.debug("Checking for macOS Rosetta environment"),
          (y = (0, f.execFileSync)("sysctl", [E], {
            encoding: "utf8",
          }).includes(`${E}: 1`)),
          p.info(`Checked for macOS Rosetta environment (isRosetta=${y})`));
      } catch (S) {
        p.warn(
          `sysctl shell command to check for macOS Rosetta environment failed: ${S}`,
        );
      }
      let m = !1;
      try {
        this.debug("Checking for arm64 in uname");
        const b = (0, f.execFileSync)("uname", ["-a"], {
          encoding: "utf8",
        }).includes("ARM");
      ...
      const T = (S) => {
        var b;
        return (
          S.url.pathname.includes("arm64") ||
          ((b = S.info.url) === null || b === void 0
            ? void 0
            : b.includes("arm64"))
        );
      };
      ...
      const N = l.updateInfoAndProvider.provider,
        D = "update.zip";
      return this.executeDownload({
        fileExtension: "zip",
        fileInfo: A,
        downloadUpdateOptions: l,
        task: async (S, b) => {
          const I = n.join(this.downloadedUpdateHelper.cacheDir, D),
            v = () =>
              (0, t.pathExistsSync)(I)
                ? !l.disableDifferentialDownload
                : (p.info(
                  ...
                  !1);
          let C = !0;
          (v() && (C = await this.differentialDownloadInstaller(A, l, S, N, D)),
            C && (await this.httpExecutor.download(A.url, S, b)));
        },
        done: async (S) => {
          if (!l.disableDifferentialDownload)
            try {
              const b = n.join(this.downloadedUpdateHelper.cacheDir, D);
              await (0, t.copyFile)(S.downloadedFile, b);
            } catch (b) {
              this._logger.warn(
                `Unable to copy file for caching for future differential downloads: ${b.message}`,
              );
            }
          return this.updateDownloaded(A, S);
        },
      });
    }
    async updateDownloaded(l, u) {
      ...
      const E = u.downloadedFile,
        y =
          (p = l.info.size) !== null && p !== void 0
            ? p
            : (await (0, t.stat)(E)).size,
        m = this._logger,
        T = `fileToProxy=${l.url.href}`;
      (this.closeServerIfExists(),
        this.debug(`Creating proxy server for native Squirrel.Mac (${T})`),
        (this.server = (0, a.createServer)()),
        this.debug(`Proxy server for native Squirrel.Mac is created (${T})`),
      ...
      return await new Promise((N, D) => {
        const S = (0, o.randomBytes)(64)
            .toString("base64")
            .replace(/\//g, "_")
            .replace(/\+/g, "-"),
          b = Buffer.from(`autoupdater:${S}`, "ascii"),
        ...
        (this.server.on("request", (v, C) => {
          ...
          if ((m.info(`${_} requested`), _ === "/")) {
            if (
              ...
              v.headers.authorization.indexOf("Basic ") === -1
            ) {
              ((C.statusCode = 401),
                (C.statusMessage = "Invalid Authentication Credentials"),
                C.end(),
                m.warn("No authenthication info"));
              return;
            }
            const $ = v.headers.authorization.split(" ")[1],
              F = Buffer.from($, "base64").toString("ascii"),
              [L, j] = F.split(":");
            if (L !== "autoupdater" || j !== S) {
              ((C.statusCode = 401),
                (C.statusMessage = "Invalid Authentication Credentials"),
                C.end(),
                m.warn("Invalid authenthication credentials"));
              return;
            }
            const k = Buffer.from(`{ "url": "${A(this.server)}${I}" }`);
            (C.writeHead(200, {
              "Content-Type": "application/json",
          ...
          if (!_.startsWith(I)) {
            (m.warn(`${_} requested, but not supported`),
              C.writeHead(404),
              C.end());
            return;
          }
          m.info(`${I} requested by Squirrel.Mac, pipe ${E}`);
          let U = !1;
          C.on("finish", () => {
          ...
          (x.on("error", ($) => {
            ...
            ((U = !0),
              this.nativeUpdater.removeListener("error", D),
              D(new Error(`Cannot pipe "${E}": ${$}`)));
          }),
            C.writeHead(200, {
          ...
          this.debug(
            `Proxy server for native Squirrel.Mac is starting to listen (${T})`,
          ),
          this.server.listen(0, "127.0.0.1", () => {
            (this.debug(
              `Proxy server for native Squirrel.Mac is listening (address=${A(this.server)}, ${T})`,
            ),
              ...
              this.autoInstallOnAppQuit
                ? (this.nativeUpdater.once("error", D),
...
function Vf() {
  ...
  function a(h, d) {
    return [
      ...
      ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", h],
      {
        shell: !0,
        timeout: d,
      },
  ...
  function s(h, d, l) {
    return new Promise((u, p) => {
      const E = d.replace(/'/g, "''");
      (l.info(`Verifying signature ${E}`),
        (0, t.execFile)(
          ...a(
            `"Get-AuthenticodeSignature -LiteralPath '${E}' | ConvertTo-Json -Compress"`,
            20 * 1e3,
          ),
          (y, m, T) => {
            var A;
            try {
              ...
              if (N.Status === 0) {
                try {
                  const I = n.normalize(N.Path),
                    v = n.normalize(d);
                  if (
                    (l.info(`LiteralPath: ${I}. Update Path: ${v}`), I !== v)
                  ) {
                    (f(
                      l,
                      new Error(`LiteralPath of ${I} is different than ${v}`),
                      T,
                      p,
                    ),
                      u(null));
                  ...
                  l.warn(
                    `Unable to verify LiteralPath of update asset due to missing data.Path. Skipping this step of validation. Message: ${(A = I.message) !== null && A !== void 0 ? A : I.stack}`,
                  );
                }
                const S = (0, e.parseDn)(N.SignerCertificate.Subject);
                let b = !1;
                for (const I of h) {
                  const v = (0, e.parseDn)(I);
                  if (
                    (v.size
                      ? (b = Array.from(v.keys()).every(
                          (_) => v.get(_) === S.get(_),
                        ))
                      : I === S.get("CN") &&
                        (l.warn(
                          `Signature validated using only CN ${I}. Please add your full Distinguished Name (DN) to publisherNames configuration`,
                        ),
                        (b = !0)),
                    b)
                  ) {
              ...
              const D =
                `publisherNames: ${h.join(" | ")}, raw info: ` +
                JSON.stringify(N, (S, b) => (S === "RawData" ? void 0 : b), 2);
              (l.warn(
                `Sign verification failed, installer signed with incorrect certificate: ${D}`,
              ),
                u(D));
            } catch (N) {
              (f(l, N, null, p), u(null));
  ...
  function i(h) {
    ...
    return (
      l != null &&
        ...
        delete l.Extensions,
        delete l.Handle,
        delete l.HasPrivateKey,
        delete l.SubjectName),
      d
    );
  }
  function f(h, d, l, u) {
    if (o()) {
      h.warn(
        `Cannot execute Get-AuthenticodeSignature: ${d || l}. Ignoring signature validation due to unsupported powershell version. Please upgrade to powershell 3 or higher.`,
      );
      return;
    }
    try {
      ...
      h.warn(
        `Cannot execute ConvertTo-Json: ${p.message}. Ignoring signature validation due to unsupported powershell version. Please upgrade to powershell 3 or higher.`,
      );
      return;
    }
    (d != null && u(d),
      l &&
        u(
          new Error(
            `Cannot execute Get-AuthenticodeSignature, stderr: ${l}. Failing signature validation due to unknown stderr.`,
          ),
        ));
  }
  function o() {
...
function uc() {
  ...
  let h = class extends r.BaseUpdater {
    constructor(l, u) {
      (super(l, u),
        (this._verifyUpdateCodeSignature = (p, E) =>
          (0, f.verifySignature)(p, E, this._logger)));
    }
    /**
    ...
    doDownloadUpdate(l) {
      ...
      return this.executeDownload({
        ...
        fileInfo: p,
        task: async (E, y, m, T) => {
          const A = p.packageInfo,
            N = A != null && m != null;
          if (N && l.disableWebInstaller)
            throw (0, e.newError)(
              `Unable to download new version ${l.updateInfoAndProvider.info.version}. Web Installers are disabled`,
              "ERR_UPDATER_WEB_INSTALLER_DISABLED",
            );
          (!N &&
            !l.disableWebInstaller &&
            this._logger.warn(
          ...
          if (D != null)
            throw (
              await T(),
              (0, e.newError)(
                `New version ${l.updateInfoAndProvider.info.version} is not signed by the application owner: ${D}`,
    ...
    doInstall(l) {
      ...
      const p = ["--updated"];
      (l.isSilent && p.push("/S"),
        l.isForceRunAfter && p.push("--force-run"),
        this.installDirectory && p.push(`/D=${this.installDirectory}`));
      const E =
        this.downloadedUpdateHelper == null
          ? null
      ...
      const y = () => {
        this.spawnLog(
          ...
          [u].concat(p),
        ).catch((m) => this.dispatchError(m));
      };
      return l.isAdminRightsRequired
        ? (this._logger.info(
            "isAdminRightsRequired is set to true, run installer using elevate.exe",
          ),
          y(),
          !0)
        : (this.spawnLog(u, p).catch((m) => {
            const T = m.code;
            (this._logger.info(
              `Cannot run installer: error code: ${T}, error message: "${m.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`,
            ),
              T === "UNKNOWN" || T === "EACCES"
                ? y()
                : T === "ENOENT"
                  ? Ht.shell.openPath(u).catch((A) => this.dispatchError(A))
    ...
    async differentialDownloadWebPackage(l, u, p, E) {
      ...
      try {
        ...
        (this.listenerCount(a.DOWNLOAD_PROGRESS) > 0 &&
          (y.onProgress = (m) => this.emit(a.DOWNLOAD_PROGRESS, m)),
          await new n.FileWithEmbeddedBlockMapDifferentialDownloader(
            u,
            this.httpExecutor,
            y,
          ).download());
        ...
        return (
          this._logger.error(
            `Cannot download differentially, fallback to full download: ${y.stack || y}`,
          ),
          process.platform === "win32"
        );
      }
  ...
  return (
    dc ||
      ...
      (function (e) {
        ...
        let E;
        function y() {
          if (process.platform === "win32") E = new (uc().NsisUpdater)();
          else if (process.platform === "darwin") E = new (sc().MacUpdater)();
          else {
            E = new (Ql().AppImageUpdater)();
            try {
              const m = a.join(process.resourcesPath, "package-type");
              if (!(0, n.existsSync)(m)) return E;
...
`,
  ...
  function o(b) {
    ...
    const I = E(b);
    b.path = I;
    const v = S.configDotenv(b);
    if (!v.parsed) {
      const x = new Error(
        `MISSING_DATA: Cannot parse ${I} for an unknown reason`,
      );
    ...
    for (let x = 0; x < _; x++)
      try {
        const $ = C[x].trim(),
          F = p(v, $);
        U = S.decrypt(F.ciphertext, F.key);
        break;
      } catch ($) {
        if (x + 1 >= _) throw $;
      }
  ...
  function u(b) {
    return b && b.DOTENV_KEY && b.DOTENV_KEY.length > 0
      ? b.DOTENV_KEY
  ...
  function p(b, I) {
    ...
    const U = `DOTENV_VAULT_${_.toUpperCase()}`,
      x = b.parsed[U];
    if (!x) {
      const $ = new Error(
        `NOT_FOUND_DOTENV_ENVIRONMENT: Cannot locate environment ${U} in your .env.vault file.`,
      );
    ...
    if (b && b.path && b.path.length > 0)
      if (Array.isArray(b.path))
        for (const v of b.path)
          e.existsSync(v) && (I = v.endsWith(".vault") ? v : `${v}.vault`);
      else I = b.path.endsWith(".vault") ? b.path : `${b.path}.vault`;
    else I = t.resolve(process.cwd(), ".env.vault");
    return e.existsSync(I) ? I : null;
  }
  function y(b) {
  ...
  function m(b) {
    const I = !!(b && b.debug),
      v = b && "quiet" in b ? b.quiet : !0;
    (I || !v) && l("Loading env from encrypted .env.vault");
    const C = S._parseVault(b);
    let _ = process.env;
    return (
      b && b.processEnv != null && (_ = b.processEnv),
      S.populate(_, C, b),
      { parsed: C }
    );
  }
  function T(b) {
    const I = t.resolve(process.cwd(), ".env");
    let v = "utf8";
    const C = !!(b && b.debug),
      _ = b && "quiet" in b ? b.quiet : !0;
    b && b.encoding
      ? (v = b.encoding)
      : C && d("No encoding is specified. UTF-8 is used by default");
    let U = [I];
    if (b && b.path)
      if (!Array.isArray(b.path)) U = [y(b.path)];
      else {
        U = [];
        for (const L of b.path) U.push(y(L));
      }
    let x;
    const $ = {};
    for (const L of U)
      try {
        const j = S.parse(e.readFileSync(L, { encoding: v }));
        S.populate($, j, b);
      } catch (j) {
    ...
    let F = process.env;
    if (
      (b && b.processEnv != null && (F = b.processEnv),
      S.populate(F, $, b),
      C || !_)
    ) {
      const L = Object.keys($).length,
        j = [];
      for (const k of U)
        try {
  ...
  function A(b) {
    if (u(b).length === 0) return S.configDotenv(b);
    const I = E(b);
    return I
      ? S._configVault(b)
      : (h(
          `You set DOTENV_KEY but you are missing a .env.vault file at ${I}. Did you forget to build it?`,
        ),
        S.configDotenv(b));
  }
  function N(b, I) {
    const v = Buffer.from(I.slice(-64), "hex");
    let C = Buffer.from(b, "base64");
    const _ = C.subarray(0, 12),
      U = C.subarray(-16);
    C = C.subarray(12, -16);
    try {
      ...
      const $ = x instanceof RangeError,
        F = x.message === "Invalid key length",
        L = x.message === "Unsupported state or unable to authenticate data";
      if ($ || F) {
        const j = new Error(
      ...
      Object.prototype.hasOwnProperty.call(b, U)
        ? (_ === !0 && (b[U] = I[U]),
          C &&
            d(
              _ === !0
                ? `"${U}" is already defined and WAS overwritten`
                : `"${U}" is already defined and was NOT overwritten`,
            ))
        : (b[U] = I[U]);
  }
  const S = {
  ...
  return (
    (pt.exports.configDotenv = S.configDotenv),
    (pt.exports._configVault = S._configVault),
    (pt.exports._parseVault = S._parseVault),
    (pt.exports.config = S.config),
    (pt.exports.decrypt = S.decrypt),
    (pt.exports.parse = S.parse),
    (pt.exports.populate = S.populate),
    (pt.exports = S),
    pt.exports
  );
}
...
function Qf({ bodyContent: e, hasAttachments: t, attachmentsJson: r }) {
  return e?.trim() ? (t ? nu(r).length > 0 : !0) : !1;
}
const Zf = on.default ?? on,
  {
    app: Xe,
    BrowserWindow: gt,
    ipcMain: Ee,
...
const th = wd(import.meta.url),
  nn = ct.dirname(th),
  ou = ct.join(Xe.getPath("userData"), "emails.db"),
  le = new vd(ou);
le.exec(`
...
function Ur(e, t, r) {
  le
    .prepare(`PRAGMA table_info(${e})`)
    .all()
    .some((s) => s.name === t) ||
    le.exec(`ALTER TABLE ${e} ADD COLUMN ${t} ${r}`);
}
...
const Ao = ct.join(Xe.getPath("userData"), "window-state.json"),
  Ro = ct.join(Xe.getPath("userData"), "ryze-settings.json"),
  Io = ct.join(Xe.getPath("userData"), "microsoft-oauth-tokens.json"),
  So = ct.join(Xe.getPath("userData"), "ai-provider-keys.json");
function Tt(e) {
  return new Promise((t) => setTimeout(t, e));
}
function kr(e, t) {
  const r = e.headers.get("retry-after"),
    n = r ? Number.parseInt(r, 10) : NaN;
...
Ee.handle(
  "updater:check",
  () => (Xe.isPackaged && Dt.autoUpdater.checkForUpdates(), !0),
);
Ee.handle(
  "updater:start-download",
  () => (Dt.autoUpdater.downloadUpdate(), !0),
);
...
function au(e) {
  const t = (e.displayName || "").toLowerCase().trim(),
    r = (e.wellKnownName || "").toLowerCase().trim(),
    n = /* @__PURE__ */ new Set([
      "outbox",
      "syncissues",
      "conflicts",
...
function hc(e) {
  const t = (e.displayName || "").toLowerCase().trim(),
    r = (e.wellKnownName || "").toLowerCase().trim();
  return r === "inbox" || t === "inbox"
    ? 0
    : r === "sentitems" || t === "sent items"
      ? 1
      : r === "drafts" || t === "drafts"
        ? 2
        : r === "archive" || t === "archive"
          ? 3
          : r === "deleteditems" || t === "deleted items" || t === "trash"
            ? 4
            : au(e)
              ? 999
              : 10;
...
function Vo(e) {
  return [...e]
    ...
    .sort((t, r) => {
      ...
      return n !== 0
        ? n
        : (t.path || t.displayName || "").localeCompare(
...
function su(e, t, r, n) {
  ...
  le.prepare(
    ...
    ON CONFLICT(accountId, folderId) DO UPDATE SET
      ...
      END
  `,
  ).run(e, t, r, n === "full" ? a : null, n === "delta" ? a : null, n, n);
}
function lu(e, t, r) {
  const n = r.from?.emailAddress?.name || r.sender?.emailAddress?.name || "",
    a = r.from?.emailAddress?.address || r.sender?.emailAddress?.address || "",
    s = r.flag ? (r.flag.flagStatus === "flagged" ? 1 : 0) : null,
    i = r.isRead !== void 0 ? (r.isRead ? 1 : 0) : null,
    f = r.hasAttachments !== void 0 ? (r.hasAttachments ? 1 : 0) : null,
    o = r.body?.content || r.bodyContent || "",
    h = r.body?.contentType || r.bodyContentType || "";
  le.prepare(
    `
    INSERT INTO emails (
      id,
...
function Ke(e, t, r = 4096) {
  ...
  if (n.length > r) throw new Error(`${t} is too long`);
  return n;
}
function lh() {
...
function dh() {
  const e = Yo(),
    t = (e.ollamaBaseUrl || "http://127.0.0.1:11434").trim(),
    r = (e.ollamaModel || "llama3.2").trim();
  if (!r)
  ...
  if (t)
    try {
      const r = JSON.parse(t),
        n = typeof r.summary == "string" ? r.summary.trim() : "",
        a = Array.isArray(r.keyPoints)
          ? r.keyPoints
              ...
              .slice(0, 5)
          : [],
        s = Array.isArray(r.suggestedActions)
          ? r.suggestedActions
              .filter((i) => typeof i == "string")
              .map((i) => i.trim())
              .filter(Boolean)
...
function gh(e) {
  const t = e && typeof e == "object" ? e : {},
    r = qe(t.aiProvider, "aiProvider", 32).trim(),
    n = qe(t.geminiModel, "geminiModel", 64).trim(),
    a = qe(t.ollamaBaseUrl, "ollamaBaseUrl", 512).trim(),
    s = qe(t.ollamaModel, "ollamaModel", 128).trim();
  return {
...
function Eh(e) {
  if (!Array.isArray(e)) throw new Error("drafts must be an array");
  return e.slice(0, 20).map((t, r) => {
    ...
    return {
      ...
      body: uu(qe(n.body, `drafts[${r}].body`, 5e5)),
...
function qe(e, t, r = 4096) {
  if (e == null) return "";
  if (typeof e != "string") throw new Error(`${t} must be a string`);
  if (e.length > r) throw new Error(`${t} is too long`);
  return e;
}
function Fe(e) {
  const t = Ke(e, "accountId", 256);
  if (!/^ms-[A-Za-z0-9._-]+$/.test(t)) throw new Error("Invalid accountId");
  return t;
}
function Pt(e) {
...
function gn(e) {
  ...
  if (!/^label-[A-Za-z0-9._-]+$/.test(t)) throw new Error("Invalid labelId");
  return t;
}
function du(e) {
  const t = Ke(e, "name", 64).replace(/\s+/g, " ").trim();
  if (t.length < 2) throw new Error("Label name must be at least 2 characters");
  return t;
}
function fu(e) {
...
function yh(e) {
  ...
  if (!/^#[0-9A-Fa-f]{6}$/.test(t)) throw new Error("Invalid label color");
  return t;
}
function nr(e) {
...
function vh(e) {
  ...
  if (!t) return "folder";
  if (!wh.has(t)) throw new Error("Invalid folder icon");
  return t;
}
function _h(e) {
  const t = Ke(e, "destinationFolder", 64).toLowerCase();
  if (!ih.has(t)) throw new Error("Invalid destination folder");
  return t;
}
function Th(e, t) {
  const r = le
...
function zo() {
  const e =
    ...
    t = process.env.MICROSOFT_OAUTH_TENANT_ID?.trim() || "common",
    r =
  ...
  if (!e) throw new Error("Missing MICROSOFT_OAUTH_CLIENT_ID");
  ...
  const a = new URL(r);
  if (
    !["127.0.0.1", "localhost"].includes(a.hostname) ||
    a.protocol !== "http:"
  )
    throw new Error(
...
function Ah(e) {
  ...
  try {
    ...
    throw a instanceof Error &&
      a.message === "Missing MICROSOFT_OAUTH_CLIENT_ID"
      ? new Error(
...
function Or() {
  try {
    ...
    const t = rt.decryptString(Buffer.from(e, "base64"));
    return JSON.parse(t);
  } catch (e) {
...
function Xo(e) {
  try {
    ...
    const t = JSON.stringify(e),
      r = rt.encryptString(t).toString("base64");
...
function Ko(e) {
  const t = En()[e],
    r = e === "gemini" ? process.env.GEMINI_API_KEY?.trim() : "";
  return {
    provider: e,
...
async function Rh(e, t, r, n) {
  const a = `https://login.microsoftonline.com/${r}/oauth2/v2.0`,
...
async function Ze(e) {
  ...
  if (r.expiresAt > Date.now() + nh) return r.accessToken;
  if (!r.refreshToken)
    throw new Error(
  ...
  const a = (async () => {
    try {
      const { clientId: s, tenantId: i, scope: f } = Ah(r),
        o = await Rh(r.refreshToken, s, i, f),
        h = Or();
      return (
        (h[e] = {
          ...r,
...
async function bo(e, t, r) {
  const n = new URLSearchParams({
    $select:
      "id,subject,bodyPreview,receivedDateTime,isRead,hasAttachments,from,toRecipients,ccRecipients,flag",
    // <--- Added ,flag
  });
  let a = `https://graph.microsoft.com/v1.0/me/mailFolders/${encodeURIComponent(
      r,
    )}/messages/delta?${n.toString()}`,
    s = "",
    i = 0;
  for (; a; ) {
...
async function mu(e, t, r) {
  ...
  try {
    ...
    if (
      h.includes("410") ||
      h.toLowerCase().includes("sync state") ||
      h.toLowerCase().includes("deltalink")
    )
...
async function yn(e) {
  const t = await Ze(e),
    r = await wu(t),
    n = Array.isArray(r) ? r : r.value || [],
    a = Vo(n);
  (console.log(`[sync] Initial full sync for ${e}: ${n.length} folders`),
    console.log(`[sync] Message sync folders: ${a.length}`),
    vu(e, n));
  for (const s of a)
    try {
      console.log(`[sync] Full delta sync folder: ${s.displayName} (${s.id})`);
      const i = await bo(t, e, s.id);
      console.log(
        `[sync] Finished folder: ${s.displayName} (${i.syncedCount ?? 0} messages)`,
      );
    } catch (i) {
      (console.error(`[sync] Failed folder: ${s.displayName} (${s.id})`, i),
        mn(e, s.id));
    }
  return { success: !0 };
}
async function gu(e, t) {
  const r = await Ze(e),
    n = Au(e),
    a = new Set(t.filter(Boolean)),
    s = Vo(n).filter((i) => a.has(i.id));
  console.log(`[sync] Targeted delta sync for ${e}: ${s.length} folders`);
  for (const i of s)
    try {
      const f = await mu(r, e, i.id);
      console.log(
...
async function Eu(e) {
  const t = await Ze(e),
    ...
    n = Array.isArray(r) ? r : r.value || [],
    a = Vo(n);
  (console.log(`[sync] Delta sync for ${e}: ${n.length} folders`),
    console.log(`[sync] Message delta folders: ${a.length}`),
    vu(e, n));
  for (const s of a)
    try {
      const i = await mu(t, e, s.id),
        f = i.updatedCount ?? i.syncedCount ?? 0,
        o = i.deletedCount ?? 0;
      console.log(
...
async function Ih(e, t) {
  for (let r = 1; r <= Et; r += 1) {
    ...
    if (
      n.status === 404 ||
      n.status === 403 ||
      a.includes("ErrorItemNotFound") ||
      a.includes("ErrorAccessDenied")
    )
      return { value: [] };
...
async function yu(e, t, r) {
  ...
  for (let s = 1; s <= Et; s += 1) {
    ...
    if (
      ...
      throw new Error(`Microsoft Graph move failed (${i.status}): ${f}`);
    await Tt(kr(i, s));
  }
...
async function bh(e, t, r) {
  const n = encodeURIComponent(t),
    a = await fetch(`https://graph.microsoft.com/v1.0/me/mailFolders/${n}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${e}`,
        "Content-Type": "application/json",
  ...
  if (!a.ok) {
    ...
    throw new Error(`Microsoft Graph folder rename failed (${a.status}): ${s}`);
  }
  return await a.json();
}
async function Ch(e, t) {
  const r = encodeURIComponent(t),
    n = await fetch(`https://graph.microsoft.com/v1.0/me/mailFolders/${r}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${e}`,
      },
  ...
  if (!n.ok && n.status !== 404) {
    const a = await n.text();
    throw new Error(`Microsoft Graph folder delete failed (${n.status}): ${a}`);
  }
  return { success: !0 };
}
...
async function Oh(e, t, r) {
  ...
  let a = 0,
    s = `https://graph.microsoft.com/v1.0/me/mailFolders/${encodeURIComponent(
      t,
  ...
  for (; s; ) {
    ...
    (i.push(...o.value.map((h) => h.id)),
      (s = o["@odata.nextLink"]),
      await Tt(80));
  }
  for (const f of i)
    (r ? await Nh(e, f) : await yu(e, f, n), (a += 1), await Tt(120));
  return {
    success: !0,
    affectedCount: a,
  };
    ...
    a = async (s, i, f) => {
      ...
      for (; o; ) {
        ...
        for (const d of h.value) {
          const l = f ? `${f}/${d.displayName}` : d.displayName,
            u = {
              ...d,
              depth: i,
              path: l,
...
function Co(e) {
  if (e.wellKnownName) return e.wellKnownName.toLowerCase();
  const t = e.id.toLowerCase(),
    r = e.displayName.toLowerCase().replace(/\s+/g, "");
  return t === "inbox" ||
    r === "inbox" ||
    r === "indbakke" ||
    r === "bandejadeentrada" ||
    ...
    : t === "sentitems" ||
      ...
      : t === "drafts" ||
          ...
          r === "brouillons"
        ? "drafts"
        : t === "archive" || r === "archive" || r === "arkiv" || r === "archivo"
          ? "archive"
          : t === "deleteditems" ||
              r === "deleteditems" ||
              r === "deleted" ||
...
function Lh() {
  try {
    if (Ge.existsSync(Ao)) return JSON.parse(Ge.readFileSync(Ao, "utf8"));
  } catch (e) {
...
function Ru() {
  const e = Lh(),
    t = ct.resolve(nn, "preload.mjs"),
    r = Xe.isPackaged
      ? ct.join(nn, "../dist/logo.ico")
      : ct.join(nn, "../../public/logo.ico"),
    n = new gt({
      x: e.x,
      y: e.y,
      width: e.width,
  ...
  (n.webContents.setWindowOpenHandler(({ url: a }) => {
    ...
    n.webContents.on("will-navigate", (a, s) => {
      (process.env.VITE_DEV_SERVER_URL &&
        s.startsWith(process.env.VITE_DEV_SERVER_URL)) ||
        s.startsWith("file://") ||
        a.preventDefault();
    }),
    n.on("close", () => {
    ...
    process.env.VITE_DEV_SERVER_URL
      ? n.loadURL(process.env.VITE_DEV_SERVER_URL)
      : n.loadFile(ct.resolve(nn, "../dist/index.html")));
}
Ee.handle("ai:get-provider-key-status", (e, t) => {
  const r = Ke(t?.provider, "provider", 32);
  if (r !== "gemini") throw new Error("Unsupported AI provider");
  return Ko(r);
});
Ee.handle("ai:set-provider-key", (e, t) => {
  const r = Ke(t?.provider, "provider", 32),
    n = Ke(t?.apiKey, "apiKey", 8192);
  if (r !== "gemini") throw new Error("Unsupported AI provider");
  const a = En();
  return (
    (a[r] = {
...
class Uh {
  ...
  allow() {
    const t = Date.now();
    return (
      (this.timestamps = this.timestamps.filter((r) => t - r < this.windowMs)),
      this.timestamps.length >= this.maxCalls
        ? !1
        : (this.timestamps.push(t), !0)
    );
  }
}
...
Ee.handle("ai:summarize-email", async (e, t) => {
  if (!kh.allow())
    throw new Error(
      "Too many AI requests. Please wait a moment before summarising another email.",
    );
  const r = mh(t),
    n = pc(hh(r.body || r.preview || ""));
...
`),
      y = async (A) => {
        ...
        if (!N.ok) {
          ...
          throw new Error(`Ollama summarize failed (${N.status}): ${D}`);
        }
        return await N.json();
      };
    let m = await y(500),
      T = (m.response || m.message?.content || m.output || "").trim();
    if (
      (!T &&
  ...
  if (!o.ok) {
    ...
    throw o.status === 400 && l.includes("API_KEY")
      ? new Error("Gemini API key is invalid or missing.")
      : new Error(`Gemini summarize failed (${o.status}): ${l}`);
  }
  const d = (await o.json()).candidates?.[0]?.content?.parts
    ?.map((l) => l.text || "")
    .join("")
    .trim();
  if (!d) throw new Error("Gemini returned an empty summary.");
  return {
    ...mc(d),
  };
});
Ee.handle("microsoft-calendar:get-events", async (e, t) => {
  ...
  if (!f.ok) {
    const h = await f.text();
    throw (
      console.error("Failed to fetch calendar:", h),
      new Error(`Failed to fetch calendar events: ${h}`)
    );
  }
...
Ee.handle("microsoft-mail:download-attachment", async (e, t) => {
  const r = Fe(t?.accountId),
    n = Pt(t?.messageId),
    a = Ke(t?.attachmentId, "attachmentId", 2048),
    s = Ke(t?.filename, "filename", 1024),
    i = gt.fromWebContents(e.sender);
  if (!i) throw new Error("No window found");
  const { canceled: f, filePath: o } = await eh.showSaveDialog(i, {
    defaultPath: s,
    title: "Save Attachment",
  });
  if (f || !o) return { success: !1, canceled: !0 };
  const h = await Ze(r),
    d = encodeURIComponent(n),
    l = encodeURIComponent(a),
    p = `${`https://graph.microsoft.com/v1.0/me/messages/${d}/attachments/${l}`}/$value`,
    E = async (A) => {
      ...
      if (N.ok) {
        ...
        return { ok: !0, bytes: Buffer.from(S) };
      }
      const D = await N.text();
      return { ok: !1, status: N.status, errorText: D };
    },
    y = await E(!0),
    m = y.ok || y.status !== 404 ? null : await E(!1),
    T = y.ok ? y : m?.ok ? m : null;
  if (!T) {
    const A = m || y;
...
Ee.handle("microsoft-mail:toggle-star", async (e, t) => {
  const r = Fe(t?.accountId),
    ...
    f = await fetch(`https://graph.microsoft.com/v1.0/me/messages/${i}`, {
      method: "PATCH",
      headers: {
  ...
  if (!f.ok) {
    ...
    if (f.status === 404 || o.includes("ErrorItemNotFound"))
      return (
        le
          .prepare("DELETE FROM emails WHERE accountId = ? AND id = ?")
          .run(r, n),
        { success: !1, missing: !0 }
      );
  ...
  return (
    le
      .prepare("UPDATE emails SET isStarred = ? WHERE accountId = ? AND id = ?")
      .run(a ? 1 : 0, r, n),
    { success: !0 }
  );
});
...
Ee.handle("microsoft-mail:syncFolders", async (e, t) => {
  ...
  const a = (Array.isArray(t?.folderIds) ? t.folderIds : []).map((s) => nr(s));
  return a.length === 0
    ? { success: !0 }
    : Jo(r)
      ? await yn(r)
...
Ee.handle("system:get-drafts", () => {
  try {
    ...
    const e = Ge.readFileSync(No),
      t = rt.decryptString(e);
    return JSON.parse(t);
  } catch (e) {
...
Ee.on("system:save-drafts", (e, t) => {
  if (!rt.isEncryptionAvailable()) {
    console.error(
      "Secure storage unavailable — drafts will not be saved to disk.",
    );
    const r = gt.getAllWindows();
    r.length > 0 &&
      r[0].webContents.send(
        "drafts:save-failed",
        "Secure storage is unavailable on this system. Drafts cannot be saved.",
      );
    return;
  }
  try {
    const r = JSON.stringify(Eh(t)),
      n = rt.encryptString(r);
    Ge.writeFileSync(No, n, { mode: 384 });
  } catch (r) {
    console.error("Failed to securely save drafts:", r);
    const n = gt.getAllWindows();
    n.length > 0 &&
      n[0].webContents.send(
        "drafts:save-failed",
...
Ee.handle("microsoft-folder:rename", async (e, t) => {
  const r = Fe(t?.accountId),
    ...
    `,
      ...
      .get(r, n);
  if (!s) throw new Error("Folder not found");
  if (s.wellKnownName) throw new Error("System folders cannot be renamed.");
  const i = await Ze(r),
    f = await bh(i, n, a);
  return (
    le
...
Ee.handle("microsoft-folder:delete", async (e, t) => {
  const r = Fe(t?.accountId),
    ...
    `,
      ...
      .get(r, n);
  if (!a) throw new Error("Folder not found");
  if (a.wellKnownName) throw new Error("System folders cannot be deleted.");
  const s = await Ze(r);
  await Ch(s, n);
  const i = Th(r, n);
  return (
...
Ee.handle("microsoft-folder:empty", async (e, t) => {
  ...
  const s = await Ze(r),
    i =
      a.wellKnownName === "deleteditems" ||
      a.displayName?.toLowerCase() === "deleted items" ||
      a.displayName?.toLowerCase() === "trash",
    f = await Oh(s, n, i);
  return (
    le.transaction(() => {
      (le
...
Ee.handle("microsoft-oauth:connect", async () => {
  const { clientId: e, tenantId: t, redirectUri: r, scope: n } = zo(),
    a = _o(dt.randomBytes(64)),
    s = _o(dt.createHash("sha256").update(a).digest()),
    i = _o(dt.randomBytes(32)),
    f = new URL(r),
    o = `https://login.microsoftonline.com/${t}/oauth2/v2.0`,
    h = new URL(`${o}/authorize`);
  ...
  const d = await new Promise((N, D) => {
      const S = _c.createServer((I, v) => {
        if (!I.url) return;
        const C = `${f.hostname}:${f.port}`;
        if (I.headers.host !== C) {
          (v.writeHead(400, { "Content-Type": "text/plain; charset=utf-8" }),
            v.end("Bad request."));
          return;
        }
        const _ = new URL(I.url, r);
        if (_.pathname !== f.pathname) {
          (v.writeHead(404, { "Content-Type": "text/plain; charset=utf-8" }),
            v.end("Not found."));
          return;
        }
        const U = _.searchParams.get("state"),
          x = _.searchParams.get("code"),
          $ = _.searchParams.get("error"),
          F = _.searchParams.get("error_description");
        if ($) {
          (v.writeHead(400, { "Content-Type": "text/plain; charset=utf-8" }),
            v.end("Microsoft sign-in failed. You can close this window."),
            S.close(() => D(new Error(F || $))));
          return;
        }
        if (U !== i || !x) {
          (v.writeHead(400, { "Content-Type": "text/plain; charset=utf-8" }),
            v.end("Invalid sign-in response. You can close this window."),
            S.close(() =>
              D(new Error("Invalid OAuth state or authorization code")),
            ));
          return;
        }
        (v.writeHead(200, { "Content-Type": "text/plain; charset=utf-8" }),
          v.end(
      ...
      (S.on("close", () => clearTimeout(b)),
        S.listen(Number(f.port), f.hostname, () => {
          iu.openExternal(h.toString()).catch((I) => {
            S.close(() => D(I));
          });
        }));
    }),
  ...
  if (!u.ok) {
    ...
    throw new Error(`Microsoft token exchange failed (${u.status}): ${N}`);
  }
  const p = await u.json(),
    E = await fetch("https://graph.microsoft.com/v1.0/me", {
      headers: {
  ...
  if (!E.ok) {
    ...
    throw new Error(`Microsoft profile request failed (${E.status}): ${N}`);
  }
  const y = await E.json(),
    m = `ms-${y.id}`,
    T = y.mail || y.userPrincipalName;
  if (!T) throw new Error("Microsoft profile did not include an email address");
  const A = Or();
  return (
    (A[m] = {
      accountId: m,
...
Ee.handle("microsoft-mail:send", async (e, t) => {
  const r = Fe(t?.accountId),
    n = Ke(t?.to, "to", 4096),
    a = qe(t?.cc, "cc", 4096),
    s = qe(t?.subject, "subject", 512),
    i = qe(t?.body, "body", 5e5),
    f = await Ze(r),
    o = {
      message: {
...
Ee.handle("microsoft-mail:mark-read", async (e, t) => {
  const r = Fe(t?.accountId),
    { messageId: n, isRead: a } = t;
  if (!n) throw new Error("Missing messageId");
  (le
    .prepare("UPDATE emails SET isRead = ? WHERE id = ? AND accountId = ?")
    .run(a ? 1 : 0, n, r),
    zo());
  const i = qh(r);
  return (
    i &&
      Bh(i.accessToken, n, { isRead: a }).catch((f) =>
        console.error("Failed background sync for mark-read:", f),
      ),
    !0
  );
});
Ee.handle("microsoft-mail:mark-unread", async (e, t) => {
  const r = Fe(t?.accountId),
    ...
    i = await fetch(`https://graph.microsoft.com/v1.0/me/messages/${s}`, {
      method: "PATCH",
      headers: {
  ...
  return (
    le
      .prepare("UPDATE emails SET isRead = 0 WHERE accountId = ? AND id = ?")
      .run(r, n),
    { success: !0 }
  );
});
Ee.handle("microsoft-mail:getAllLocal", () => {
  ...
  `,
      ...
      .all(),
    r = {};
  for (const i of e) r[i.id] = Tu(t.filter((f) => f.folder === i.id));
  const n = le
      .prepare(
        "SELECT * FROM labels ORDER BY accountId, name COLLATE NOCASE ASC",
      )
      .all(),
    s = le
      .prepare(
...
Ee.handle("microsoft-mail:get-body", async (e, t) => {
  const r = Fe(t?.accountId),
    ...
    `,
      ...
      .get(r, n);
  if (!a) throw new Error("Message not found locally.");
  ...
  const i = await Ze(r),
    f = `https://graph.microsoft.com/v1.0/me/messages/${encodeURIComponent(
      n,
  ...
  const h = await o.json(),
    d = h.body?.content || "",
    l = h.body?.contentType || "html",
    u = Array.isArray(h.attachments)
      ? h.attachments
          .filter((p) =>
            String(p?.["@odata.type"] || "").includes("fileAttachment"),
          )
          .map((p) => ({
            id: p.id || "",
...
Ee.handle("microsoft-mail:move", async (e, t) => {
  ...
  `,
        ...
        .get(r, a)?.id || a,
    h = await fetch(`https://graph.microsoft.com/v1.0/me/messages/${i}/move`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${s}`,
        "Content-Type": "application/json",
...
Xe.whenReady().then(() => {
  (on.session.defaultSession.webRequest.onHeadersReceived((e, t) => {
    t({
      responseHeaders: {
        ...e.responseHeaders,
        "Content-Security-Policy": [Xe.isPackaged ? $h : Mh],
      },
    });
  }),
    on.session.defaultSession.setPermissionRequestHandler((e, t, r) => r(!1)),
    Ru(),
    Xe.isPackaged &&
      setTimeout(() => {
...
function qh(e, t) {
  const n = Or()[e];
  if (!(!n || n.provider !== "microsoft" || n.accountId !== e)) return n;
}
async function Bh(e, t, r) {
  const n = encodeURIComponent(Ke(t, "messageId", 2048)),
    a = !!r.isRead,
    s = `https://graph.microsoft.com/v1.0/me/messages/${n}`,
    i = JSON.stringify({ isRead: a });
